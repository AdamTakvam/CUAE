<Application name="BridgeCalls" trigger="Metreos.CallControl.IncomingCall" version="0.8" single="false">
  <!--//// app tree ////-->
  <global name="BridgeCalls">
    <outline>
      ...
      <treenode type="evh" id="632722533371894272" level="2" text="Metreos.MediaControl.Play_Complete: OnPlay_Complete">
        ...
        <references>
          <ref id="632724962137272659" actid="632722533371894278" />
        </references>
      ...
      <treenode type="evh" id="632722533371894277" level="2" text="Metreos.MediaControl.Play_Failed: OnPlay_Failed">
        ...
        <references>
          <ref id="632724962137272660" actid="632722533371894278" />
        </references>
        <Properties type="asyncCallback">
        </Properties>
      </treenode>
      <treenode type="evh" id="632724359405628642" level="2" text="Metreos.CallControl.MakeCall_Complete: OnMakeCall_Complete">
        ...
        <references>
          <ref id="632724962137272665" actid="632724359405628653" />
        </references>
        <Properties type="asyncCallback">
        </Properties>
      </treenode>
      <treenode type="evh" id="632724359405628647" level="2" text="Metreos.CallControl.MakeCall_Failed: OnMakeCall_Failed">
        ...
        <references>
          <ref id="632724962137272666" actid="632724359405628653" />
        </references>
        <Properties type="asyncCallback">
        </Properties>
      </treenode>
      <treenode type="evh" id="632724359405628652" level="2" text="Metreos.CallControl.RemoteHangup: OnRemoteHangup">
        ...
        <references>
          <ref id="632724962137272667" actid="632724359405628653" />
        </references>
    ...
    <variables>
      <treenode text="g_incomingConnId" id="632724962137272651" vid="632722533371894265">
        <Properties type="String">g_incomingConnId</Properties>
      </treenode>
      <treenode text="g_incomingCallId" id="632724962137272653" vid="632722533371894284">
        <Properties type="String">g_incomingCallId</Properties>
      </treenode>
      <treenode text="g_outboundCallId" id="632724962137272655" vid="632724359405628657">
        <Properties type="String">g_outboundCallId</Properties>
      </treenode>
      <treenode text="g_conferenceId" id="632724962137272678" vid="632724962137272677">
  ...
  <canvas type="Function" name="OnPlay_Complete" startnode="632722533371894271" treenode="632722533371894272" appnode="632722533371894269" handlerfor="632722533371894268">
    ...
    <node type="Action" id="632724359405628659" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="250" y="370">
      <Properties final="true" type="appControl" log="On">
      </Properties>
    </node>
  </canvas>
  ...
  <canvas type="Function" name="OnMakeCall_Complete" startnode="632724359405628641" treenode="632724359405628642" appnode="632724359405628639" handlerfor="632724359405628638">
    <node type="Start" id="632724359405628641" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="32" y="375">
      <linkto id="632724962137272676" type="Basic" style="Bezier" ortho="true" />
    </node>
    <node type="Action" id="632724962137272676" name="CreateConference" class="MaxActionNode" group="" path="Metreos.MediaControl" x="144" y="375">
      <linkto id="632724962137272679" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider" log="On">
        <ap name="ConnectionId" type="variable">outboundConnectionId</ap>
        <rd field="ConferenceId">g_conferenceId</rd>
      </Properties>
    </node>
    <node type="Action" id="632724962137272679" name="JoinConference" class="MaxActionNode" group="" path="Metreos.MediaControl" x="268" y="375">
      <linkto id="632724962137272680" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider" log="On">
        <ap name="ConnectionId" type="variable">g_incomingConnId</ap>
        <ap name="ConferenceId" type="variable">g_conferenceId</ap>
      </Properties>
    </node>
    <node type="Action" id="632724962137272680" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="376" y="375">
      <Properties final="true" type="appControl" log="On">
      </Properties>
    </node>
    <node type="Variable" id="632724359405628660" name="outboundConnectionId" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="String" initWith="ConnectionId" refType="reference" name="Metreos.CallControl.MakeCall_Complete">outboundConnectionId</Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnMakeCall_Failed" activetab="true" startnode="632724359405628646" treenode="632724359405628647" appnode="632724359405628644" handlerfor="632724359405628643">
