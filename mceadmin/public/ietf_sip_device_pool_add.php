...
$conf_metas = ComponentUtils::get_standard_config_metas(ComponentType::IETF_SIP_DEVICE_POOL);
...
if ($_POST['submit'])
{
    ...
    if ($errors->IsEmpty())
    {
        ...
        $db->Execute("INSERT INTO mce_components (name, type, status, version, description) " .
                     "VALUES (?,?,?,?,?)",
                     array($_POST['name'], ComponentType::IETF_SIP_DEVICE_POOL, ComponentStatus::ENABLED_RUNNING, '1.0', $_POST['description']));
        $dp_id = $db->Insert_ID();
        ...
        EventLog::log(LogMessageType::AUDIT, 'IETF SIP Device Pool Created', LogMessageId::IPT_SERVER_CREATED, print_r($log_values, TRUE));
