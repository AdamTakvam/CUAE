...
<form action="{$_SCRIPT_NAME}" method="post">
    <table>
        ...
        <tr class="{cycle values='eveRow,oddRow'}">
            <th>Device Name Prefix</th>
            <td><input type="text" name="device_prefix" maxlength="11" value="{$device_prefix|escape:"html"}" /></td>
            <td>Prefix for the device names of this set (up to 11 characters)</td>
        </tr>
        <tr class="{cycle values='evenRow,oddRow'}">
            <th>Devices to Register</th>
            <td><input type="text" name="device_count" value="{$device_count}" /></td>
            <td>
                Number of devices to enumerate
                <span class="metaDescription">Valid Range: 1 - 9,999</span>
            </td>
        </tr>
    </table>
    <input type="hidden" name="id" value="{$id}" />
