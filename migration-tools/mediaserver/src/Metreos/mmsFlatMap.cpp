...
int MmsFlatMapWriter::insert(const int key, const int datatype, const int length, const char* value)
{
  assert(value);
...
int MmsFlatMapWriter::insert(const int key, const int value)
{
  int intval = value;
...
int MmsFlatMapWriter::insert(const int key, const __int64 value)
{
...
int MmsFlatMapWriter::insert(const int key, const double value)
{
...
char* MmsFlatMapWriter::format(const int key, const int datatype, const int length)
{
...
int MmsFlatMapWriter::length()            // Return size of a marshaled map 
...
int MmsFlatMapWriter::marshal(char* buf, int extensionlength, char* headerextension)           
{
  char* p = buf;
...
int MmsFlatMapWriter::verify(const int length)    
{
...
int MmsFlatMapWriter::reallocateBody(const int size)    
{
  ...
  return newsize;
                                            ...
                                            // Ctor
MmsFlatMapWriter::MmsFlatMapWriter(const int initialBodySize)
{
...
MmsFlatMapWriter::~MmsFlatMapWriter()                            
{                                            
...
MmsFlatMapReader::MmsFlatMapReader(const char* flatmap): m_index(0), m_bodysize(0)
{
  this->load(flatmap);
}
...
MmsFlatMapReader::MmsFlatMapReader(): m_index(0), m_bodysize(0) 
{ 
}


                                            // Load a flatmap into the reader 
int MmsFlatMapReader::load(const char* marshaledFlatmap)    
{                                          
...
( const int key, char** value, int* datatype, int occurrence)
{
  ...
  return length;
                                            ...
                                            // Sequential access
int MmsFlatMapReader::get(const int i, int* key, char** value, int* datatype)
{
