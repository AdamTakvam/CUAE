...
namespace AROneExtern
{
	...
	public class Worker
	{
        ...
        public bool Generate(int deviceStart, int deviceCount, string accountPrefix, string findMePrefix)
        {
            ...
            for(int i = deviceStart; i < deviceStart + deviceCount; i++)
            {
                ...
                extraReceiverDns.Add(deviceCount + i);
                extraReceiverDns.Add(deviceCount + i + 1);
            }        
            ...
            for(int i = 0; i < receiverDns.Count; i++)
            {
                ...
                externalNumberSql2.AddFieldValue("phone_number", findMePrefix + extraReceiverDns[i * 2]);
                ...
                externalNumberSql3.AddFieldValue("phone_number", findMePrefix + extraReceiverDns[i * 2 + 1]);
