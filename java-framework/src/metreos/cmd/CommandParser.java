/* $Id: CommandParser.java 7054 2005-06-07 17:48:33Z wert $
 *
...
public class CommandParser
{
	...
	{
		if (option.isHidden() && option.getDefaultValue() == null)
	...
	public boolean parse( String[] args ) throws Exception
	{
		...
		Iterator<String> argsIterator = new StringArrayIterator( args );
		while (argsIterator.hasNext())
		{
			...
			if (option != null)
			{
				...
				{
					value = option.getAndConvertValue( token, argsIterator );
					if (value == null)
						return false;
				...
				if (!option.deliverValue( token, value, false ))
					return false;
...
//			System.out.println( "checking option "+option );
	 ...
	 * @param i
	 */
	void report( String msg, String token, Iterator<String> i )
	{
	...
	public void defineStringOption( String tokens, String name, String method,
		...
		throws Exception
	{
		define( new StringOption( this, tokens, name, method, description, flags,
			defaultValue, constraint ) );
	}
