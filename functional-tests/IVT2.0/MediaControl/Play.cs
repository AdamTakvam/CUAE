...
namespace Metreos.FunctionalTests.IVT2._0.MediaControl
{
    ...
    public class PlayToCallee : FunctionalTestBase
    {
        ...
        public PlayToCallee() : base(typeof( PlayToCallee ))
        {
        ...
        public override bool Execute()
        {
            ...
            {
                log.Write(System.Diagnostics.TraceLevel.Info, "Play provisional response not received");
                return false;
            }
        ...
        public void PlayComplete(ActionMessage im)
        {
            ...
            if(!playSuccess)
            {
                log.Write(System.Diagnostics.TraceLevel.Info, "The play failed to start");
            }
        }
