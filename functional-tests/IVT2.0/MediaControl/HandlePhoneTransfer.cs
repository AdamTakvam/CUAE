...
namespace Metreos.FunctionalTests.IVT2._0.MediaControl
{
    ...
    public class HandlePhoneTransfer : FunctionalTestBase
    {
        ...
        public HandlePhoneTransfer() : base(typeof( HandlePhoneTransfer ))
        {
...
//            are.WaitOne();
            ...
            {
                log.Write(System.Diagnostics.TraceLevel.Info, "Play after transfer response not received");
                return false;
            }
