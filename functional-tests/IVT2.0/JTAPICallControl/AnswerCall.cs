...
namespace Metreos.FunctionalTests.IVT2._0.JtapiCallControl
{
    ...
    public class JTapiAnswerCall : FunctionalTestBase
    {
        ...
        public JTapiAnswerCall() : base(typeof( JTapiAnswerCall ))
        {
        ...
        {  
            log.Write(System.Diagnostics.TraceLevel.Info, "Call test phone");
