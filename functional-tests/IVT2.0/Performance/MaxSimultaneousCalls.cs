...
namespace Metreos.FunctionalTests.IVT2._0.Performance
{
    ...
    public class MaxSimultaneousCalls : FunctionalTestBase
    {
        ...
        public MaxSimultaneousCalls() : base(typeof( MaxSimultaneousCalls ))
        {
        ...
        {  
            ...
            maxCalls = Convert.ToInt32(input[maxCallsField]);
            ...
            if(!answerCallSuccess || maxCalls != callCountSuccess)
            {
                return false;
            }
        ...
        {
            TestTextInputData maxCallField = new TestTextInputData(maxCallsField, 
                "The number of maximum calls to wait for.", maxCallsField, 80);
            
            ArrayList inputs = new ArrayList();
            inputs.Add(maxCallField);
            return inputs;
        }
