...
namespace Metreos.FunctionalTests.IVT2._0.IPPhoneServices
{
    ...
    public class CreateText : FunctionalTestBase
    {
        ...
        public CreateText() : base(typeof( CreateText ))
        {
        ...
        {
            return new string[] { SendExecuteTest.FullName, CreateTextTest.FullName};
        }
