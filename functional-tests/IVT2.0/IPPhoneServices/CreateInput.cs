...
using CreateInputTest = Metreos.TestBank.IVT.IVT.CreateInput;
...
namespace Metreos.FunctionalTests.IVT2._0.IPPhoneServices
{
    ...
    public class CreateInput : FunctionalTestBase
    {
        ...
        public CreateInput() : base(typeof( CreateInput ))
        {
        ...
        {
            return new string[] { SendExecuteTest.FullName, CreateInputTest.FullName, CreateTextTest.FullName };
        }
