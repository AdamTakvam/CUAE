...
using CreateImageFileTest = Metreos.TestBank.IVT.IVT.CreateImageFile;
...
namespace Metreos.FunctionalTests.IVT2._0.IPPhoneServices
{
    ...
    public class CreateImageFile : FunctionalTestBase
    {
        ...
        public CreateImageFile() : base(typeof( CreateImageFile ))
        {
        ...
        {  
            ...
            args[url] = MakeUri("CreateImageFile");
        ...
        {
            return new string[] { SendExecuteTest.FullName, CreateImageFileTest.FullName, CreateTextTest.FullName };
        }
