...
using CreateMenuTest = Metreos.TestBank.IVT.IVT.CreateMenu;
...
namespace Metreos.FunctionalTests.IVT2._0.IPPhoneServices
{
    ...
    public class CreateMenu : FunctionalTestBase
    {
        ...
        public CreateMenu() : base(typeof( CreateMenu ))
        {
        ...
        {
            return new string[] { SendExecuteTest.FullName, CreateMenuTest.FullName, CreateTextTest.FullName };
        }
