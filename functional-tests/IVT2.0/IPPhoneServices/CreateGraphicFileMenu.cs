...
using CreateGraphicMenuFileTest = Metreos.TestBank.IVT.IVT.CreateGraphicFileMenu;
...
namespace Metreos.FunctionalTests.IVT2._0.IPPhoneServices
{
    ...
    public class CreateGraphicMenuFile : FunctionalTestBase
    {
        ...
        public CreateGraphicMenuFile() : base(typeof( CreateGraphicMenuFile ))
        {
        ...
        {  
            ...
            args[url] = MakeUri("CreateGraphicFileMenu");
        ...
        {
            return new string[] { SendExecuteTest.FullName, CreateGraphicMenuFileTest.FullName, CreateTextTest.FullName };
        }
