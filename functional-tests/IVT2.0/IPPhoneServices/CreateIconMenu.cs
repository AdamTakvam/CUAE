...
using CreateIconMenuTest = Metreos.TestBank.IVT.IVT.CreateIconMenu;
...
namespace Metreos.FunctionalTests.IVT2._0.IPPhoneServices
{
    ...
    public class CreateIconMenu : FunctionalTestBase
    {
        ...
        public CreateIconMenu() : base(typeof( CreateIconMenu ))
        {
        ...
        {  
            ...
            args[url] = MakeUri("CreateIconMenu");
        ...
        {
            return new string[] { SendExecuteTest.FullName, CreateIconMenuTest.FullName, CreateTextTest.FullName };
        }
