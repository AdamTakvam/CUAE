...
using CreateImageTest = Metreos.TestBank.IVT.IVT.CreateImage;
...
namespace Metreos.FunctionalTests.IVT2._0.IPPhoneServices
{
    ...
    public class CreateImage : FunctionalTestBase
    {
        ...
        public CreateImage() : base(typeof( CreateImage ))
        {
        ...
        {
            return new string[] { SendExecuteTest.FullName, CreateImageTest.FullName, CreateTextTest.FullName };
        }
