...
using CreateGraphicMenuTest = Metreos.TestBank.IVT.IVT.CreateGraphicMenu;
...
namespace Metreos.FunctionalTests.IVT2._0.IPPhoneServices
{
    ...
    public class CreateGraphicMenu : FunctionalTestBase
    {
        ...
        public CreateGraphicMenu() : base(typeof( CreateGraphicMenu ))
        {
        ...
        {  
            ...
            args[url] = MakeUri("CreateGraphicMenu");
        ...
        {
            return new string[] { SendExecuteTest.FullName, CreateGraphicMenuTest.FullName, CreateTextTest.FullName, CreateDirectoryTest.FullName };
        }
