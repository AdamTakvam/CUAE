...
namespace Metreos.FunctionalTests.TestControlProvider.IncomingCallEvent
{
	...
	public class IncomingCall_SIP_Late : FunctionalTestBase
	{
        ...
        private AutoResetEvent gotSetMedia;
        private AutoResetEvent hungup;

        public IncomingCall_SIP_Late() : base(typeof( IncomingCall_SIP_Late ))
        {
            this.timeout = 3000;
            this.callAccepted = new AutoResetEvent(false);
            this.callAnswered = new AutoResetEvent(false);
            this.gotSetMedia = new AutoResetEvent(false);
        ...
        public override bool Execute()
        {
            ...
            if(gotSetMedia.WaitOne(15000, false) == false)
            {
            ...
            this.log.Write(System.Diagnostics.TraceLevel.Info, "Info: MediaEstablished has been sent. Waiting for Hangup.");
