...
using RecordTest = Metreos.TestBank.Provider.Provider.RecordConference;
...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer
{
    ...
    public class RecordConference : FunctionalTestBase
    {
        ...
        public RecordConference() : base(typeof( RecordConference ))
        {
        }
