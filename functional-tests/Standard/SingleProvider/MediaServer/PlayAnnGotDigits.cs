...
using PlayAnnTest = Metreos.TestBank.Provider.Provider.PlayAnnGotDigits;
...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer
{
    ...
    public class PlayAnnGotDigits : FunctionalTestBase
    {
        ...
        public PlayAnnGotDigits() : base(typeof( PlayAnnGotDigits ))
        {
        }
