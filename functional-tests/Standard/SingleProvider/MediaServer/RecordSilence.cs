...
using RecordTest = Metreos.TestBank.Provider.Provider.RecordSilence;
...
namespace Metreos.FunctionalTesats.SingleProvider.MediaServer
{
    ...
    public class RecordSilence : FunctionalTestBase
    {
        ...
        public RecordSilence() : base(typeof( RecordSilence ))
        {
        }
