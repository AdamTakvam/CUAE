...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1007")]
    public class FileTTS : FunctionalTestBase
    {
        ...
        private bool hungup;
        public FileTTS () : base(typeof( FileTTS ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play2"] = "if the wave file played first, this test succeeds.";
