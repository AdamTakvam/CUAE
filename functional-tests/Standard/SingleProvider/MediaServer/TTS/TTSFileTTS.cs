...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1010")]
    public class TTSFileTTS : FunctionalTestBase
    {
        ...
        private bool hungup;
        public TTSFileTTS () : base(typeof( TTSFileTTS ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play1"] =  "if the wave file plays now.";
            parameters["play2"] = "enter_pin.wav";
            parameters["play3"] = "and if this is spoken after the wav, the test succeeds.";
