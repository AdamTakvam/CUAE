...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1005")]
    public class Abbreviations1 : FunctionalTestBase
    {
        ...
        private bool hungup;
        public Abbreviations1 () : base(typeof( Abbreviations1 ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play1"] = "your package is 3g. over weight.";
