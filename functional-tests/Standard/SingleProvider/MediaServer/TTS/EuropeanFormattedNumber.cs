...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1003")]
    public class EuropeanFormattedNumber : FunctionalTestBase
    {
        ...
        private bool hungup;
        public EuropeanFormattedNumber() : base(typeof( EuropeanFormattedNumber ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play1"] = "the number you entered was +82-2-3016-8534.";
            parameters["play2"] = null;
