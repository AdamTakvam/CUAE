...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1008")]
    public class TTSFile : FunctionalTestBase
    {
        ...
        private bool hungup;
        public TTSFile () : base(typeof( TTSFile ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play1"] = "if the wave file plays after this, the test succeeds";
