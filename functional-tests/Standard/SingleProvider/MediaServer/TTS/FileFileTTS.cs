...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1012")]
    public class FileFileTTS : FunctionalTestBase
    {
        ...
        private bool hungup;
        public FileFileTTS () : base(typeof( FileFileTTS ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play2"] = "enter_acct.wav";
            parameters["play3"] = "if both wave files played before this, this test succeeds";
