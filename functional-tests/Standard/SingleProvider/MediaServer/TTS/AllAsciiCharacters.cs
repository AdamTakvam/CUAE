...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1015")]
    public class AllAsciiCharacters : FunctionalTestBase
    {
        ...
        private bool hungup;
        public AllAsciiCharacters () : base(typeof( AllAsciiCharacters ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play1"] = "bogus text 	 ~`^()_{}[]| end bogus text.";
