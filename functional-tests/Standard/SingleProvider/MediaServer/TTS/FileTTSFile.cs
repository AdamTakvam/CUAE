...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1013")]
    public class FileTTSFile : FunctionalTestBase
    {
        ...
        private bool hungup;
        public FileTTSFile () : base(typeof( FileTTSFile ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play1"] = "enter_pin.wav";
            parameters["play2"] = "if the first wave preceded, and the second follows, this test succeeds.";
            parameters["play3"] = "enter_acct.wav";
