...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1009")]
    public class TTSMissing : FunctionalTestBase
    {
        ...
        private bool hungup;
        public TTSMissing () : base(typeof( TTSMissing ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play1"] = "if you hear this the test fails.";
            parameters["play2"] = "no_such_file.wav";
            parameters["play3"] = null;
            ...
            if(success)
            {
                log.Write(System.Diagnostics.TraceLevel.Info, "The play completed successfully, which should not have happened");
                return false;
            }
