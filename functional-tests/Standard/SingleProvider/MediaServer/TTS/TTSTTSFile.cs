...
namespace Metreos.FunctionalTests.SingleProvider.MediaServer.TTS
{
    ...
    [QaTest(Id="TESTCASE-MMS-1011")]
    public class TTSTTSFile : FunctionalTestBase
    {
        ...
        private bool hungup;
        public TTSTTSFile () : base(typeof( TTSTTSFile ))
        {
        }
        ...
        public override bool Execute()
        {
            ...
            parameters["play1"] = "if this is spoken first.";
            parameters["play2"] = "and the wave file follows this, the test succeeds.";
            parameters["play3"] = "enter_pin.wav";
