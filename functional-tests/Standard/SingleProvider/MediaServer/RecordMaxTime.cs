...
using RecordTest = Metreos.TestBank.Provider.Provider.RecordMaxTime;
...
namespace Metreos.FunctionalTesats.SingleProvider.MediaServer
{
    ...
    public class RecordMaxTime : FunctionalTestBase
    {
        ...
        public RecordMaxTime() : base(typeof( RecordMaxTime ))
        {
        }
