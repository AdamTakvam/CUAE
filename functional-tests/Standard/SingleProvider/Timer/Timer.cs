...
namespace Metreos.FunctionalTests.SingleProvider.Timer
{
    ...
    public class AddRegularTimer : FunctionalTestBase
    {
        public AddRegularTimer() : base(typeof( AddRegularTimer ))
        {
        ...
        public override bool Execute()
        {
            ...
            if( !WaitForSignal(TimerTest.script1.S_TimerFire.FullName) )
            {
