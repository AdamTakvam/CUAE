...
using SessionCleanConnectionAndCallTest = Metreos.TestBank.ARE.ARE.SessionCleanConnectionAndCall;
...
namespace Metreos.FunctionalTests.Standard.ARE.Sessions
{
    ...
    public class SessionCleanConnectionAndCall : FunctionalTestBase
	{
        private const string number = "number";
        private const string callManagerIp = "callManager";

        public SessionCleanConnectionAndCall() : base(typeof( SessionCleanConnectionAndCall ))
        {
            this.Instructions = "This test will make one a call and a connection.  Watch that the Application Sever hangs up the call after the script exits.";
        }
        ...
        public override bool Execute()
        {
            ...
            TriggerScript( SessionCleanConnectionAndCallTest.script1.FullName, fields );
            return true;
        }
    
        public override string[] GetRequiredTests()
        {
            return new string[] { ( SessionCleanConnectionAndCallTest.FullName ) };
        }
