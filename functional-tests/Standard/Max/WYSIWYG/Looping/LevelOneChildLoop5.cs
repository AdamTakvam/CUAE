...
using LevelOneChildLoopTest = Metreos.TestBank.Max.Max.LevelOneChildLoop5;
...
namespace Metreos.FunctionalTests.Standard.Max.WYSIWYG.Looping
{
    ...
    public class LevelOneChildLoop5 : FunctionalTestBase
    {
        ...
        public LevelOneChildLoop5() : base(typeof( LevelOneChildLoop5 ))
        {
        ...
        public override bool Execute()
        {
            ...
            for(int i = 0; i < levelZeroCount; i++)
            {
                ...
                {
                    log.Write(System.Diagnostics.TraceLevel.Info, "Did not the signal from the level zero child loop" + LevelOneChildLoopTest.script1.S_LevelOne.Name);
                    return false;
                }
        ...
        public override CallbackLink[] GetCallbacks()
        {
            return new CallbackLink[] {
                ...
                new CallbackLink( LevelOneChildLoopTest.script1.S_LevelOneB.FullName, new FunctionalTestSignalDelegate(ReceivedSignalTwo)) };
        }
    } 
}
