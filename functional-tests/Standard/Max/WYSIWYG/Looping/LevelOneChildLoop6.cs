...
using LevelOneChildLoopTest = Metreos.TestBank.Max.Max.LevelOneChildLoop6;
...
namespace Metreos.FunctionalTests.Standard.Max.WYSIWYG.Looping
{
	...
	public class LevelOneChildLoop6 : FunctionalTestBase
	{
        ...
        public LevelOneChildLoop6() : base(typeof( LevelOneChildLoop6 ))
        {
