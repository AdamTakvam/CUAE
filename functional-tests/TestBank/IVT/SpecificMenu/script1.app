<Application name="script1" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632521058645571467" level="1" text="Metreos.Providers.Http.GotRequest (trigger): OnGotRequest">
        ...
        <Properties type="hybrid">
          <ep name="url" type="literal">/SpecificMenu</ep>
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="g_remoteHost" id="632527174907346248" vid="632521063257319714">
        <Properties type="String">g_remoteHost</Properties>
      </treenode>
      <treenode text="g_host" id="632527174907346250" vid="632521063257319716">
  ...
  <canvas type="Function" name="OnEvent" activetab="true" startnode="632521064764204372" treenode="632521064764204373" appnode="632521064764204370" handlerfor="632521064764204369">
    <node type="Start" id="632521064764204372" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="32" y="344">
      <linkto id="632521064764204412" type="Basic" style="Bezier" ortho="true" />
    </node>
    <node type="Action" id="632521064764204379" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="592" y="344">
    ...
    <node type="Action" id="632521064764204380" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="760" y="344">
      <Properties final="true" type="appControl" log="On">
      </Properties>
    </node>
    <node type="Action" id="632521064764204412" name="CreateMenu" class="MaxActionNode" group="" path="Metreos.Native.CiscoIpPhone" x="224" y="344">
      <linkto id="632521064764204413" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
    ...
    <node type="Action" id="632521064764204413" name="AddMenuItem" class="MaxActionNode" group="" path="Metreos.Native.CiscoIpPhone" x="336" y="344">
      <linkto id="632521064764204414" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="Name" type="variable">menuName1</ap>
        <ap name="URL" type="variable">menuUrl1</ap>
        <rd field="ResultData">menuXml</rd>
      </Properties>
    </node>
    <node type="Action" id="632521064764204414" name="AddMenuItem" class="MaxActionNode" group="" path="Metreos.Native.CiscoIpPhone" x="464" y="344">
      <linkto id="632521064764204379" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="Name" type="variable">menuName2</ap>
        <ap name="URL" type="variable">menuUrl2</ap>
        <rd field="ResultData">menuXml</rd>
      </Properties>
    </node>
    ...
    <node type="Variable" id="632521064764204376" name="menuName1" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="String" initWith="menuName1" refType="reference">menuName1</Properties>
    </node>
    <node type="Variable" id="632521064764204409" name="menuName2" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="String" initWith="menuName2" refType="reference">menuName2</Properties>
    </node>
    <node type="Variable" id="632521064764204410" name="menuUrl1" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="String" initWith="menuUrl1" refType="reference">menuUrl1</Properties>
    </node>
    <node type="Variable" id="632521064764204411" name="menuUrl2" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="String" initWith="menuUrl2" refType="reference">menuUrl2</Properties>
    </node>
    <node type="Variable" id="632521064764204415" name="menuXml" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
