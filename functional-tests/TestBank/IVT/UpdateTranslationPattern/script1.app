<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.8" single="false">
    ...
    <outline>
      <treenode type="evh" id="632531378747997245" level="1" text="Metreos.Providers.FunctionalTest.TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">IVT.UpdateTranslationPattern.script1</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="S_UpdateTranslationPatternResponse" id="632531424449612675" vid="632531378747997303">
        <Properties type="String" initWith="S_UpdateTranslationPatternResponse">S_UpdateTranslationPatternResponse</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" activetab="true" startnode="632531378747997244" treenode="632531378747997245" appnode="632531378747997242" handlerfor="632531378747997241">
    <node type="Start" id="632531378747997244" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="44" y="372">
      <linkto id="632531424449612692" type="Basic" style="Bezier" ortho="true" />
    </node>
    <node type="Action" id="632531378747997315" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="591" y="373">
      ...
      <Properties final="false" type="provider" log="On">
        ...
        <ap name="signalName" type="variable">S_UpdateTranslationPatternResponse</ap>
      </Properties>
    </node>
    ...
    <node type="Action" id="632531424449612692" name="UpdateTranslationPattern" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="435" y="372">
      ...
      <Properties final="false" type="native" log="On">
        <ap name="CalledPartyTransformationMask" type="variable">calledxformmask</ap>
        <ap name="CallingPartyTransformationMask" type="variable">callingxformmask</ap>
    ...
    <node type="Variable" id="632531424449612694" name="calledxformmask" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="String" initWith="calledxformmask" refType="reference">calledxformmask</Properties>
    </node>
    <node type="Variable" id="632531424449612695" name="callingxformmask" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="String" initWith="callingxformmask" refType="reference">callingxformmask</Properties>
    </node>
  </canvas>
  <!--//// hidden canvases ////-->
