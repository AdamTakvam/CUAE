<Application name="script2" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.8" single="false">
    ...
    <outline>
      <treenode type="evh" id="632527174907346806" level="1" text="Metreos.Providers.FunctionalTest.TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">IVT.CreateStatusFile.script2</ep>
        </Properties>
      </treenode>
    </outline>
    <variables />
  ...
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" startnode="632527174907346805" treenode="632527174907346806" appnode="632527174907346803" handlerfor="632527174907346802">
