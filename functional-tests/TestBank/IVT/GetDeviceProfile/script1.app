<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.8" single="false">
    ...
    <outline>
      <treenode type="evh" id="632531378747997245" level="1" text="Metreos.Providers.FunctionalTest.TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">IVT.GetDeviceProfile.script1</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="S_GetDeviceProfileResponse" id="632532296746194782" vid="632531378747997303">
        <Properties type="String" initWith="S_GetDeviceProfileResponse">S_GetDeviceProfileResponse</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" activetab="true" startnode="632531378747997244" treenode="632531378747997245" appnode="632531378747997242" handlerfor="632531378747997241">
    <node type="Start" id="632531378747997244" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="44" y="372">
      <linkto id="632531378747997565" type="Basic" style="Bezier" ortho="true" />
    </node>
...
public static string Execute(Metreos.Types.AxlSoap333.GetDeviceProfileResponse response, ref string message)
{
	int numLines = response.Response.@return.profile.lines == null ? 0 : 
			         response.Response.@return.profile.lines.Items.Length;


	string description = response.Response.@return.profile.description;

	string devicePool = response.Response.@return.profile.Item3 == null ? "&lt;None&gt;" : response.Response.@return.profile.Item3.ToString();
    ...
    <node type="Action" id="632531378747997315" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="595" y="373">
      ...
      <Properties final="false" type="provider" log="On">
        ...
        <ap name="signalName" type="variable">S_GetDeviceProfileResponse</ap>
      </Properties>
    </node>
    ...
    <node type="Action" id="632531378747997565" name="GetDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="244" y="370">
      ...
      <Properties final="false" type="native" log="On">
        <ap name="ProfileName" type="variable">devicename</ap>
        ...
        <rd field="GetDeviceProfileResponse">response</rd>
    ...
    <node type="Variable" id="632531378747997310" name="response" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap333.GetDeviceProfileResponse" refType="reference">response</Properties>
    </node>
