<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632146032163593938" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">Max.Label4.script1</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="S_Simple" id="632224881663907969" vid="632146012209687659">
        <Properties type="Metreos.Types.String" initWith="S_Simple">S_Simple</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" activetab="true" varsy="692" startnode="632146012209687652" treenode="632146032163593938" appnode="632146012209687651" handlerfor="632146012209687650">
    ...
    <node type="Action" id="632146012209687658" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="520" y="193">
      <linkto id="632224881663907979" type="Labeled" style="Bezier" ortho="true" label="default" />
    ...
    <node type="Label" id="632146032163593947" text="B" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="375" y="195" />
    <node type="Label" id="632146032163593948" text="B" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="433" y="194">
      <linkto id="632146012209687658" type="Basic" style="Bezier" ortho="true" />
    </node>
    <node type="Action" id="632224881663907979" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="631" y="190">
