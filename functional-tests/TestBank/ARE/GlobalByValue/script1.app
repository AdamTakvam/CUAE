<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632229256274375151" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">ARE.GlobalByValue.script1</ep>
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="S_Simple" id="632229806375000177" vid="632229256274375179">
        <Properties type="Metreos.Types.String" initWith="S_Simple">S_Simple</Properties>
      </treenode>
      <treenode text="testVarGlobal" id="632229806375000189" vid="632229806375000188">
        <Properties type="Metreos.Types.String" defaultInitWith="specificValue">testVarGlobal</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" activetab="true" varsy="692" startnode="632229256274375150" treenode="632229256274375151" appnode="632229256274375148" handlerfor="632229256274375147">
