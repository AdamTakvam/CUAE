<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632229256274375151" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">ARE.LocalByRefPrimitive.script1</ep>
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="S_Simple" id="632229786183125155" vid="632229256274375179">
  ...
  <canvas type="Function" name="ByValueFunction" varsy="667" startnode="632229256274375172" treenode="632229256274375173" appnode="632229256274375170" handlerfor="632229256274375147">
    ...
    <node type="Variable" id="632229256274375175" name="testVar" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="17" y="685">
      <Properties type="Metreos.Types.Int" initWith="testVarValue" refType="reference">testVar</Properties>
    </node>
