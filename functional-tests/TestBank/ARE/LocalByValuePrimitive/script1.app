<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632229256274375151" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">ARE.LocalByValuePrimitive.script1</ep>
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="S_Simple" id="632229763116562706" vid="632229256274375179">
        <Properties type="Metreos.Types.String" initWith="S_Simple">S_Simple</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" varsy="667" startnode="632229256274375150" treenode="632229256274375151" appnode="632229256274375148" handlerfor="632229256274375147">
    ...
    <node type="Variable" id="632229256274375168" name="testVar" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="17" y="685">
      <Properties type="Metreos.Types.Int" defaultInitWith="1" refType="reference">testVar</Properties>
    </node>
  ...
  <canvas type="Function" name="ByValueFunction" activetab="true" varsy="667" startnode="632229256274375172" treenode="632229256274375173" appnode="632229256274375170" handlerfor="632229256274375147">
    ...
    <node type="Variable" id="632229256274375175" name="testVar" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="17" y="685">
      <Properties type="Metreos.Types.Int" initWith="testVarValue" refType="value">testVar</Properties>
    </node>
	...
	public static string Execute(ref int testVar)
	{
	 testVar = 2;
return String.Empty;
