<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632145353336406374" level="1" text="TriggerApp (trigger): OnTriggerApp">
    ...
    <variables>
      <treenode text="S_One" id="632224792549062664" vid="632145265340625254">
        <Properties type="Metreos.Types.String" initWith="S_One">S_One</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" activetab="true" varsy="692" startnode="632145265340625228" treenode="632145353336406374" appnode="632145265340625227" handlerfor="632145265340625226">
    ...
    <node type="Action" id="632145265340625256" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="330" y="205">
      <linkto id="632224792549062669" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_One</ap>
      </Properties>
    </node>
    <node type="Action" id="632224792549062669" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="514" y="204">
