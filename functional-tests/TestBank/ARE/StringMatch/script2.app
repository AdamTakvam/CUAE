<Application name="script2" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script2">
    <outline>
      <treenode type="evh" id="632145265340625204" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">ARE.StringMatch.script2</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="S_Two" id="632224814145469290" vid="632145265340625192">
        <Properties type="Metreos.Types.String" initWith="S_Two">S_Two</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" varsy="692" startnode="632145265340625190" treenode="632145265340625204" appnode="632145265340625189" handlerfor="632145265340625188">
    ...
    <node type="Action" id="632145265340625209" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="348" y="335">
      <linkto id="632224814145469295" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_Two</ap>
      </Properties>
    </node>
    <node type="Action" id="632224814145469295" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="572" y="344">
