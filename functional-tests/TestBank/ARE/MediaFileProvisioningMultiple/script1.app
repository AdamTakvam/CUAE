<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.7" single="false">
    ...
    <outline>
      <treenode type="evh" id="632278574451250174" level="1" text="Metreos.Providers.FunctionalTest.TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">ARE.MediaFileProvisioningMultiple.script1</ep>
        </Properties>
      </treenode>
    </outline>
    <variables />
  ...
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" activetab="true" startnode="632278574451250173" treenode="632278574451250174" appnode="632278574451250171" handlerfor="632278574451250170">
    ...
    <node type="Action" id="632278574451250175" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="497" y="368">
