<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.8" single="false">
    ...
    <outline>
      <treenode type="evh" id="632277756578281510" level="1" text="Metreos.Providers.FunctionalTest.TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">ARE.ExecuteCommand.script1</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="S_Success" id="632580609502868745" vid="632277756578281521">
        <Properties type="Metreos.Types.String" initWith="S_Success">S_Success</Properties>
      </treenode>
      <treenode text="S_Failure" id="632580609502868747" vid="632277756578281523">
  ...
  <canvas type="Function" name="OnTriggerApp" activetab="true" startnode="632277756578281509" treenode="632277756578281510" appnode="632277756578281507" handlerfor="632277756578281506">
    ...
    <node type="Action" id="632277756578281519" name="OpenDatabase" class="MaxActionNode" group="" path="Metreos.Native.Database" x="131" y="367">
      <linkto id="632277756578281571" type="Labeled" style="Bevel" label="default" />
    ...
    <node type="Action" id="632277756578281525" name="ExecuteQuery" class="MaxActionNode" group="" path="Metreos.Native.Database" x="405" y="368">
      <linkto id="632277756578281527" type="Labeled" style="Bevel" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="Query" type="literal">SELECT value from main where name = 'name2'</ap>
        <ap name="Name" type="literal">whatever</ap>
    ...
    <node type="Action" id="632277756578281527" name="Compare" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="546" y="367">
      ...
      <Properties final="false" type="native" log="On">
        ...
        <ap name="Value2" type="literal">value2</ap>
      </Properties>
    </node>
    ...
    <node type="Action" id="632277756578281571" name="ExecuteCommand" class="MaxActionNode" group="" path="Metreos.Native.Database" x="256" y="367">
      <linkto id="632277756578281525" type="Labeled" style="Bevel" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="Command" type="literal">INSERT INTO main (name, value) VALUES('name2', 'value2')</ap>
        <ap name="Name" type="literal">whatever</ap>
      </Properties>
    </node>
