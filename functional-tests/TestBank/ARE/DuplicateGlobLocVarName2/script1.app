<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
    ...
    <outline>
      <treenode type="evh" id="632241798842656415" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">ARE.DuplicateGlobLocVarName2.script1</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="dupName" id="632241798842656438" vid="632241798842656424">
        <Properties type="Metreos.Types.Int" defaultInitWith="1">dupName</Properties>
      </treenode>
      <treenode text="S_Signal" id="632241798842656440" vid="632241798842656427">
  ...
  <canvas type="Function" name="OnTriggerApp" activetab="true" varsy="667" startnode="632241798842656414" treenode="632241798842656415" appnode="632241798842656412" handlerfor="632241798842656411">
    <node type="Start" id="632241798842656414" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="34" y="332">
      <linkto id="632241798842656445" type="Basic" style="Bezier" ortho="true" />
    </node>
    ...
    <node type="Action" id="632241798842656429" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="368" y="331">
    ...
    <node type="Action" id="632241798842656430" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="583" y="330">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632241798842656445" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="171" y="330">
      <linkto id="632241798842656429" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties language="csharp">
	public static string Execute(ref int dupName)
	{
		dupName++;
