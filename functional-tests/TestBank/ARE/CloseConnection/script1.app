<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.7" single="false">
    ...
    <outline>
      <treenode type="evh" id="632277666755469218" level="1" text="Metreos.Providers.FunctionalTest.TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">ARE.CloseConnection.script1</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="S_Success" id="632277828331719052" vid="632277666755469246">
        <Properties type="Metreos.Types.String" initWith="S_Success">S_Success</Properties>
      </treenode>
      <treenode text="S_Failure" id="632277828331719054" vid="632277666755469259">
  ...
  <canvas type="Function" name="OnTriggerApp" activetab="true" startnode="632277666755469217" treenode="632277666755469218" appnode="632277666755469215" handlerfor="632277666755469214">
    ...
    <node type="Action" id="632277747735000185" name="OpenDatabase" class="MaxActionNode" group="" path="Metreos.Native.Database" x="162" y="371">
      <linkto id="632277756578281613" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
        <ap name="DSN" type="literal">DSN=testframework;UID=root;PWD=</ap>
        <ap name="Name" type="literal">closeconnection</ap>
    ...
    <node type="Action" id="632277756578281613" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="316" y="373">
      <linkto id="632277666755469275" type="Labeled" style="Bezier" ortho="true" label="success" />
	...
	public static string Execute(SessionData sessionData)
	{
		try
		{
			IDbConnection connection = sessionData.DbConnections["closeconnection"] as IDbConnection;
