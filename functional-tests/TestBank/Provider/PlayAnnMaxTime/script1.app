<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632150611285781381" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">Provider.PlayAnnMaxTime.script1</ep>
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="connectionId1" id="632224881663906627" vid="632150611285781382">
        <Properties type="Metreos.Types.Int">connectionId1</Properties>
      </treenode>
      <treenode text="connectionId2" id="632224881663906629" vid="632150611285781384">
        <Properties type="Metreos.Types.Int">connectionId2</Properties>
      </treenode>
      <treenode text="mediaIp1" id="632224881663906631" vid="632150611285781386">
        <Properties type="Metreos.Types.String">mediaIp1</Properties>
      </treenode>
      <treenode text="mediaIp2" id="632224881663906633" vid="632150611285781388">
        <Properties type="Metreos.Types.String">mediaIp2</Properties>
      </treenode>
      <treenode text="mediaPort1" id="632224881663906635" vid="632150611285781390">
        <Properties type="Metreos.Types.Int">mediaPort1</Properties>
      </treenode>
      <treenode text="mediaPort2" id="632224881663906637" vid="632150611285781392">
        <Properties type="Metreos.Types.Int">mediaPort2</Properties>
      </treenode>
      <treenode text="S_FailureToStart" id="632224881663906639" vid="632150611285781398">
        <Properties type="Metreos.Types.String" initWith="S_FailureToStart">S_FailureToStart</Properties>
      </treenode>
      <treenode text="S_Started" id="632224881663906641" vid="632150611285781412">
        <Properties type="Metreos.Types.String" initWith="S_Started">S_Started</Properties>
      </treenode>
      <treenode text="S_PlayFailed" id="632224881663906643" vid="632150611285781418">
        <Properties type="Metreos.Types.String" initWith="S_PlayFailed">S_PlayFailed</Properties>
      </treenode>
      <treenode text="S_PlaySuccess" id="632224881663906645" vid="632150611285781422">
  ...
  <canvas type="Function" name="OnTriggerApp" activetab="true" varsy="692" startnode="632150611285781380" treenode="632150611285781381" appnode="632150611285781379" handlerfor="632150611285781378">
    ...
    <node type="Action" id="632150611285781415" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="441" y="410">
      <linkto id="632224881663906676" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150611285781416" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="696" y="221">
      <linkto id="632224881663906677" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632224881663906676" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="446" y="502">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906677" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="796.7611" y="222">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Complete" varsy="667" startnode="632150611285781402" treenode="632150611285781403" appnode="632150611285781401" handlerfor="632150611285781400">
    ...
    <node type="Action" id="632150611285781426" name="DeleteConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="173" y="177">
      <linkto id="632151253429844152" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId1</ap>
    ...
    <node type="Action" id="632150611285781429" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="484" y="176">
      <linkto id="632224881663906675" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="resultCode" type="variable">resultCode</ap>
        <ap name="signalName" type="variable">S_PlaySuccess</ap>
      </Properties>
    </node>
    <node type="Action" id="632151253429844152" name="DeleteConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="320" y="176">
      <linkto id="632150611285781429" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId2</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906675" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="650" y="199">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Failed" varsy="692" startnode="632150611285781406" treenode="632150611285781407" appnode="632150611285781405" handlerfor="632150611285781404">
    ...
    <node type="Action" id="632150611285781420" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="388" y="180">
      <linkto id="632224881663906674" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150611285781579" name="DeleteConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="172" y="180">
      <linkto id="632151253429844153" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId1</ap>
      </Properties>
    </node>
    <node type="Action" id="632151253429844153" name="DeleteConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="289" y="181">
      <linkto id="632150611285781420" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId2</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906674" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="599" y="196">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
