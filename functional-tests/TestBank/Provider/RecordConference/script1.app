<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632150611285781381" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">Provider.RecordConference.script1</ep>
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="connectionId1" id="632224881663906822" vid="632150611285781382">
        <Properties type="Metreos.Types.Int">connectionId1</Properties>
      </treenode>
      <treenode text="connectionId2" id="632224881663906824" vid="632150611285781384">
        <Properties type="Metreos.Types.Int">connectionId2</Properties>
      </treenode>
      <treenode text="mediaIp1" id="632224881663906826" vid="632150611285781386">
        <Properties type="Metreos.Types.String">mediaIp1</Properties>
      </treenode>
      <treenode text="mediaIp2" id="632224881663906828" vid="632150611285781388">
        <Properties type="Metreos.Types.String">mediaIp2</Properties>
      </treenode>
      <treenode text="mediaPort1" id="632224881663906830" vid="632150611285781390">
        <Properties type="Metreos.Types.Int">mediaPort1</Properties>
      </treenode>
      <treenode text="mediaPort2" id="632224881663906832" vid="632150611285781392">
        <Properties type="Metreos.Types.Int">mediaPort2</Properties>
      </treenode>
      <treenode text="S_FailureToStart" id="632224881663906834" vid="632150611285781398">
        <Properties type="Metreos.Types.String" initWith="S_FailureToStart">S_FailureToStart</Properties>
      </treenode>
      <treenode text="S_Started" id="632224881663906836" vid="632150611285781412">
        <Properties type="Metreos.Types.String" initWith="S_Started">S_Started</Properties>
      </treenode>
      <treenode text="S_RecordFailed" id="632224881663906838" vid="632150611285781418">
        <Properties type="Metreos.Types.String" initWith="S_RecordFailed">S_RecordFailed</Properties>
      </treenode>
      <treenode text="S_RecordSuccess" id="632224881663906840" vid="632150611285781422">
        <Properties type="Metreos.Types.String" initWith="S_RecordSuccess">S_RecordSuccess</Properties>
      </treenode>
      <treenode text="firstPlayDone" id="632224881663906842" vid="632151253429844218">
        <Properties type="Metreos.Types.Bool">firstPlayDone</Properties>
      </treenode>
      <treenode text="S_FirstPlayDone" id="632224881663906844" vid="632151253429844334">
        <Properties type="Metreos.Types.String" initWith="S_FirstPlayDone">S_FirstPlayDone</Properties>
      </treenode>
      <treenode text="conferenceId" id="632224881663906846" vid="632155560786094080">
  ...
  <canvas type="Function" name="OnTriggerApp" varsy="692" startnode="632150611285781380" treenode="632150611285781381" appnode="632150611285781379" handlerfor="632150611285781378">
    ...
    <node type="Action" id="632150611285781415" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="439" y="410">
      <linkto id="632224881663906906" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150611285781416" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="1225" y="225">
      <linkto id="632224881663906908" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150839508750161" name="CreateConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="295" y="223">
    ...
    <node type="Action" id="632224881663906906" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="422" y="527">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906907" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="1478.761" y="223">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906908" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="1339.761" y="219">
      <linkto id="632224881663906907" type="Labeled" style="Bezier" ortho="true" label="default" />
...
return String.Empty;
  ...
  <canvas type="Function" name="OnRecordAudio_Complete" varsy="692" startnode="632151253429843915" treenode="632151253429843916" appnode="632151253429843914" handlerfor="632151253429843913">
    ...
    <node type="Action" id="632151253429844242" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="532" y="394">
      <linkto id="632224881663906910" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632151253429844336" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="519" y="218">
      <linkto id="632224881663906909" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_FirstPlayDone</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906909" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="629" y="208">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906910" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="649" y="380">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Complete" activetab="true" varsy="667" startnode="632151253429844208" treenode="632151253429844209" appnode="632151253429844207" handlerfor="632151253429844206">
    ...
    <node type="Action" id="632151253429844223" name="Switch" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="381" y="183">
      ...
      <linkto id="632224881663906913" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632151253429844245" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="634.7611" y="329">
      <linkto id="632224881663906912" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordSuccess</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906911" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="690" y="186">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906912" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="717" y="317">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906913" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="512" y="179">
      <linkto id="632224881663906911" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties language="csharp">	public static string Execute(bool firstPlayDone)
	{
firstPlayDone = true;
return String.Empty;
  ...
  <canvas type="Function" name="OnPlayAnnouncement_Failed" varsy="667" startnode="632151253429844212" treenode="632151253429844213" appnode="632151253429844211" handlerfor="632151253429844210">
    ...
    <node type="Action" id="632151253429844246" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="829.0762" y="167">
      <linkto id="632224881663906914" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordFailed</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906914" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="916.0762" y="169">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnRecordAudio_Failed" varsy="692" startnode="632151253429843919" treenode="632151253429843920" appnode="632151253429843918" handlerfor="632151253429843917">
    ...
    <node type="Action" id="632151253429843928" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="466" y="164">
      <linkto id="632224881663906915" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordFailed</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906915" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="614" y="131">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
