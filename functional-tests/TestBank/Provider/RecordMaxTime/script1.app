<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632150611285781381" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">Provider.RecordMaxTime.script1</ep>
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="connectionId1" id="632224881663907074" vid="632150611285781382">
        <Properties type="Metreos.Types.Int">connectionId1</Properties>
      </treenode>
      <treenode text="connectionId2" id="632224881663907076" vid="632150611285781384">
        <Properties type="Metreos.Types.Int">connectionId2</Properties>
      </treenode>
      <treenode text="mediaIp1" id="632224881663907078" vid="632150611285781386">
        <Properties type="Metreos.Types.String">mediaIp1</Properties>
      </treenode>
      <treenode text="mediaIp2" id="632224881663907080" vid="632150611285781388">
        <Properties type="Metreos.Types.String">mediaIp2</Properties>
      </treenode>
      <treenode text="mediaPort1" id="632224881663907082" vid="632150611285781390">
        <Properties type="Metreos.Types.Int">mediaPort1</Properties>
      </treenode>
      <treenode text="mediaPort2" id="632224881663907084" vid="632150611285781392">
        <Properties type="Metreos.Types.Int">mediaPort2</Properties>
      </treenode>
      <treenode text="S_FailureToStart" id="632224881663907086" vid="632150611285781398">
        <Properties type="Metreos.Types.String" initWith="S_FailureToStart">S_FailureToStart</Properties>
      </treenode>
      <treenode text="S_Started" id="632224881663907088" vid="632150611285781412">
        <Properties type="Metreos.Types.String" initWith="S_Started">S_Started</Properties>
      </treenode>
      <treenode text="S_RecordFailed" id="632224881663907090" vid="632150611285781418">
        <Properties type="Metreos.Types.String" initWith="S_RecordFailed">S_RecordFailed</Properties>
      </treenode>
      <treenode text="S_RecordSuccess" id="632224881663907092" vid="632150611285781422">
        <Properties type="Metreos.Types.String" initWith="S_RecordSuccess">S_RecordSuccess</Properties>
      </treenode>
      <treenode text="firstPlayDone" id="632224881663907094" vid="632151253429844218">
        <Properties type="Metreos.Types.Bool">firstPlayDone</Properties>
      </treenode>
      <treenode text="S_FirstPlayDone" id="632224881663907096" vid="632151253429844334">
        <Properties type="Metreos.Types.String" initWith="S_FirstPlayDone">S_FirstPlayDone</Properties>
      </treenode>
      <treenode text="conferenceId" id="632224881663907098" vid="632155560786094080">
  ...
  <canvas type="Function" name="OnTriggerApp" varsy="692" startnode="632150611285781380" treenode="632150611285781381" appnode="632150611285781379" handlerfor="632150611285781378">
    ...
    <node type="Action" id="632150611285781415" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="439" y="410">
      <linkto id="632224881663907162" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150611285781416" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="1225" y="225">
      <linkto id="632224881663907164" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632151253429843921" name="RecordAudio" class="MaxAsyncActionNode" group="" path="Metreos.Providers.MediaServer" x="982" y="212" mx="1058" my="228">
      ...
      <Properties final="false" type="provider">
        <ap name="termCondMaxTime" type="literal">20000</ap>
    ...
    <node type="Action" id="632224881663907162" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="444" y="498">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663907163" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="1480.761" y="225">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663907164" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="1346.761" y="225">
      <linkto id="632224881663907163" type="Labeled" style="Bezier" ortho="true" label="default" />
...
return String.Empty;
  ...
  <canvas type="Function" name="OnRecordAudio_Complete" varsy="692" startnode="632151253429843915" treenode="632151253429843916" appnode="632151253429843914" handlerfor="632151253429843913">
    ...
    <node type="Action" id="632151253429844242" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="532" y="394">
      <linkto id="632224881663907165" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632151253429844336" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="519" y="218">
      <linkto id="632224881663907166" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_FirstPlayDone</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663907165" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="622" y="402">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663907166" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="638" y="241">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Complete" varsy="667" startnode="632151253429844208" treenode="632151253429844209" appnode="632151253429844207" handlerfor="632151253429844206">
    ...
    <node type="Action" id="632151253429844223" name="Switch" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="381" y="183">
      ...
      <linkto id="632224881663907169" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632151253429844245" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="634.7611" y="329">
      <linkto id="632224881663907168" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordSuccess</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663907168" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="702.7611" y="335">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663907169" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="544.7611" y="181">
      <linkto id="632224881663907170" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties language="csharp">	public static string Execute(bool firstPlayDone)
	{
firstPlayDone = true;
return String.Empty;
    ...
    <node type="Action" id="632224881663907170" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="682.7611" y="181">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Failed" varsy="667" startnode="632151253429844212" treenode="632151253429844213" appnode="632151253429844211" handlerfor="632151253429844210">
    ...
    <node type="Action" id="632151253429844246" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="829.0762" y="167">
      <linkto id="632224881663907171" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordFailed</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663907171" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="914.0762" y="163">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnRecordAudio_Failed" activetab="true" varsy="692" startnode="632151253429843919" treenode="632151253429843920" appnode="632151253429843918" handlerfor="632151253429843917">
    ...
    <node type="Action" id="632151253429843928" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="466" y="164">
      <linkto id="632224881663907172" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordFailed</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663907172" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="589" y="162">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="SendDigit" varsy="692" startnode="632156534533437895" treenode="632156534533437896" appnode="632156534533437894" handlerfor="632156534533437893">
    ...
    <node type="Action" id="632156534533437897" name="SendDigits" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="374" y="189">
      <linkto id="632224881663907173" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="digits" type="literal">#</ap>
        <ap name="connectionId" type="variable">connectionId1</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663907173" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="532" y="203">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
