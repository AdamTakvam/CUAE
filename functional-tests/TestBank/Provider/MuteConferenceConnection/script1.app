    ...
    <outline>
      <treenode type="evh" id="632150611285781381" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">Provider.MuteConferenceConnection.script1</ep>
        </Properties>
      </treenode>
      ...
      <treenode type="evh" id="632158425462968977" level="2" text="PlayAnnouncement_Complete: OnPlayAnnouncement_Complete">
        <node type="function" name="OnPlayAnnouncement_Complete" id="632151253429844207" path="Metreos.StockTools" />
        <node type="event" name="PlayAnnouncement_Complete" id="632151253429844206" path="Metreos.Providers.MediaServer.PlayAnnouncement_Complete" />
        <Properties type="asyncCallback">
        </Properties>
      </treenode>
      <treenode type="evh" id="632158425462968978" level="2" text="PlayAnnouncement_Failed: OnPlayAnnouncement_Failed">
        <node type="function" name="OnPlayAnnouncement_Failed" id="632151253429844211" path="Metreos.StockTools" />
        <node type="event" name="PlayAnnouncement_Failed" id="632151253429844210" path="Metreos.Providers.MediaServer.PlayAnnouncement_Failed" />
        <Properties type="asyncCallback">
        </Properties>
      ...
      <treenode type="evh" id="632156534533437896" level="1" text="Event: SendDigit">
        ...
        <Properties type="nonTriggering">
          <ep name="uniqueEventParam" type="literal">Provider.MuteConferenceConnection.script1.E_SendDigit</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="connectionId1" id="632224875425625174" vid="632150611285781382">
        <Properties type="Metreos.Types.Int">connectionId1</Properties>
      </treenode>
      <treenode text="connectionId2" id="632224875425625176" vid="632150611285781384">
        <Properties type="Metreos.Types.Int">connectionId2</Properties>
      </treenode>
      <treenode text="mediaIp1" id="632224875425625178" vid="632150611285781386">
        <Properties type="Metreos.Types.String">mediaIp1</Properties>
      </treenode>
      <treenode text="mediaIp2" id="632224875425625180" vid="632150611285781388">
        <Properties type="Metreos.Types.String">mediaIp2</Properties>
      </treenode>
      <treenode text="mediaPort1" id="632224875425625182" vid="632150611285781390">
        <Properties type="Metreos.Types.Int">mediaPort1</Properties>
      </treenode>
      <treenode text="mediaPort2" id="632224875425625184" vid="632150611285781392">
        <Properties type="Metreos.Types.Int">mediaPort2</Properties>
      </treenode>
      <treenode text="S_FailureToStart" id="632224875425625186" vid="632150611285781398">
        <Properties type="Metreos.Types.String" initWith="S_FailureToStart">S_FailureToStart</Properties>
      </treenode>
      <treenode text="S_Started" id="632224875425625188" vid="632150611285781412">
        <Properties type="Metreos.Types.String" initWith="S_Started">S_Started</Properties>
      </treenode>
      <treenode text="S_RecordFailed" id="632224875425625190" vid="632150611285781418">
        <Properties type="Metreos.Types.String" initWith="S_RecordFailed">S_RecordFailed</Properties>
      </treenode>
      <treenode text="S_RecordSuccess" id="632224875425625192" vid="632150611285781422">
        <Properties type="Metreos.Types.String" initWith="S_RecordSuccess">S_RecordSuccess</Properties>
      </treenode>
      <treenode text="firstPlayDone" id="632224875425625194" vid="632151253429844218">
        <Properties type="Metreos.Types.Bool">firstPlayDone</Properties>
      </treenode>
      <treenode text="S_FirstPlayDone" id="632224875425625196" vid="632151253429844334">
        <Properties type="Metreos.Types.String" initWith="S_FirstPlayDone">S_FirstPlayDone</Properties>
      </treenode>
      <treenode text="conferenceId" id="632224875425625198" vid="632155560786094080">
        <Properties type="Metreos.Types.String">conferenceId</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnTriggerApp" varsy="691" startnode="632150611285781380" treenode="632150611285781381" appnode="632150611285781379" handlerfor="632150611285781378">
    ...
    <node type="Action" id="632150611285781415" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="439" y="410">
      <linkto id="632224855787500498" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150611285781416" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="1225" y="225">
      <linkto id="632224875425625262" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150839508750161" name="CreateConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="295" y="224">
    ...
    <node type="Action" id="632151253429843921" name="RecordAudio" class="MaxAsyncActionNode" group="" path="Metreos.Providers.MediaServer" x="983" y="210" mx="1059" my="226">
      <items count="2">
    ...
    <node type="Action" id="632155560786094079" name="CreateConnectionConference" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="772" y="220">
      <linkto id="632150839508750163" type="Labeled" style="Bezier" ortho="true" label="default" />
      <linkto id="632158425462968979" type="Labeled" style="Bezier" ortho="true" label="success" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId2</ap>
        <ap name="conferenceId" type="variable">conferenceId</ap>
      </Properties>
    </node>
    <node type="Action" id="632158425462968979" name="PlayAnnouncement" class="MaxAsyncActionNode" group="" path="Metreos.Providers.MediaServer" x="829" y="86" mx="922" my="102">
      <items count="2">
        <item text="OnPlayAnnouncement_Complete" treenode="632158425462968977" />
        <item text="OnPlayAnnouncement_Failed" treenode="632158425462968978" />
      </items>
    ...
    <node type="Action" id="632158425462968980" name="Sleep" class="MaxActionNode" group="" path="Metreos.Native.ApplicationControl" x="1442.761" y="223">
      <linkto id="632158425462968981" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
        <ap name="timeout" type="literal">1000</ap>
      </Properties>
    </node>
    <node type="Action" id="632158425462968981" name="MuteConferenceConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="1570.761" y="221">
      <linkto id="632224855787500499" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId1</ap>
        <ap name="conferenceId" type="variable">conferenceId</ap>
      </Properties>
    </node>
    <node type="Action" id="632224855787500498" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="423" y="570">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224855787500499" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="1727.761" y="231">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224875425625262" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="1335" y="228">
      <linkto id="632158425462968980" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties language="csharp">
	public static string Execute(bool firstPlayDone)
	{
	  firstPlayDone = false;
...
return String.Empty;
  ...
  <canvas type="Function" name="OnRecordAudio_Complete" varsy="692" startnode="632151253429843915" treenode="632151253429843916" appnode="632151253429843914" handlerfor="632151253429843913">
    ...
    <node type="Action" id="632151253429844242" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="532" y="394">
      <linkto id="632224875425625264" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632151253429844336" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="519" y="218">
      <linkto id="632224875425625263" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_FirstPlayDone</ap>
      </Properties>
    </node>
    <node type="Action" id="632224875425625263" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="669" y="235">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224875425625264" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="643" y="388">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Complete" activetab="true" varsy="667" startnode="632151253429844208" treenode="632151253429844209" appnode="632151253429844207" handlerfor="632151253429844206">
    ...
    <node type="Action" id="632151253429844223" name="Switch" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="381" y="183">
      ...
      <linkto id="632224875425625265" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632151253429844245" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="634.7611" y="329">
      <linkto id="632224875425625267" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordSuccess</ap>
      </Properties>
    </node>
    <node type="Action" id="632224875425625265" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="571.7611" y="181">
      <linkto id="632224875425625266" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties language="csharp">
		public static string Execute(bool firstPlayDone)
	{
	  firstPlayDone = true;
...
return String.Empty;
    ...
    <node type="Action" id="632224875425625266" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="718.7611" y="172">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224875425625267" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="719.7611" y="321">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Failed" varsy="667" startnode="632151253429844212" treenode="632151253429844213" appnode="632151253429844211" handlerfor="632151253429844210">
    ...
    <node type="Action" id="632151253429844246" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="829.0762" y="167">
      <linkto id="632224875425625268" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordFailed</ap>
      </Properties>
    </node>
    <node type="Action" id="632224875425625268" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="911.0762" y="164">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnRecordAudio_Failed" varsy="692" startnode="632151253429843919" treenode="632151253429843920" appnode="632151253429843918" handlerfor="632151253429843917">
    ...
    <node type="Action" id="632151253429843928" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="466" y="164">
      <linkto id="632224875425625269" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordFailed</ap>
      </Properties>
    </node>
    <node type="Action" id="632224875425625269" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="638" y="176">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="SendDigit" varsy="692" startnode="632156534533437895" treenode="632156534533437896" appnode="632156534533437894" handlerfor="632156534533437893">
    ...
    <node type="Action" id="632156534533437897" name="SendDigits" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="274" y="188">
      <linkto id="632224875425625270" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="digits" type="literal">#</ap>
        <ap name="connectionId" type="variable">connectionId1</ap>
      </Properties>
    </node>
    <node type="Action" id="632224875425625270" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="553" y="171">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
