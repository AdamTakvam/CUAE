<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
    ...
    <outline>
      <treenode type="evh" id="632150611285781381" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">Provider.PlayAnnGotDigits.script1</ep>
        </Properties>
      </treenode>
      ...
      <treenode type="evh" id="632150839508750320" level="1" text="Event: SendDigit">
        ...
        <Properties type="nonTriggering">
          <ep name="uniqueEventParam" type="literal">Provider.PlayAnnGotDigits.script1.E_SendDigit</ep>
        </Properties>
      </treenode>
    </outline>
    <variables>
      <treenode text="connectionId1" id="632224881663906556" vid="632150611285781382">
        <Properties type="Metreos.Types.Int">connectionId1</Properties>
      </treenode>
      <treenode text="connectionId2" id="632224881663906558" vid="632150611285781384">
        <Properties type="Metreos.Types.Int">connectionId2</Properties>
      </treenode>
      <treenode text="mediaIp1" id="632224881663906560" vid="632150611285781386">
        <Properties type="Metreos.Types.String">mediaIp1</Properties>
      </treenode>
      <treenode text="mediaIp2" id="632224881663906562" vid="632150611285781388">
        <Properties type="Metreos.Types.String">mediaIp2</Properties>
      </treenode>
      <treenode text="mediaPort1" id="632224881663906564" vid="632150611285781390">
        <Properties type="Metreos.Types.Int">mediaPort1</Properties>
      </treenode>
      <treenode text="mediaPort2" id="632224881663906566" vid="632150611285781392">
        <Properties type="Metreos.Types.Int">mediaPort2</Properties>
      </treenode>
      <treenode text="S_FailureToStart" id="632224881663906568" vid="632150611285781398">
        <Properties type="Metreos.Types.String" initWith="S_FailureToStart">S_FailureToStart</Properties>
      </treenode>
      <treenode text="S_Started" id="632224881663906570" vid="632150611285781412">
        <Properties type="Metreos.Types.String" initWith="S_Started">S_Started</Properties>
      </treenode>
      <treenode text="S_PlayFailed" id="632224881663906572" vid="632150611285781418">
        <Properties type="Metreos.Types.String" initWith="S_PlayFailed">S_PlayFailed</Properties>
      </treenode>
      <treenode text="S_PlaySuccess" id="632224881663906574" vid="632150611285781422">
  ...
  <canvas type="Function" name="OnTriggerApp" activetab="true" varsy="692" startnode="632150611285781380" treenode="632150611285781381" appnode="632150611285781379" handlerfor="632150611285781378">
    ...
    <node type="Action" id="632150611285781394" name="CreateConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="140" y="224">
      ...
      <linkto id="632150839508750161" type="Labeled" style="Bezier" label="success" />
    ...
    <node type="Action" id="632150611285781415" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="439" y="410">
      <linkto id="632224881663906610" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150611285781416" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="696" y="221">
      <linkto id="632224881663906611" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632224881663906610" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="410" y="567">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906611" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="768.7611" y="219">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Complete" varsy="667" startnode="632150611285781402" treenode="632150611285781403" appnode="632150611285781401" handlerfor="632150611285781400">
    ...
    <node type="Action" id="632150611285781426" name="DeleteConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="233" y="176">
      <linkto id="632151253429844099" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId1</ap>
    ...
    <node type="Action" id="632150611285781429" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="484" y="176">
      <linkto id="632224881663906609" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="resultCode" type="variable">resultCode</ap>
        <ap name="signalName" type="variable">S_PlaySuccess</ap>
      </Properties>
    </node>
    <node type="Action" id="632151253429844099" name="DeleteConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="375" y="175">
      <linkto id="632150611285781429" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId2</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906609" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="608" y="181">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Failed" varsy="692" startnode="632150611285781406" treenode="632150611285781407" appnode="632150611285781405" handlerfor="632150611285781404">
    ...
    <node type="Action" id="632150611285781420" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="391" y="179">
      <linkto id="632224881663906607" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150611285781579" name="DeleteConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="172" y="180">
      <linkto id="632151253429844100" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId1</ap>
      </Properties>
    </node>
    <node type="Action" id="632151253429844100" name="DeleteConnection" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="299" y="177">
      <linkto id="632150611285781420" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="connectionId" type="variable">connectionId2</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906607" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="601" y="183">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="SendDigit" varsy="692" startnode="632150839508750319" treenode="632150839508750320" appnode="632150839508750318" handlerfor="632150839508750317">
    ...
    <node type="Action" id="632150839508750321" name="SendDigits" class="MaxActionNode" group="" path="Metreos.Providers.MediaServer" x="228" y="116">
      <linkto id="632224881663906608" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="digits" type="literal">44444</ap>
        <ap name="connectionId" type="variable">connectionId1</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906608" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="538" y="202">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
