<Application name="script1" trigger="Metreos.Providers.FunctionalTest.TriggerApp" version="0.6" single="false">
  ...
  <global name="script1">
    <outline>
      <treenode type="evh" id="632150611285781381" level="1" text="TriggerApp (trigger): OnTriggerApp">
        ...
        <Properties type="triggering">
          <ep name="testScriptName" type="literal">Provider.Record.script1</ep>
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="connectionId1" id="632224881663906703" vid="632150611285781382">
        <Properties type="Metreos.Types.Int">connectionId1</Properties>
      </treenode>
      <treenode text="connectionId2" id="632224881663906705" vid="632150611285781384">
        <Properties type="Metreos.Types.Int">connectionId2</Properties>
      </treenode>
      <treenode text="mediaIp1" id="632224881663906707" vid="632150611285781386">
        <Properties type="Metreos.Types.String">mediaIp1</Properties>
      </treenode>
      <treenode text="mediaIp2" id="632224881663906709" vid="632150611285781388">
        <Properties type="Metreos.Types.String">mediaIp2</Properties>
      </treenode>
      <treenode text="mediaPort1" id="632224881663906711" vid="632150611285781390">
        <Properties type="Metreos.Types.Int">mediaPort1</Properties>
      </treenode>
      <treenode text="mediaPort2" id="632224881663906713" vid="632150611285781392">
        <Properties type="Metreos.Types.Int">mediaPort2</Properties>
      </treenode>
      <treenode text="S_FailureToStart" id="632224881663906715" vid="632150611285781398">
        <Properties type="Metreos.Types.String" initWith="S_FailureToStart">S_FailureToStart</Properties>
      </treenode>
      <treenode text="S_Started" id="632224881663906717" vid="632150611285781412">
        <Properties type="Metreos.Types.String" initWith="S_Started">S_Started</Properties>
      </treenode>
      <treenode text="S_RecordFailed" id="632224881663906719" vid="632150611285781418">
        <Properties type="Metreos.Types.String" initWith="S_RecordFailed">S_RecordFailed</Properties>
      </treenode>
      <treenode text="S_RecordSuccess" id="632224881663906721" vid="632150611285781422">
        <Properties type="Metreos.Types.String" initWith="S_RecordSuccess">S_RecordSuccess</Properties>
      </treenode>
      <treenode text="firstPlayDone" id="632224881663906723" vid="632151253429844218">
        <Properties type="Metreos.Types.Bool">firstPlayDone</Properties>
      </treenode>
      <treenode text="S_FirstPlayDone" id="632224881663906725" vid="632151253429844334">
        <Properties type="Metreos.Types.String" initWith="S_FirstPlayDone">S_FirstPlayDone</Properties>
      </treenode>
      <treenode text="conferenceId" id="632224881663906727" vid="632155560786094080">
  ...
  <canvas type="Function" name="OnTriggerApp" varsy="691" startnode="632150611285781380" treenode="632150611285781381" appnode="632150611285781379" handlerfor="632150611285781378">
    ...
    <node type="Action" id="632150611285781415" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="439" y="410">
      <linkto id="632224881663906787" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632150611285781416" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="1225" y="225">
      <linkto id="632224881663906789" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632151253429844217" name="PlayAnnouncement" class="MaxAsyncActionNode" group="" path="Metreos.Providers.MediaServer" x="771.7611" y="216" mx="865" my="232">
      <items count="2">
    ...
    <node type="Action" id="632224881663906787" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="372" y="555">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906788" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="1465.761" y="227">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906789" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="1321.761" y="227">
      <linkto id="632224881663906788" type="Labeled" style="Bezier" ortho="true" label="default" />
...
return String.Empty;
  ...
  <canvas type="Function" name="OnRecordAudio_Complete" varsy="692" startnode="632151253429843915" treenode="632151253429843916" appnode="632151253429843914" handlerfor="632151253429843913">
    ...
    <node type="Action" id="632151253429844214" name="PlayAnnouncement" class="MaxAsyncActionNode" group="" path="Metreos.Providers.MediaServer" x="237" y="201" mx="330" my="217">
      <items count="2">
    ...
    <node type="Action" id="632151253429844237" name="Compare" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="103" y="223">
      <linkto id="632151253429844214" type="Labeled" style="Bezier" ortho="true" label="equal" />
      <linkto id="632151253429844238" type="Labeled" style="Bezier" ortho="true" label="default" />
    ...
    <node type="Action" id="632151253429844242" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="532" y="394">
      <linkto id="632224881663906791" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
    ...
    <node type="Action" id="632151253429844336" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="519" y="218">
      <linkto id="632224881663906790" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_FirstPlayDone</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906790" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="651" y="202">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906791" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="652" y="391">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnPlayAnnouncement_Complete" activetab="true" varsy="667" startnode="632151253429844208" treenode="632151253429844209" appnode="632151253429844207" handlerfor="632151253429844206">
    ...
    <node type="Action" id="632151253429844223" name="Switch" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="381" y="183">
      ...
      <linkto id="632224881663906796" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632151253429844245" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="634.7611" y="329">
      <linkto id="632224881663906792" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordSuccess</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906792" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="745.7611" y="324">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906793" name="EndFunction" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="737.7611" y="182">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Action" id="632224881663906796" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="547.7611" y="187">
      <linkto id="632224881663906793" type="Labeled" style="Bezier" ortho="true" label="default" />
...
return String.Empty;
  ...
  <canvas type="Function" name="OnPlayAnnouncement_Failed" varsy="667" startnode="632151253429844212" treenode="632151253429844213" appnode="632151253429844211" handlerfor="632151253429844210">
    ...
    <node type="Action" id="632151253429844246" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="829.0762" y="167">
      <linkto id="632224881663906794" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordFailed</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906794" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="921.0762" y="167">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
  <canvas type="Function" name="OnRecordAudio_Failed" varsy="692" startnode="632151253429843919" treenode="632151253429843920" appnode="632151253429843918" handlerfor="632151253429843917">
    ...
    <node type="Action" id="632151253429843928" name="Signal" class="MaxActionNode" group="" path="Metreos.Providers.FunctionalTest" x="466" y="164">
      <linkto id="632224881663906795" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="signalName" type="variable">S_RecordFailed</ap>
      </Properties>
    </node>
    <node type="Action" id="632224881663906795" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="654" y="165">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
  </canvas>
