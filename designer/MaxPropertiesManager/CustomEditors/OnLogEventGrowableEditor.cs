...
namespace Metreos.Max.Framework.Satellite.Property
{
    ...
    /// </summary>
    public class OnLogEventGrowableEditor : System.Windows.Forms.UserControl
    {        
        ...
        public OnLogEventGrowableEditor(
        ...
        protected void InitializeEditor()
        {
            ...
            MaxProperty loggingProperty = (MaxProperty) context.PropertyDescriptor;

            foreach(MaxProperty log in loggingProperty.ChildrenProperties)
                listBox1.Items.Add(new ListPropertyItem(log));
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.addButton.Text = "Add Logging Event";
            ...
            this.label1.Text = "New Logging Event";
            ...
            this.label2.Text = "Existing Logging Events";
            ...
            this.Name = "OnLogEventGrowableEditor";
        ...
        private bool RequiredUserIntervention(string textToCheck)
        {
            ...
            {
                errorLabel.Text = Defaults.noLogEvent;
        ...
        private void AddButton_Click(object sender, System.EventArgs e)
        {
            ...
            OnLogEventPropertyGrowable growableLogging = (OnLogEventPropertyGrowable) value_;
      
            string nameForNewProperty = newParamNameBox.Text;

            OnLogEventProperty logEventProperty = new OnLogEventProperty(nameForNewProperty, String.Empty, 
                growableLogging.Mpm, growableLogging.Subject, growableLogging.Container);

            UserTypeProperty typeProperty = new  UserTypeProperty(growableLogging.Mpm.GetDefaultUserTypeDelegate(), growableLogging.Mpm, growableLogging.Subject, growableLogging.Container);
            TraceLevelProperty traceLevel = new TraceLevelProperty(Defaults.TRACE_LEVEL, growableLogging.Mpm, growableLogging.Subject, growableLogging.Container);
            OnOffProperty onOffProperty = new OnOffProperty(DataTypes.OnOff.On, growableLogging.Mpm, growableLogging.Subject, growableLogging.Container);
            RenamingProperty renamingProperty = new RenamingProperty(nameForNewProperty, logEventProperty, growableLogging.Mpm, growableLogging.Subject, growableLogging.Container);

            logEventProperty.ChildrenProperties.Add(typeProperty);
            logEventProperty.ChildrenProperties.Add(traceLevel);
            logEventProperty.ChildrenProperties.Add(onOffProperty);
            logEventProperty.ChildrenProperties.Add(renamingProperty);
      
            growableLogging.ChildrenProperties.Add(logEventProperty);

            listBox1.Items.Add(new ListPropertyItem(logEventProperty));
        }
        ...
        private void RemoveButton_Click(object sender, System.EventArgs e)
        {
            ...
            {
                ListPropertyItem logCriterion = listBox1.CheckedItems[0] as ListPropertyItem;
                listBox1.Items.Remove(logCriterion);
                removeProperty(value_ as OnLogEventPropertyGrowable, logCriterion.Property);
            }
        }
