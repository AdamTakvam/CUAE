...
set DeployDir=%MetreosBuildRoot%\MaxDesigner
...
xcopy %ProjectRoot%\MaxDesigner\bin\%BuildTarget%\MaxDesigner.exe                %DeployDir% /Y >> %PostBuildLog%
xcopy %ProjectRoot%\MaxDesigner\bin\%BuildTarget%\MaxDesigner.exe.config         %DeployDir% /Y >> %PostBuildLog%
xcopy %ProjectRoot%\MaxDesigner\bin\%BuildTarget%\MagicLibrary.dll               %DeployDir% /Y >> %PostBuildLog%
xcopy %ProjectRoot%\MaxDesigner\bin\%BuildTarget%\Northwoods.Go.dll              %DeployDir% /Y >> %PostBuildLog%
xcopy %ProjectRoot%\MaxDesigner\bin\%BuildTarget%\Northwoods.Go.xml              %DeployDir% /Y >> %PostBuildLog%
xcopy %ProjectRoot%\MaxPropertiesManager\bin\%BuildTarget%\PropertyGrid.Core.dll %DeployDir% /Y >> %PostBuildLog%

xcopy %ProjectRoot%\MaxDesigner\bin\%BuildTarget%\MaxDesigner.pdb                %SymbolDir% /Y >> %PostBuildLog%
xcopy %ProjectRoot%\MaxPropertiesManager\bin\%BuildTarget%\PropertyGrid.Core.pdb %SymbolDir% /Y >> %PostBuildLog%
