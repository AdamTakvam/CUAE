...
void H323EndPoint::OnListenerClosed(H323Listener* /*listener*/, 
                                    BOOL /*closedDueToError*/)
{
}
                                    ...
                                    H323AudioCodec & codec)
{
  ...
  if ((soundChannel != NULL) && soundChannel->Open(deviceName,
                         isEncoding ? PSoundChannel::Recorder
