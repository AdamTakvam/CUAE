...
#ifdef DEFER_OLC
    // If OLC accepted, yet cause changed to dataTypeNotAvailable, OLCAck deferred.
    if (cause == H245_OpenLogicalChannelReject_cause::e_dataTypeNotAvailable) {
      connection.AddDeferredOpenLogicalChannel(pdu);
      mutex.Signal();
      return TRUE;
    }
#endif
