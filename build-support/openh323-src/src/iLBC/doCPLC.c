   ...
   ******************************************************************/ 
   ...
   void doThePLC( 
    ...
    
           ...
           use_gain=1.0; 
           if (iLBCdec_inst->consPLICount* 
                           iLBCdec_inst->blockl>320) 
               use_gain=(float)0.9; 
    ...
    
           ...
           for (i=0; i<iLBCdec_inst->blockl; i++) { 
               ...
               if (pick < 0) { 
                   randvec[i] =   
                       iLBCdec_inst->prevResidual[iLBCdec_inst->blockl+ 
                                                   pick]; 
               } else { 
               ...
               if (i<80) 
                   PLCresidual[i] = use_gain*(pitchfact*PLCresidual[i] + 
                       ((float)1.0 - pitchfact) * randvec[i]); 
               else if (i<160) 
                   PLCresidual[i] = (float)0.95*use_gain* 
                       (pitchfact * PLCresidual[i] + 
                       ((float)1.0 - pitchfact) * randvec[i]); 
               else 
