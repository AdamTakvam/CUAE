...
BOOL H323Gatekeeper::OnSendFeatureSet(unsigned pduType, H225_FeatureSet & features) const
{
  return endpoint.OnSendFeatureSet(pduType, features);
}

void H323Gatekeeper::OnReceiveFeatureSet(unsigned pduType, const H225_FeatureSet & features) const
{
  endpoint.OnReceiveFeatureSet(pduType, features);
}
