/* $Id: MsgType.java 32224 2007-05-16 21:26:24Z wert $
 * 
...
public interface MsgType 
{
	...
	/**
	 * Description of UseMohMedia.
	 */
	public static final int UseMohMedia = 47;

	/**
	 * Requests the server to hold a call. Server will respond
	 * with HeldCall and eventually EstablishedMedia.
	 * 
	 * Args:
	 *    CallId
	 * 
	 ...
	 * 
	 * @see #HeldCall
	 * @see #EstablishedMedia
	 * @see #HangupCall
	 * @see #Error
	 */
	public static final int HoldCall = 48;

	/**
	 * Requests the server to resume a call. Server will
	 * unhold and then may respond with EstablishedCall
	 * and eventually EstablishedMedia. If the device is
	 * a media device (cti port or route point) then rxIP
	 * and rxPort may be specified.
	 * 
	 * Args:
	 *    CallId
	 *    [RxIP]
	 ...
	 * @see #Error
	 */
	public static final int ResumeCall = 49;
