...
namespace NAnt.Core.Types {
    ...
    public class FilterCollection : CollectionBase {
        ...
        /// <summary>
        /// Gets the <see cref="Filter"/> with the specified token.
        /// </summary>
        /// <param name="token">The token to get.</param>
        [System.Runtime.CompilerServices.IndexerName("Item")]
        public Filter this[string token] {
            get {
                if (token != null) {
                    // Try to locate instance using Value
                    foreach (Filter filter in base.List) {
        ...
        /// <summary>
        /// Determines whether a <see cref="Filter"/> with the specified
        /// token is in the collection.
        /// </summary>
        /// <param name="token">The token to locate in the collection.</param> 
        /// <returns>
        /// <see langword="true" /> if a <see cref="Filter" /> with the given 
