...
namespace LocalPortForwardDemo
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private SBSSHForwarding.TElSSHLocalPortForwarding forwarding;
		...
		private void InitializeComponent()
		{
			...
			this.forwarding = new SBSSHForwarding.TElSSHLocalPortForwarding();
			...
			this.Name = "frmMain";
			this.Text = "SSH Local port forwarding demo";
