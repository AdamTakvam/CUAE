...
typedef enum
{
 ...
 /*The following Coders are GSM adaptive multirate narrow band coders that are 
   ...
   CODEC_AUDIO_AMRNB_NONE			  = 0x8a,	/* 138 AMR Narrow Band */
   ...
   CODEC_AUDIO_G729ANNEXE			  = 0x8e,
   CODEC_AUDIO_AMRWB_6_6K			  = 0x8f,
   CODEC_AUDIO_AMRWB_8_85K			  = 0x90,
   CODEC_AUDIO_AMRWB_12_65K			  = 0x91,
   CODEC_AUDIO_AMRWB_14_25K			  = 0x92,
   CODEC_AUDIO_AMRWB_15_85K			  = 0x93,
   CODEC_AUDIO_AMRWB_18_25K			  = 0x94,
   CODEC_AUDIO_AMRWB_19_85K			  = 0x95,
   CODEC_AUDIO_AMRWB_23_05K			  = 0x96,
   CODEC_AUDIO_AMRWB_23_85K			  = 0x97,
   CODEC_AUDIO_ILBC_13_33K			  = 0x98,
   CODEC_AUDIO_ILBC_15_2K			  = 0x99,
