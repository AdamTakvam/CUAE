...
*    %instance:      hsw_2 %
*    %created_by:    afanasya %
*    %date_modified: Fri Apr 15 13:15:46 2005 %
*    ===================================================================
*/
...
#ifndef lint
static char    *_hsw_2_dlgceventbasedef_h = "@(#) %filespec: dlgceventbasedef.h-17 %  (%full_filespec: dlgceventbasedef.h-17:incl:hsw#2 %)";
#endif
...
#define LICENSING_CHANNEL                   "LICENSING"                 // Licensing Events						
...
#define  DLGC_LICENSING_BASE_EVT_ID                 0x000A0000
