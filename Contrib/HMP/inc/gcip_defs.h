...
typedef enum {
    ...
    /* TLS requires TCP enabled*/
    IPERR_INVALID_TLS_WITHOUT_TCP,

    /* Invalid TLS parameter*/
...
#define IPPARM_SIP_PRACK_MANDATORY		  0x12
/* FR 2558 support */
...
/* values for IPPARM_SIP_PRACK_MANDATORY parameters */
#define IP_SIP_PRACK_MANDATORY_ON	0x00
#define IP_SIP_PRACK_MANDATORY_OFF	0x01
