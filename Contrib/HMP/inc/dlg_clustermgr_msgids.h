...
#ifndef _DLG_CLUSTERMGR_MSGID_H
#define _DLG_CLUSTERMGR_MSGID_H

#include "dlgfacil.h"


/*  
    Cluster Manager Framework  Message  Definition 
    For use by clients.
 */
...
( DLG_INFO_CODE  | DLG_CLUSTER_FACILITY | 0x00000000 );     
...
( DLG_INTERNAL_MASK | DLG_ERROR_CODE | DLG_CLUSTER_FACILITY | 0x00000000);
*/
