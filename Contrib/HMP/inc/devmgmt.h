...
typedef struct resourcelist {
	...
	int count; // number of items filled in structure below
...
#define DEV_RESOURCE_LIST_VERSION  DEV_RESOURCE_LIST_VER(0)
...
#define DEV_RESOURCE_RESERVATIONINFO_EX_VERSION  DEV_RESOURCE_RESERVATIONINFO_EX_VER(0)
