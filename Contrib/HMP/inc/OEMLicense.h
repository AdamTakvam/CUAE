...
OEMLICENSE_API OEMLicenseRetCode      OEMLicense_GetRegisteredOEMLib( char *szLibraryName, unsigned int *iLibraryNameLength,  char *szFunctionName, unsigned int *iFunctionNameLength);
