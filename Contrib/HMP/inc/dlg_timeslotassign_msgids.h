...
#ifndef _DLG_TIMESLOT_ASSIGN_MSGID_H
#define _DLG_TIMESLOT_ASSIGN_MSGID_H

#include "dlgfacil.h"


/*  
    Timeslot Assign Framework  Message  Definition 
    For use by clients.
 */
...
( DLG_INFO_CODE  | DLG_TIMESLOT_ASSIGN_FACILITY | 0x00000000 );     
...
( DLG_INTERNAL_MASK | DLG_ERROR_CODE | DLG_TIMESLOT_ASSIGN_FACILITY | 0x00000000);
*/
