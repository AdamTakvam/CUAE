 ...
 */
#define DT_MSI    0x00004000               /* MSI device class */
...
#define MSG_FIRSTRINGNOTIFY			0x36	/* Enable/Disable the notification 
											   of the first ring */
...
#define MS_RNGA_CADLEN    0x8  /* Default ring cadence length for initial 
                                  release of genringex() */
#define MS_CADENCE_OFFSET 0x1  /* Ring cadence offset, to separate boardwide 
                                  cadences from genringex() cadences */
...
#define chan_lts        chan_attr       /* Same area used for listen 
														   tslot info */
...
DllLinkage    int __cdecl ms_genring(int,unsigned short, unsigned short); 
															 /* Generate ringing */                                                                                /* Generate ringing */
...
DllLinkage    int __cdecl ms_chgxtder(int,int,MS_CDT *);            /* Change connection 
																	  extender */
DllLinkage    int __cdecl ms_delxtdcon(int,int);                    /* Delete Extended Connection */
DllLinkage    int __cdecl ms_estxtdcon(int,MS_CDT *,int *);         /* Establish extended 
																	 connection*/
...
DllLinkage    int __cdecl ms_genringex(int,unsigned short, unsigned short, unsigned short); 
															/* Generate distinctive ringing */                                                                                
DllLinkage    int __cdecl ms_libinit(HINSTANCE LibHandle);  /* Init funcs for clib lib */
DllLinkage    int __cdecl ms_genringCallerID(int,unsigned short, unsigned short, unsigned short,char*,void*); 
															/* Generate distinctive ringing with CallerID*/                                                                                
DllLinkage    int __cdecl ms_SetMsgWaitInd(int,unsigned short,void*,void*); 
