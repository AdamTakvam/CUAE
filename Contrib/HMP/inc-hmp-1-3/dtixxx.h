...
#define NET_SHLIB_BUSY        SH_SHLIB_BUSY+0x50                /* SH library is busy processing another request. */
#define NET_BAD_SHINDX        SH_BAD_SHINDX+0x50                /* Invalid SH index number. */
#define NET_SHLIB_NOT_INIT    SH_SHLIB_NOT_INIT+0x50    /* SH library has not been initialized via sh_setloc(). */
#define NET_NO_CLOCK          SH_NO_CLOCK+0x50                  /* Clock fallback failed. */
#define NET_NO_SH_PRESENT     SH_NO_SH_PRESENT+0x50     /* SH is not present. */
#define NET_BAD_MODE          SH_BAD_MODE+0x50                  /* Invalid bus mode. */
#define NET_BAD_LOCTS         SH_BAD_LOCTS+0x50                 /* Invalid local timeslot parameter. */
#define NET_BAD_TYPE          SH_BAD_TYPE+0x50                  /* Invalid type. */
#define NET_BAD_EXTTS         SH_BAD_EXTTS+0x50         /* External timeslot not supported at current clock rate. */
#define NET_LOCTS_SET         SH_LOCTS_SET+0x50                 /* Local timeslot already connected. */
#define NET_LOCTS_DISCONNECT  SH_LOCTS_DISCONNECT+0x50  /* Local timeslot disconnected. */
