...
#ifndef _DLG_FAULTDETECTORS_MSGID_H
#define _DLG_FAULTDETECTORS_MSGID_H
...
/*  
    Fault Detectors  Framework  Message  Definition 
    For use by clients.
 */
...
( DLG_INFO_CODE  | DLG_FAULT_DETECTORS_FACILITY | 0x00000000 );     
...
( DLG_INTERNAL_MASK | DLG_ERROR_CODE | DLG_FAULT_DETECTORS_FACILITY | 0x00000000);
