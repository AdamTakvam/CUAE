...
#ifndef _DLG_CLKDEAMON_MSGID_H
#define _DLG_CLKDEAMON_MSGID_H
...
( DLG_INFO_CODE  | DLG_CLOCK_DEAMON_FACILITY | 0x00000000 );     
...
( DLG_INTERNAL_MASK | DLG_ERROR_CODE | DLG_CLOCK_DEAMON_FACILITY | 0x00000000);
*/
