 ...
 ************************************************************************
 *
 * $Id: VXIcache.h,v 1.24 2003/10/24 19:26:09 dsmith Exp $
 *
 ************************************************************************
 */
 ...
 * @name VXIcacheOpenMode
 ...
 @doc Open supports ANSI/ISO C standard I/O open modes
 */
...
typedef struct VXIcacheInterface {
  ...
  /**
   * @name Open
   * @memo Open a stream for reading or writing given a wide character key
   *
  ...
  /**
   * @name Unlock
   * @memo Unlock an entry that was previously locked into the cache given
  ...
  /**
   * @name UnlockEx
   * @memo Unlock an entry that was previously locked into the cache
   *       given a binary key
   *
