<Application name="AllErrorsList" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  <!--//// app tree ////-->
  <global name="AllErrorsList">
    <outline>
      <treenode type="evh" id="632588502418711560" level="1" text="Metreos.Providers.Http.GotRequest (trigger): OnGotRequest">
        ...
        <Properties type="hybrid">
          <ep name="url" type="literal">/showerrors</ep>
        </Properties>
      </treenode>
    </outline>
    <variables />
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632588502418711559" treenode="632588502418711560" appnode="632588502418711557" handlerfor="632588502418711556">
    <node type="Start" id="632588502418711559" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="32" y="254">
      <linkto id="632588502418711562" type="Basic" style="Bevel" />
    </node>
    <node type="Action" id="632588502418711562" name="Query" class="MaxActionNode" group="" path="Metreos.Providers.DatabaseScraper" x="332" y="252">
      <linkto id="632588502418711564" type="Labeled" style="Bevel" label="default" />
      <Properties final="false" type="provider" log="On">
        <rd field="Data">errors</rd>
      </Properties>
    </node>
    <node type="Comment" id="632588502418711563" text="Specifying no start or end time&#xD;&#xA;indicates to the provider&#xD;&#xA;Query action to query all records&#xD;&#xA;with any timestamp value." class="MaxCommentNode" group="Application Components" path="Metreos.StockTools" x="245" y="149" />
