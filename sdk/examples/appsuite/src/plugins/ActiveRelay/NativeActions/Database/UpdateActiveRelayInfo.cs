...
namespace Metreos.Native.ActiveRelay
{
    ...
    /// </summary>
    public class UpdateActiveRelayInfo : INativeAction
    {
        ...
        [Action("UpdateActiveRelayInfo", false, "Updates AR Info", "Updates ActiveRelay info based on user id")]
        public string Execute(SessionData sessionData, IConfigUtility configUtility)
        {
            ...
            try
            {
                ...
                if (affectedRows == 0)
                {
                    log.Write(TraceLevel.Warning, "UPDATE attempt into table \"{0}\" FAILED when using SQL command: " +
