...
{
    /// <summary>
    /// Decrements participant count for a conference
    /// </summary>
    [PackageDecl("Metreos.Native.ScheduledConference")]
    public class DecrementParticipantCount : INativeAction
    {
        ...
        public DecrementParticipantCount()
        {
            Clear();
        }
        ...
        [Action("DecrementParticipantCount", false, "Decrements the participant count for a conference", "Decrements the participant count for a conference")]
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility)
        {
            ...
            catch (Exception e)
            {
                ...
                log.Write(TraceLevel.Warning, "Error encountered in the DecrementParticipantCount method, using pin: {0}\n"+
                    "Error message: {1}", msgArray);
                return SC.ReturnValues.failure.ToString();
            }
            finally
