...
#include "win32/MetreosPresenceStackService.h"
...
using namespace Metreos::Presence::Win32;
...
int main(int argc, char* argv[])
{
    ...
    LogServerClient::Instance()->open("Presence");
    ...
    if(serviceEnabled == false)
    {
        ...
        Metreos::Presence::MtPresenceStackRuntime runtime;
        runtime.open();
        runtime.activate();
    ...
    {
        MetreosPresenceStackService service;
