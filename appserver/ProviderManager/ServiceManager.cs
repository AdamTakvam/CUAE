...
namespace Metreos.AppServer.ProviderManager
{
    public sealed class ServiceManager
    {
        ...
        public bool InstallService(FileInfo serviceFile, string serviceName, string displayName, 
            string username, string password, out string failReason) 
        {
            failReason = null;
            ...
            int hSvc = CreateService(hSCM, serviceName, displayName, ServiceDefs.AllAccess, 
                ...
                serviceFile.FullName, null, 0, null, username, password);
        ...
        public bool UninstallService(string serviceName, out string failReason) 
        {
            ...
            {
                failReason = String.Format("Cannot uninstall service '{0}'. State = {1}", serviceName, svc.Status.ToString());
                return false;
            }            
        ...
        public void StartService(string serviceName, string[] args)
        {
            ServiceController svc = new ServiceController(serviceName);
