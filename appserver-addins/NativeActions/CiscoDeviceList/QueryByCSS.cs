...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.QueryBySearchSpace;

namespace Metreos.Native.CiscoDeviceList
{
	/// <summary>
    ///     Provides simplified interface for querying only by device CSS.
	...
	public class QueryBySearchSpace : INativeAction
    {
