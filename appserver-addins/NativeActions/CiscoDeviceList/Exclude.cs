...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.Exclude;

namespace Metreos.Native.CiscoDeviceList
{
	/// <summary>
	///     Excludes out all specified field values when querying the Device List X database
	/// </summary>
	...
	public class Exclude : INativeAction
    {
