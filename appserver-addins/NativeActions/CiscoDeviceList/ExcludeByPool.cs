...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.ExcludeByPool;

namespace Metreos.Native.CiscoDeviceList
{
	/// <summary>
    ///     Provides simplified interface for excluding out a particular Pool.
	...
	public class ExcludeByPool : INativeAction
    {
