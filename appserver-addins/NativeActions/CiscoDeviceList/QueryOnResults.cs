...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.QueryOnResults;
...
namespace Metreos.Native.CiscoDeviceList
{
	...
	public class QueryOnResults : INativeAction
    {
