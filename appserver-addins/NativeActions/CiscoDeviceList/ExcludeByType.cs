...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.ExcludeByType;

namespace Metreos.Native.CiscoDeviceList
{
	/// <summary>
	///     Provides simplified interface for excluding by a particular Device Type.
	...
	public class ExcludeByType : INativeAction
    {
