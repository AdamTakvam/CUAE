...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.ExcludeByIP;

namespace Metreos.Native.CiscoDeviceList
{
	/// <summary>
	///     Provides simplified interface for excluding out a particular IP Address
	...
	public class ExcludeByIP : INativeAction
    {
