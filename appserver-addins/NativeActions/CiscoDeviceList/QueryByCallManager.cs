...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.QueryByCallManager;

namespace Metreos.Native.CiscoDeviceList
{
	/// <summary>
	/// Provides simplified interface for querying for all devices on a given CCM IP
	/// </summary>
	...
	public class QueryByCallManager : INativeAction
    {
