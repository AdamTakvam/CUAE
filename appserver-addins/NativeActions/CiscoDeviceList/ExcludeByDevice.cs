...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.ExcludeByDevice;

namespace Metreos.Native.CiscoDeviceList
{
	/// <summary>
	///     Provides simplified interface for excluding out a particular Device Name.
	...
	public class ExcludeByDevice : INativeAction
    {
