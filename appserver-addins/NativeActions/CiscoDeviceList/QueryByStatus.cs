...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoDeviceList.Actions.QueryByStatus;

namespace Metreos.Native.CiscoDeviceList
{
	/// <summary>
	///     Provides simplified interface for querying only by Device Status.
	...
	public class QueryByStatus : INativeAction
    {
