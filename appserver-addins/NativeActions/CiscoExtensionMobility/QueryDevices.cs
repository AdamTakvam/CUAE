...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoExtensionMobility.Actions.QueryDevices;

namespace Metreos.Native.CiscoExtensionMobility
{
    /// <summary> 
    ///     Query a set of devices, returning which users are using the devices, using the Cisco 
    ...
    public class QueryDevices : INativeAction
    {
        ...
        [ActionParamField("The name(s) of the device(s)", true)]
        public string[] DeviceNames { set { deviceNames = value; } }
        ...
        [ResultDataField(Package.Results.QueryDevicesResult.DISPLAY, Package.Results.QueryDevicesResult.DESCRIPTION)]
        public UserResponse QueryDevicesResult { get { return userResponse; } set { userResponse = value ; } }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.devicesQueryData = new UserRequest.DevicesQueryData();
            request.devicesQueryData.deviceName = deviceNames;
            ...
            UrlStatus status = Web.CiscoPostXmlTransaction(url, request, typeof(UserResponse), out responseUncasted);

            UserResponse response = responseUncasted as UserResponse;
