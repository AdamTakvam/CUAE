...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoIpPhone.Actions.CreateGraphicMenu;
...
namespace Metreos.Native.CiscoIpPhone
{
	...
	public class CreateGraphicMenu : INativeAction
    {
        private LogWriter log;
        public LogWriter Log { set { log = value; } }
        
        [ResultDataField(Package.Results.ResultData.DISPLAY, Package.Results.ResultData.DESCRIPTION)]
        public CiscoIPPhoneGraphicMenuType ResultData { get { return resultData; } }
        private CiscoIPPhoneGraphicMenuType resultData;
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            CiscoIPPhoneGraphicMenuType menu = new CiscoIPPhoneGraphicMenuType();
            menu.Title = title;
            menu.Prompt = prompt;
            menu.LocationX = x;
            menu.LocationY = y;
