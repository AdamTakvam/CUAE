...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoIpPhone.Actions.CreateImageFile;
...
namespace Metreos.Native.CiscoIpPhone
{
	...
	public class CreateImageFile : INativeAction
    {
        private LogWriter log;
        public LogWriter Log { set { log = value; } }
        
        [ResultDataField(Package.Results.ResultData.DISPLAY, Package.Results.ResultData.DESCRIPTION)]
        public CiscoIPPhoneImageFileType ResultData { get { return resultData; } }
        private CiscoIPPhoneImageFileType resultData;
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            CiscoIPPhoneImageFileType image = new CiscoIPPhoneImageFileType();
            image.Title = title;
            image.Prompt = prompt;
            image.LocationX = x;
            image.LocationY = y;
            image.URL = formatURL ? ICiscoPhone.FormatUrl(url) : url;
