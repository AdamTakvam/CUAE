...
using Package = Metreos.Interfaces.PackageDefinitions.CiscoIpPhone.Actions.CreateMenu;
...
namespace Metreos.Native.CiscoIpPhone
{
	...
	public class CreateMenu : INativeAction
    {
        private LogWriter log;
        public LogWriter Log { set { log = value; } }
        
        [ResultDataField(Package.Results.ResultData.DISPLAY, Package.Results.ResultData.DESCRIPTION)]
        public CiscoIPPhoneMenuType ResultData { get { return resultData; } }
        private CiscoIPPhoneMenuType resultData;
