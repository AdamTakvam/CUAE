...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.GetTranslationPattern;

namespace Metreos.Native.AxlSoap413
{
	/// <summary> Wraps up the 'getTranslationPattern' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
