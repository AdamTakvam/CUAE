...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.ListUserByName;

namespace Metreos.Native.AxlSoap413
{
	/// <summary> Wraps up the 'listUserByName' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
