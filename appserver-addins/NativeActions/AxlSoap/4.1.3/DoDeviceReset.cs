...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.DoDeviceReset;

namespace Metreos.Native.AxlSoap413
{
	/// <summary> Wraps up the 'doDeviceReset' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
    ...
    public class DoDeviceReset: INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType8) IAxlSoap.DetermineChosenBetweenStringsType
                (phoneName, phoneId, ItemChoiceType8.deviceName, ItemChoiceType8.deviceId);
