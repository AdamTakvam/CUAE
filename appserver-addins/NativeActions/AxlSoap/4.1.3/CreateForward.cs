...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.CreateForward;

namespace Metreos.Native.AxlSoap413
{
    /// <summary> 
    ///     Creates the forwarding information for a forward attribute for a line, 
    ///     to be later used with an 'updateLine' AXL SOAP method for Cisco CallManager 4.1.3
    /// </summary>
