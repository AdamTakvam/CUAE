...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.ClearLines;

namespace Metreos.Native.AxlSoap413
{
    /// <summary> Clears all lines for a 'updatePhone' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
