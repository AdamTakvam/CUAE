...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.AddTranslationPattern;

namespace Metreos.Native.AxlSoap413
{
    /// <summary> Wraps up the 'addTranslationPattern' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
    ...
    {     
        ...
        public XPresentationBit CallingPartyPresentation { set { callingPartyPresentation = value; callingPartyPresentationBitSpecified = true; } }
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            {
                trans.newPattern.CallingSearchSpace = callingSearchSpaceName;
            }
            else
            {
                trans.newPattern.CallingSearchSpace = CreateXCallingSearchSpace(callingSearchSpaceId);
            }
            ...
            trans.newPattern.callingNamePresentationBit            = callingPartyPresentation;
