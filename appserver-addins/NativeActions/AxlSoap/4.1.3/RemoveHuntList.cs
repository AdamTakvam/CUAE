...
//{
//	/// <summary> Wraps up the 'removeHuntList' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
...
//    public class RemoveHuntList : INativeAction
//	{     
...
//
//        [ResultDataField(Package.Results.RemoveHuntListResponse.DISPLAY, Package.Results.RemoveHuntListResponse.DESCRIPTION)]
//        public removeHuntListResponse RemoveHuntListResponse { get { return response; } }
//
...
//            this.response                   = new removeHuntListResponse();
...
//            
//            removeHuntList request = new removeHuntList();
//
...
//				name, uuid, ItemChoiceType16.name, ItemChoiceType16.uuid);
//             
//            try
//            {
//                response = client.removeHuntList(request);
//            }
