...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.UpdateDeviceProfile;
...
namespace Metreos.Native.AxlSoap413
{
    ...
    public class UpdateDeviceProfile : INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            updateProfile.ItemElementName = (ItemChoiceType14) IAxlSoap.DetermineChosenBetweenStringsType(
                profileName, profileId, ItemChoiceType14.name, ItemChoiceType14.uuid);
