...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.GetUser;

namespace Metreos.Native.AxlSoap413
{
	/// <summary> Wraps up the 'getUser' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
