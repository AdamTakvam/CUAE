...
//{
//	/// <summary> Wraps up the 'getHuntList' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
...
//    public class GetHuntList : INativeAction
//	{     
...
//
//        [ResultDataField(Package.Results.GetHuntListResponse.DISPLAY, Package.Results.GetHuntListResponse.DESCRIPTION)]
//        public getHuntListResponse GetHuntListResponse { get { return response; } }
//
...
//        private getHuntListResponse response;
//
//		public GetHuntList()
//		{
//		    Clear();	
...
//            this.response                   = new getHuntListResponse();
...
//            
//            getHuntList request = new getHuntList();
//
...
//            try
//            {
//                response = client.getHuntList(request);
//            }
