...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.GetCSS;

namespace Metreos.Native.AxlSoap413
{
	/// <summary> Wraps up the 'getCSS' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType16) IAxlSoap.DetermineChosenBetweenStringsType(cssName, cssId, ItemChoiceType16.name, ItemChoiceType16.uuid);
