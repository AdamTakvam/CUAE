...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413.Actions.GetPhone;

namespace Metreos.Native.AxlSoap413
{
	/// <summary> Wraps up the 'getPhone' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
