...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.UpdateUser;

namespace Metreos.Native.AxlSoap504
{
    /// <summary> Wraps up the 'updateUser' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
    ...
    {     
		...
		[ActionParamField(Package.Params.DigestCredentials.DISPLAY, Package.Params.DigestCredentials.DESCRIPTION, false, Package.Params.DigestCredentials.DEFAULT)]
		public string DigestCredentials { set { digestCredentials = value; } }
		...
		private string digestCredentials;
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
			...
			user.digestCredentials = digestCredentials;
			...
			user.userLocaleSpecified = userLocaleSpecified;
