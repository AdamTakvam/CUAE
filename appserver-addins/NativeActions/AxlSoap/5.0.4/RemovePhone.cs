...
{
	/// <summary> Wraps up the 'removePhone' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
    ...
    public class RemovePhone : INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType49) IAxlSoap.DetermineChosenBetweenStringsType(
                phoneName, phoneId, ItemChoiceType49.phoneName, ItemChoiceType49.phoneId);
