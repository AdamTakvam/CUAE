...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.ClearLines;

namespace Metreos.Native.AxlSoap504
{
    /// <summary> Clears all lines for a 'updatePhone' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
