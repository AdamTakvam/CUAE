...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.UpdateLine;

namespace Metreos.Native.AxlSoap504
{
    /// <summary> Wraps up the 'updateLine' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
			...
			line.ItemElementName = (ItemChoiceType57) IAxlSoap.DetermineChosenBetweenStringsType(
			...
			line.Item1ElementName = (Item1ChoiceType15) IAxlSoap.DetermineChosenBetweenStringsType(
			...
			line.Item2ElementName = (Item2ChoiceType9) IAxlSoap.DetermineChosenBetweenStringsType(
				newRoutePartitionName, newRoutePartitionId, Item2ChoiceType9.newRoutePartitionName, Item2ChoiceType9.newRoutePartitionId);
			line.Item3 = IAxlSoap.DetermineChosenBetweenStrings(aarNeighborhoodName, aarNeighborhoodId);
			line.Item3ElementName = (Item3ChoiceType7) IAxlSoap.DetermineChosenBetweenStringsType(
				aarNeighborhoodName, aarNeighborhoodId, Item3ChoiceType7.aarNeighborhoodName, Item3ChoiceType7.aarNeighborhoodId);
			...
			line.Item5ElementName = (Item5ChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
				shareLineAppearanceCSSName, shareLineAppearanceCSSId, Item5ChoiceType5.shareLineAppearanceCSSName, Item5ChoiceType5.shareLineAppearanceCSSId);
            line.Item6 = IAxlSoap.DetermineChosenBetweenStrings(voiceMailProfileName, voiceMailProfileId);
			line.Item6ElementName = (Item6ChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
				voiceMailProfileName, voiceMailProfileId, Item6ChoiceType5.voiceMailProfileName, Item6ChoiceType5.voiceMailProfileId);
