...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.AddLineItem;

namespace Metreos.Native.AxlSoap504
{
    /// <summary> Creates a line item for the 'updatePhone' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
