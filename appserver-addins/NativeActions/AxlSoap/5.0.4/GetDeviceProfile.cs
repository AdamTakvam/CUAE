...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.GetDeviceProfile;

namespace Metreos.Native.AxlSoap504
{
	/// <summary> Wraps up the 'getDeficeProfile' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
    ...
    public class GetDeviceProfile : INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType10) IAxlSoap.DetermineChosenBetweenStringsType(
                profileName, profileId, ItemChoiceType10.profileName, ItemChoiceType10.profileId);
