...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.RemoveHuntList;

namespace Metreos.Native.AxlSoap504
{
	/// <summary> Wraps up the 'removeHuntList' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
