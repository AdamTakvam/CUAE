...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.AddTranslationPattern;

namespace Metreos.Native.AxlSoap504
{
    /// <summary> Wraps up the 'addTranslationPattern' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
    ...
    {     
        ...
        public XPresentationBit CallingPartyPresentationBit { set { callingPartyPresentationBit = value; callingPartyPresentationBitSpecified = true; } }
		...
		public XPatternPrecedence PatternPrecedence { set { patternPrecedence = value; patternPrecedenceSpecified = true; } }
		...
		public XReleaseCauseValue ReleaseCause { set { releaseCause = value; releaseCauseSpecified = true; } }
...
//        public XPatternUsage Usage { set { usage = value; } }
        ...
        private XPresentationBit callingPartyPresentationBit;
        ...
        public void Clear()
        {
            ...
            this.callingPartyPresentationBit            = XPresentationBit.Default;
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
           ...
           if(routePartitionName != null)
            ...
            trans.newPattern.callingNamePresentationBitSpecified   = callingPartyPresentationBitSpecified;
			trans.newPattern.callingLinePresentationBit			   = callingLinePresentationBit;
			trans.newPattern.callingLinePresentationBitSpecified   = callingLinePresentationBitSpecified;
			trans.newPattern.connectedLinePresentationBit		   = connectedLinePresentationBit;
			trans.newPattern.connectedLinePresentationBitSpecified = connectedLinePresentationBitSpecified;
			trans.newPattern.connectedNamePresentationBit		   = connectedNamePresentationBit;
			trans.newPattern.connectedNamePresentationBitSpecified = connectedNamePresentationBitSpecified;
			trans.newPattern.patternPrecedence					   = patternPrecedence;
			trans.newPattern.patternPrecedenceSpecified		       = patternPrecedenceSpecified;
			...
			trans.newPattern.releaseCauseSpecified				   = releaseCauseSpecified;
