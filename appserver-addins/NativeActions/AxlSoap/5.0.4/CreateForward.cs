...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.CreateForward;

namespace Metreos.Native.AxlSoap504
{
    /// <summary> 
    ///     Creates the forwarding information for a forward attribute for a line, 
    ///     to be later used with an 'updateLine' AXL SOAP method for Cisco CallManager 5.0.4
    /// </summary>
