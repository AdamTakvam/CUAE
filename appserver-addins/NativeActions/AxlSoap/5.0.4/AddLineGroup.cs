...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.AddLineGroup;

namespace Metreos.Native.AxlSoap504
{
    /// <summary> Wraps up the 'addLineGroup' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
