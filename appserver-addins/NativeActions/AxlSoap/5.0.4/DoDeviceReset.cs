...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.DoDeviceReset;

namespace Metreos.Native.AxlSoap504
{
	/// <summary> Wraps up the 'doDeviceReset' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
    ...
    public class DoDeviceReset: INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType11) IAxlSoap.DetermineChosenBetweenStringsType
                (phoneName, phoneId, ItemChoiceType11.deviceName, ItemChoiceType11.deviceId);
