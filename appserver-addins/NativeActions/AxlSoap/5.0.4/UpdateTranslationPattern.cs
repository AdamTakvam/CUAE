...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.UpdateTranslationPattern;

namespace Metreos.Native.AxlSoap504
{
    /// <summary> Wraps up the 'updateTranslationPattern' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
			...
			trans.ItemElementName = (ItemChoiceType57) IAxlSoap.DetermineChosenBetweenStringsType(
			...
			trans.Item1ElementName = (Item1ChoiceType15) IAxlSoap.DetermineChosenBetweenStringsType(
            ...
            trans.Item3ElementName = (Item3ChoiceType9) IAxlSoap.DetermineChosenBetweenStringsType(
                dialPlanName, dialPlanId, Item3ChoiceType9.dialPlanName, Item3ChoiceType9.dialPlanId);
			...
			trans.Item5ElementName = (Item5ChoiceType6) IAxlSoap.DetermineChosenBetweenStringsType(
				newRouteFilterName, newRouteFilterId, Item5ChoiceType6.newRouteFilterName, Item5ChoiceType6.newRouteFilterId);
            trans.Item6 = IAxlSoap.DetermineChosenBetweenStrings(callingSearchSpaceName, callingSearchSpaceId);
            trans.Item6ElementName = (Item6ChoiceType6) IAxlSoap.DetermineChosenBetweenStringsType(
                callingSearchSpaceName, callingSearchSpaceId, Item6ChoiceType6.callingSearchSpaceName, Item6ChoiceType6.callingSearchSpaceId);
			...
			trans.patternPrecedenceSpecified			= patternPrecedenceSpecified;
			trans.releaseCause							= releaseCause;
			trans.releaseCauseSpecified					= releaseCauseSpecified;
