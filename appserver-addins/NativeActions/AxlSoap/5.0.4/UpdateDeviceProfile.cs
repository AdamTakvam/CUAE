...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.UpdateDeviceProfile;
...
namespace Metreos.Native.AxlSoap504
{
    ...
    public class UpdateDeviceProfile : INativeAction
	{
		...
		public XBoolean AllowCtiControlFlag { set { allowCtiControlFlag = value; allowCtiControlFlagSpecified = true;} }
		...
		public XUserLocale UserLocale { set { userLocale = value; userLocaleSpecified = true;} }
		...
		private XBoolean allowCtiControlFlag;
		...
		private XUserLocale userLocale;
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            updateProfile.ItemElementName = (ItemChoiceType28) IAxlSoap.DetermineChosenBetweenStringsType(
                profileName, profileId, ItemChoiceType28.name, ItemChoiceType28.uuid);
            updateProfile.Item1 = IAxlSoap.DetermineChosenBetweenStrings(callingSearchSpaceName, callingSearchSpaceId);
			updateProfile.Item1ElementName = (Item1ChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
				callingSearchSpaceName, callingSearchSpaceId, Item1ChoiceType5.subscribeCallingSearchSpaceName, Item1ChoiceType5.subscribeCallingSearchSpaceId);
			updateProfile.Item2 = IAxlSoap.DetermineChosenBetweenStrings(presenceGroupName, presenceGroupId);
			updateProfile.Item2ElementName = (Item2ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
				presenceGroupName, presenceGroupId, Item2ChoiceType2.PresenceGroupName, Item2ChoiceType2.presenceGroupID);
			...
			updateProfile.preemption = preemption;
			updateProfile.preemptionSpecified = preemptionSpecified;
			updateProfile.userLocale	      = userLocale;
			updateProfile.userLocaleSpecified = userLocaleSpecified;
        ...
        public void Clear()
        {
			this.allowCtiControlFlag		= XBoolean.No;
			...
			this.userLocale					= XUserLocale.EnglishUnitedStates;
