...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504.Actions.GetPartition;

namespace Metreos.Native.AxlSoap504
{
	/// <summary> Wraps up the 'getPartition' AXL SOAP method for Cisco CallManager 5.0.4 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType23) IAxlSoap.DetermineChosenBetweenStringsType(partitionName, partitionId, ItemChoiceType23.partitionName, ItemChoiceType23.partitionId);
