...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.RemoveHuntPilot;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'removeHuntPilot' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
