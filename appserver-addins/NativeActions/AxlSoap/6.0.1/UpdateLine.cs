...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.UpdateLine;

namespace Metreos.Native.AxlSoap601
{
    /// <summary> Wraps up the 'updateLine' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    ...
    {     
		[ActionParamField(Package.Params.AlertingName.DISPLAY, Package.Params.AlertingName.DESCRIPTION, false, Package.Params.AlertingName.DEFAULT)]
		public string AlertingName { set { alertingName = value; } }
        ...
        public string AutoAnswer { set { autoAnswer = value; } }
        ...
        public string PatternPrecedence { set { patternPrecedence = value; } }
        ...
        public string ReleaseCause { set { releaseCause = value; } }
		...
		[ActionParamField(Package.Params.CallForwardBusyInt.DISPLAY, Package.Params.CallForwardBusyInt.DESCRIPTION, false, Package.Params.CallForwardBusyInt.DEFAULT)]
		public CallForward CallForwardBusyInt { set { callForwardBusyInt = value; } }
		...
		[ActionParamField(Package.Params.CallForwardNoAnswerInt.DISPLAY, Package.Params.CallForwardNoAnswerInt.DESCRIPTION, false, Package.Params.CallForwardNoAnswerInt.DEFAULT)]
		public CallForward CallForwardNoAnswerInt { set { callForwardNoAnswerInt = value; } }

		[ActionParamField(Package.Params.CallForwardNoCoverage.DISPLAY, Package.Params.CallForwardNoCoverage.DESCRIPTION, false, Package.Params.CallForwardNoCoverage.DEFAULT)]
		public CallForward CallForwardNoCoverage { set { callForwardNoCoverage = value; } }

		[ActionParamField(Package.Params.CallForwardNoCoverageInt.DISPLAY, Package.Params.CallForwardNoCoverageInt.DESCRIPTION, false, Package.Params.CallForwardNoCoverageInt.DEFAULT)]
		public CallForward CallForwardNoCoverageInt { set { callForwardNoCoverageInt = value; } }
		...
		private CallForward callForwardBusyInt;
        private CallForward callForwardNoAnswer;
		private CallForward callForwardNoAnswerInt;
        private CallForward callForwardOnFailure;
		private CallForward callForwardNoCoverage;
		private CallForward callForwardNoCoverageInt;
        ...
        public void Clear()
        {
			this.alertingName				= null;
            this.aarNeighborhoodId          = null;
            this.aarNeighborhoodName        = null;
            this.autoAnswer =               "Off";// XAutoAnswer.AutoAnswerOff;
			...
			this.callForwardBusyInt         = null;
			this.callForwardNoAnswer        = null;
			this.callForwardNoAnswerInt     = null;
			this.callForwardOnFailure       = null;
			this.callForwardNoCoverage		= null;
			this.callForwardNoCoverageInt   = null;
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
			...
			line.Item = IAxlSoap.DetermineChosenBetweenStrings(routePartitionName, routePartitionId);
			line.ItemElementName = (ItemChoiceType69) IAxlSoap.DetermineChosenBetweenStringsType(
				routePartitionName, routePartitionId, ItemChoiceType69.routePartitionName, ItemChoiceType69.routePartitionId);
			line.Item1 = IAxlSoap.DetermineChosenBetweenStrings(routeFilterName, routeFilterId);
			line.Item1ElementName = (Item1ChoiceType17) IAxlSoap.DetermineChosenBetweenStringsType(
				routeFilterName, routeFilterId, Item1ChoiceType17.routeFilterName, Item1ChoiceType17.routeFilterId);
			line.Item2 = IAxlSoap.DetermineChosenBetweenStrings(newRoutePartitionName, newRoutePartitionId);

            line.Item2ElementName = (Item2ChoiceType16)IAxlSoap.DetermineChosenBetweenStringsType(
                newRoutePartitionName, newRoutePartitionId, Item2ChoiceType16.newRoutePartitionName, Item2ChoiceType16.newRoutePartitionId);
			
            line.Item3 = IAxlSoap.DetermineChosenBetweenStrings(aarNeighborhoodName, aarNeighborhoodId);

            line.Item3ElementName = (Item3ChoiceType12)IAxlSoap.DetermineChosenBetweenStringsType(
                aarNeighborhoodName, aarNeighborhoodId, Item3ChoiceType12.aarNeighborhoodName, Item3ChoiceType12.aarNeighborhoodId);
			
            line.Item4 = IAxlSoap.DetermineChosenBetweenStrings(callPickupGroupName, callPickupGroupId);
            
            line.Item5 = IAxlSoap.DetermineChosenBetweenStrings(shareLineAppearanceCSSName, shareLineAppearanceCSSId);

            line.Item5ElementName = (Item5ChoiceType8)IAxlSoap.DetermineChosenBetweenStringsType(
                shareLineAppearanceCSSName, shareLineAppearanceCSSId, Item5ChoiceType8.shareLineAppearanceCSSName, Item5ChoiceType8.shareLineAppearanceCSSId);
            
            line.Item6 = IAxlSoap.DetermineChosenBetweenStrings(voiceMailProfileName, voiceMailProfileId);

            line.Item6ElementName = (Item6ChoiceType6)IAxlSoap.DetermineChosenBetweenStringsType(
                voiceMailProfileName, voiceMailProfileId, Item6ChoiceType6.voiceMailProfileName, Item6ChoiceType6.voiceMailProfileId);
			
            line.alertingName = alertingName;
			line.autoAnswer = autoAnswer;
			//dpotter line.autoAnswerSpecified = false;
            ...
            //dpotter line.patternPrecedenceSpecified = patternPrecedenceSpecified;
            line.releaseCause = releaseCause;
            //dpotter line.releaseCauseSpecified = releaseCauseSpecified;
			...
			line.callForwardBusyInt = callForwardBusyInt != null ? callForwardBusyInt.Data : null;
			line.callForwardNoAnswer = callForwardNoAnswer != null ? callForwardNoAnswer.Data : null;
			line.callForwardNoAnswerInt = callForwardNoAnswerInt != null ? callForwardNoAnswerInt.Data : null;
			line.callForwardOnFailure = callForwardOnFailure != null ? callForwardOnFailure.Data : null;
			line.callForwardNoCoverage = callForwardNoCoverage != null ? callForwardNoCoverage.Data : null;
			line.callForwardNoCoverageInt = callForwardNoCoverageInt != null ? callForwardNoCoverageInt.Data : null;

			CorrectCallForward(line.callForwardAll);
			CorrectCallForward(line.callForwardBusy);
			CorrectCallForward(line.callForwardBusyInt);
			CorrectCallForward(line.callForwardNoAnswer);
			CorrectCallForward(line.callForwardNoAnswerInt);
			CorrectCallForward(line.callForwardOnFailure);
			CorrectCallForward(line.callForwardAlternateParty);
			CorrectCallForward(line.callForwardNoCoverage);
			CorrectCallForward(line.callForwardNoCoverageInt);
