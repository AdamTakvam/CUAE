...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.DoAuthenticateUser;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'doAuthenticateUser' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    ...
    public class DoAuthenticateUser: INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType36) IAxlSoap.DetermineChosenBetweenStringsType
				(userPassword, userPin, ItemChoiceType36.password, ItemChoiceType36.pin);
