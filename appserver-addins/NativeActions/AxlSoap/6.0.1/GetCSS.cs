...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.GetCSS;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'getCSS' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType55)IAxlSoap.DetermineChosenBetweenStringsType(cssName, cssId, ItemChoiceType55.name, ItemChoiceType55.uuid);
