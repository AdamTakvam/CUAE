...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.DoDeviceReset;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'doDeviceReset' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    ...
    public class DoDeviceReset: INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType16)IAxlSoap.DetermineChosenBetweenStringsType
                (phoneName, phoneId, ItemChoiceType16.deviceName, ItemChoiceType16.deviceId);
