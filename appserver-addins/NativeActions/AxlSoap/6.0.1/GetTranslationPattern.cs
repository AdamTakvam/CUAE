...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.GetTranslationPattern;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'getTranslationPattern' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
