...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.ExecuteSQLUpdate;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'ExecuteSQLUpdate' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    ...
    public class ExecuteSQLUpdate: INativeAction
	{

        [ActionParamField(Package.Params.Update.DISPLAY, Package.Params.Update.DESCRIPTION, false, Package.Params.Update.DEFAULT)]
        public string Update { set { update = value; } }
        ...
        [ResultDataField(Package.Results.ExecuteSQLUpdateResponse.DISPLAY, Package.Results.ExecuteSQLUpdateResponse.DESCRIPTION)]
        public executeSQLUpdateResponse ExecuteSQLUpdateResponse { get { return response; } }
        ...
        public void Clear()
        {
            ...
            this.response       = new executeSQLUpdateResponse();
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            executeSQLUpdate request = new executeSQLUpdate();
			request.sql = update;

            try
            {
                response = client.executeSQLUpdate(request);
            }
