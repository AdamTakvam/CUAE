...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.UpdatePhone;
...
namespace Metreos.Native.AxlSoap601
{
    ...
    public class UpdatePhone : INativeAction
	{
        ...
        public string BuiltInBridgeStatus { set { builtInBridgeStatus = value; } }
        ...
        public string CallInfoPrivacyStatus { set { callInfoPrivacyStatus = value; } }
...
//        public XDeviceSecurityMode DeviceSecurityMode { set { deviceSecurityMode = value; } }
		...
		public string CertificateOperation { set { certificateOperation = value; /*certificateOperationSpecified = true;*/ } }
		...
		public string CertificateStatus { set { certificateStatus = value; /*certificateStatusSpecified = true;*/} }
        ...
        public string MlppIndicationStatus { set { mlppIndicationStatus = value; } }
        ...
        public string Preemption { set { preemption = value; } }
        ...
        private string builtInBridgeStatus;
        private bool builtInBridgeStatusSpecified;
        private string callInfoPrivacyStatus;
        ...
        private string mlppIndicationStatus;
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            //dpotter updatePhone.certificateOperationSpecified = certificateOperationSpecified;
			updatePhone.certificateStatus = certificateStatus;
            //dpotter updatePhone.certificateStatusSpecified = certificateStatusSpecified;
            updatePhone.builtInBridgeStatus = builtInBridgeStatus;
            //dpotter updatePhone.builtInBridgeStatusSpecified = builtInBridgeStatusSpecified;
            updatePhone.callInfoPrivacyStatus = callInfoPrivacyStatus;
            //dpotter updatePhone.callInfoPrivacyStatusSpecified = callInfoPrivacyStatusSpecified;
...
//            updatePhone.deviceSecurityModeSpecified = deviceSecurityModeSpecified;
            ...
            //dpotter updatePhone.enableExtensionMobilitySpecified = enableExtensionMobilitySpecified;
            ...
            updatePhone.ItemElementName = (ItemChoiceType72)IAxlSoap.DetermineChosenBetweenStringsType(phoneName, phoneId, ItemChoiceType72.name, ItemChoiceType72.uuid);
            updatePhone.Item1 = IAxlSoap.DetermineChosenBetweenStrings(callingSearchSpaceName, callingSearchSpaceId);
            updatePhone.Item1ElementName = (Item1ChoiceType18)IAxlSoap.DetermineChosenBetweenStringsType(callingSearchSpaceName, callingSearchSpaceId,
                Item1ChoiceType18.callingSearchSpaceName, Item1ChoiceType18.callingSearchSpaceId);
            updatePhone.Item2 = IAxlSoap.DetermineChosenBetweenStrings(devicePoolName, devicePoolId);
            updatePhone.Item2ElementName = (Item2ChoiceType17)IAxlSoap.DetermineChosenBetweenStringsType(devicePoolName, devicePoolId,
                Item2ChoiceType17.devicePoolName, Item2ChoiceType17.devicePoolId);
            
            updatePhone.Item3 = IAxlSoap.DetermineChosenBetweenStrings(locationName, locationId);
            updatePhone.Item3ElementName = (Item3ChoiceType13)IAxlSoap.DetermineChosenBetweenStringsType(locationName, locationId,
                Item4ChoiceType9.locationName, Item4ChoiceType9.locationId);
            ...
            updatePhone.Item4ElementName = (Item4ChoiceType9)IAxlSoap.DetermineChosenBetweenStringsType(mediaResourceListName, mediaResourceListId,
                Item5ChoiceType9.mediaResourceListName, Item5ChoiceType9.mediaResourceListId);
            ...
            updatePhone.Item5ElementName = (Item5ChoiceType9)IAxlSoap.DetermineChosenBetweenStringsType(
                ...
                Item6ChoiceType7.automatedAlternateRoutingCSSName, Item6ChoiceType7.automatedAlternateRoutingCSSId);
            ...
            updatePhone.Item6ElementName = (Item6ChoiceType7) IAxlSoap.DetermineChosenBetweenStringsType(
                ...
                Item7ChoiceType4.aarNeighborhoodName, Item7ChoiceType4.aarNeighborhoodId);
            updatePhone.Item7 = IAxlSoap.DetermineChosenBetweenStrings(phoneTemplateName, phoneTemplateId); 
            updatePhone.Item7ElementName = (Item7ChoiceType4) IAxlSoap.DetermineChosenBetweenStringsType(
                phoneTemplateName, phoneTemplateId, Item8ChoiceType2.phoneTemplateName, Item8ChoiceType2.phoneTemplateId);

			updatePhone.Item8 = IAxlSoap.DetermineChosenBetweenStrings(securityProfileName, securityProfileId);
			updatePhone.Item8ElementName = (Item8ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
                securityProfileName, securityProfileId, Item9ChoiceType2.securityProfileName, Item9ChoiceType2.securityProfileId);

			updatePhone.Item9 = IAxlSoap.DetermineChosenBetweenStrings(softkeyTemplateName, softkeyTemplateId);
			updatePhone.Item9ElementName = (Item9ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
                softkeyTemplateName, softkeyTemplateId, Item10ChoiceType3.softkeyTemplateName, Item10ChoiceType3.softkeyTemplateId);
            ...
            updatePhone.Item10ElementName = (Item10ChoiceType3) IAxlSoap.DetermineChosenBetweenStringsType(
                defaultProfileName, defaultProfileId, Item11ChoiceType1.defaultProfileName, Item11ChoiceType1.defaultProfileId);

			updatePhone.Item11 = IAxlSoap.DetermineChosenBetweenStrings(subscribeCallingSearchSpaceName, subscribeCallingSearchSpaceId); 
			updatePhone.Item11ElementName = (Item11ChoiceType1) IAxlSoap.DetermineChosenBetweenStringsType(
                subscribeCallingSearchSpaceName, subscribeCallingSearchSpaceId, Item12ChoiceType1.subscribeCallingSearchSpaceName, Item12ChoiceType1.subscribeCallingSearchSpaceId);
			
            updatePhone.Item12 = IAxlSoap.DetermineChosenBetweenStrings(presenceGroupName, presenceGroupId); 
			updatePhone.Item12ElementName = (Item12ChoiceType1) IAxlSoap.DetermineChosenBetweenStringsType(
                presenceGroupName, presenceGroupId, Item14ChoiceType.presenceGroupName, Item14ChoiceType.presenceGroupId);
            ...
            //dpotter updatePhone.mlppIndicationStatusSpecified = mlppIndicationStatusSpecified;
            ...
            //dpotter updatePhone.preemptionSpecified = preemptionSpecified;
        ...
        public void Clear()
        {
            ...
            this.builtInBridgeStatus        = null;//dpotter string.Default;
            this.builtInBridgeStatusSpecified = false;
            this.callInfoPrivacyStatus      = null;//dpotter string.Default;
			...
			this.certificateOperation		= null;//dpotter XCertificateOperation.NoPendingOperation;
			//this.certificateOperationSpecified = false;
			this.certificateStatus			= null;//dpotter XCertificateStatus.None;
            ...
            this.MlppIndicationStatus       = null;//dpotter string.Default;
            this.networkHoldMOHAudioSourceId = null;
            this.newName                    = null;
            this.preemption                 = null;//dpotter  XPreemption.Default;
