...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.AddLineItem;

namespace Metreos.Native.AxlSoap601
{
    /// <summary> Creates a line item for the 'updatePhone' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    ...
    {    
        ...
        public string ConsecutiveRingSetting { set { consecutiveRingSetting = value; } }
        ...
        public string MwlPolicy { set { mwlPolicy = value; } }
        ...
        public string RingSetting { set { ringSetting = value; } }
        ...
        private string consecutiveRingSetting;
        ...
        public void Clear()
        {
            ...
            this.consecutiveRingSetting     = null;//dpotterstring.UseSystemDefault;
            this.ctiid                      = null;
            ...
            this.mwlPolicy                  = null;//dpotterXMWLPolicy.UseSystemPolicy;
        ...
        { 
			...
			//line.callInfoDisplay = new XLineCallInfoDisplay() // not supported
            ...
            //dpotter line.mwlPolicySpecified = mwlPolicySpecified;
