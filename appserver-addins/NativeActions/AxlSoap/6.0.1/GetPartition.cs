...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.GetPartition;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'getPartition' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType32) IAxlSoap.DetermineChosenBetweenStringsType(partitionName, partitionId, ItemChoiceType32.partitionName, ItemChoiceType32.partitionId);
