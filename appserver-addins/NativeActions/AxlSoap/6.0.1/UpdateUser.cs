...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.UpdateUser;

namespace Metreos.Native.AxlSoap601
{
    /// <summary> Wraps up the 'updateUser' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    ...
    {     
        ...
        public void Clear()
        {
			...
			this.userid						= null;
            this.userLocale                 = null;//dpotter XUserLocale.EnglishUnitedStates;
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
			...
			//dpotter user.userLocaleSpecified = userLocaleSpecified;
