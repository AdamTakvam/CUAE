...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.GetHuntPilot;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'getHuntPilot' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
