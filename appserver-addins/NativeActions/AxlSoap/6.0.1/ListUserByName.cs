...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.ListUserByName;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'listUserByName' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
