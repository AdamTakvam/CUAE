...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.AddLineGroupItem;

namespace Metreos.Native.AxlSoap601
{
    /// <summary> Creates a line item for the 'updateLineGroup' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    ...
    {    
        ...
        { 
			...
			else
			{
				...
				pattPart.ItemElementName = (ItemChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
					routePartitionName, routePartitionId, ItemChoiceType5.routePartitionName, ItemChoiceType5.routePartitionId);
