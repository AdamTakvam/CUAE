...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.RemoveHuntList;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'removeHuntList' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
