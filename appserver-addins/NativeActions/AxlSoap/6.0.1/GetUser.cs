...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.GetUser;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'getUser' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
