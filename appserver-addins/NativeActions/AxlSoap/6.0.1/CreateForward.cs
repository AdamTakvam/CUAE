...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.CreateForward;

namespace Metreos.Native.AxlSoap601
{
    /// <summary> 
    ///     Creates the forwarding information for a forward attribute for a line, 
    ///     to be later used with an 'updateLine' AXL SOAP method for Cisco CallManager 6.0.1
    /// </summary>
    ...
    {    
        ...
        {  
            ...
            //dpotter forward.forwardToVoiceMailSpecified = forwardToVoiceMailSpecified;
