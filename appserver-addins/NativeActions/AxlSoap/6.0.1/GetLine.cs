...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.GetLine;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'getLine' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
			...
			request.ItemElementName = (ItemChoiceType69) IAxlSoap.DetermineChosenBetweenStringsType(
			...
			request.Item1ElementName = (Item1ChoiceType17) IAxlSoap.DetermineChosenBetweenStringsType(
