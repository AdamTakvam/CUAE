...
{
	/// <summary> Wraps up the 'addPhone.newPhone' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    [PackageDecl("Metreos.Native.AxlSoap601")]
    public class AddPhone : INativeAction
	{
		...
		public bool RetryVideoCallAsVoice { set { retryVideoCallAsVoice = value; retryVideoCallAsVoiceSpecified = true; } }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
			...
			addPhone.newPhone.allowCtiControlFlag = allowCtiControlFlag;
			addPhone.newPhone.allowCtiControlFlagSpecified = allowCtiControlFlagSpecified;
			...
			addPhone.newPhone.certificateOperation = certificateOperation;
			addPhone.newPhone.certificateOperationSpecified = certificateOperationSpecified;
			addPhone.newPhone.certificateStatus = certificateStatus;
			addPhone.newPhone.certificateStatusSpecified = certificateStatusSpecified;
			...
			addPhone.newPhone.retryVideoCallAsAudio = retryVideoCallAsVoice;
			addPhone.newPhone.retryVideoCallAsAudioSpecified = retryVideoCallAsVoiceSpecified;
			...
			{
				XIPPhoneSecurityProfile sp = new XIPPhoneSecurityProfile();
				sp.uuid = securityProfileId;
				addPhone.newPhone.Item8 = sp;
			}
			else
			{
				addPhone.newPhone.Item8 = securityProfileName;
			}
...
//				addPhone.newPhone.Item9 = pt;
//			}
//			else
//			{
//				addPhone.newPhone.Item9 = phoneTemplateName;
//			}
			...
			if(subscribeCallingSearchSpaceId != null)      // Used in conjunction with Extension Mobility

			{
				XCallingSearchSpace css = new XCallingSearchSpace();
				css.uuid = subscribeCallingSearchSpaceId;
				addPhone.newPhone.Item12 = css;
			}
			else
			{
				addPhone.newPhone.Item12 = subscribeCallingSearchSpaceName;
			}

//			if(presenceGroupId != null)      // Used in conjunction with Extension Mobility
//
//			{
//				XPresenceGroup pg = new XPresenceGroup();
//				pg..uuid = presenceGroupId;
//				addPhone.newPhone.Item13 = pg;
//			}
//			else
//			{
				addPhone.newPhone.Item13 = presenceGroupName;
//			}
        ...
        public void Clear()
        {
            ...
            this.idleUrl                    = null;
            this.phoneName                  = null;
			this.protocol					= XDeviceProtocol.SCCP;
        ...
        public XIPPhoneLines BuildLines()
        {
            ...
            {
                // no lines
				return new XIPPhoneLines();
            }

            XIPPhoneLines newLines = new XIPPhoneLines();
