...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601.Actions.GetPhone;

namespace Metreos.Native.AxlSoap601
{
	/// <summary> Wraps up the 'getPhone' AXL SOAP method for Cisco CallManager 6.0.1 </summary>
    ...
    public class GetPhone : INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType63) IAxlSoap.DetermineChosenBetweenStringsType(
                phoneName, phoneId, ItemChoiceType63.phoneName, ItemChoiceType63.phoneId);
