...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.UpdateLine;

namespace Metreos.Native.AxlSoap333
{
    /// <summary> Wraps up the 'updateLine' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            line.callPickupGroupId = callPickupGroupId;
            line.description = description;
            line.Item = uuid != null ? null : IAxlSoap.DetermineChosenBetweenStrings(routePartitionName, routePartitionId);
            line.ItemElementName = (Item1ChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
            ...
            line.Item3 = IAxlSoap.DetermineChosenBetweenStrings(shareLineAppearanceCSSName, shareLineAppearanceCSSId);
            line.Item3ElementName = (Item3ChoiceType1) IAxlSoap.DetermineChosenBetweenStringsType(
                shareLineAppearanceCSSName, shareLineAppearanceCSSId, Item3ChoiceType1.shareLineAppearanceCSSName, Item3ChoiceType1.shareLineAppearanceCSSId);
            line.Item4 = IAxlSoap.DetermineChosenBetweenStrings(voiceMailProfileName, voiceMailProfileId);
            line.Item4ElementName = (Item4ChoiceType1) IAxlSoap.DetermineChosenBetweenStringsType(
                voiceMailProfileName, voiceMailProfileId, Item4ChoiceType1.voiceMailProfileName, Item4ChoiceType1.voiceMailProfileId);
            line.Item5 = uuid != null ? null : IAxlSoap.DetermineChosenBetweenStrings(routeFilterName, routeFilterId);
            line.Item5ElementName = (Item4ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
