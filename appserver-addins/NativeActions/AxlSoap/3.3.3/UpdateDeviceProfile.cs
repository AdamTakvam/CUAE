...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.UpdateDeviceProfile;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'updatePhone' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
    ...
    public class UpdateDeviceProfile : INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            updateProfile.ItemElementName = (ItemChoiceType15) IAxlSoap.DetermineChosenBetweenStringsType(
                profileName, profileId, ItemChoiceType15.name, ItemChoiceType15.uuid);
            updateProfile.Item1 = IAxlSoap.DetermineChosenBetweenStrings(phoneTemplateName, phoneTemplateId);
            updateProfile.Item1ElementName = (Item1ChoiceType4) IAxlSoap.DetermineChosenBetweenStringsType(
                phoneTemplateName, phoneTemplateId, Item1ChoiceType4.phoneTemplateName, Item1ChoiceType4.phoneTemplateId);
            updateProfile.Item2 = IAxlSoap.DetermineChosenBetweenStrings(softkeyTemplateName, softkeyTemplateId);
            updateProfile.Item2ElementName = (Item2ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
                softkeyTemplateName, softkeyTemplateId, Item2ChoiceType2.softkeyTemplateName, Item2ChoiceType2.softkeyTemplateId);
