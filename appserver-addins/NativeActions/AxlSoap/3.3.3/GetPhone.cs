...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.GetPhone;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'getPhone' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
    ...
    public class GetPhone : INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.Item = DeterminePhoneIdentifier();
            request.ItemElementName = DeterminePhoneIdentifierType();
        ...
        public string DeterminePhoneIdentifier()
        {
            if(phoneName != null && phoneName != String.Empty)
            {
                return phoneName;
        ...
        public ItemChoiceType7 DeterminePhoneIdentifierType()
        {
            if(phoneName != null && phoneName != String.Empty)
            {
                return ItemChoiceType7.phoneName;
            }
            else
            {
                return ItemChoiceType7.phoneId;
            }
        }
