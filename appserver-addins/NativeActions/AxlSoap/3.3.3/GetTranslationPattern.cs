...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.GetTranslationPattern;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'getTranslationPattern' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
