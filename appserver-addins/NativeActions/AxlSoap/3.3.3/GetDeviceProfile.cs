...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.GetDeviceProfile;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'getDeficeProfile' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
    ...
    public class GetDeviceProfile : INativeAction
	{
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType16) IAxlSoap.DetermineChosenBetweenStringsType(
                profileName, profileId, ItemChoiceType16.profileName, ItemChoiceType16.profileId);
