...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.AddLineItem;

namespace Metreos.Native.AxlSoap333
{
    /// <summary> Creates a line item for the 'updatePhone' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
