...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.AddPhone;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'addPhone.newPhone' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
