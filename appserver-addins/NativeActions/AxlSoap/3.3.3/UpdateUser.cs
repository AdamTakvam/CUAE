...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.UpdateUser;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'updateUser' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
