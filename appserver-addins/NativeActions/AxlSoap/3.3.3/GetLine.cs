...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.GetLine;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'getLine' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
    ...
    public class GetLine : INativeAction
	{     
        ...
        [ResultDataField(Package.Results.GetLineResponse.DISPLAY, Package.Results.GetLineResponse.DESCRIPTION)]
        public getLineResponse GetLineResponse { get { return response; } }
        ...
        private getLineResponse response;
        ...
        public void Clear()
        {
            ...
            this.response                   = new getLineResponse();
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            getLine request = new getLine();
            request.Item = IAxlSoap.DetermineChosenBetweenStrings(routePartitionName, routePartitionId);
            request.ItemElementName = (Item1ChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
            ...
            request.ItemElementName1 = (Item4ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
            ...
            try
            {
                response = client.getLine(request);
            }
