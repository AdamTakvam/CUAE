...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.RemovePhone;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'removePhone' AXL SOAP method for Cisco CallManager 4.1.3 </summary>
    ...
    public class RemovePhone : INativeAction
	{
        ...
        [ResultDataField(Package.Results.RemovePhoneResponse.DISPLAY, Package.Results.RemovePhoneResponse.DESCRIPTION)]
        public removePhoneResponse RemovePhoneResponse { get { return response; } }
        ...
        public void Clear()
        {
            ...
            this.response       = new removePhoneResponse();
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            request.ItemElementName = (ItemChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
                phoneName, phoneId, ItemChoiceType5.phoneName, ItemChoiceType5.phoneId);
            
            try
            {
                response = client.removePhone(request);
            }
