...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.DoDeviceReset;

namespace Metreos.Native.AxlSoap333
{
	/// <summary> Wraps up the 'doDeviceReset' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
    ...
    public class DoDeviceReset: INativeAction
	{
        ...
        [ActionParamField(Package.Params.IsHardReset.DISPLAY, Package.Params.IsHardReset.DESCRIPTION, false, Package.Params.IsHardReset.DEFAULT)]
        public bool IsHardReset { set { isHardReset = value; } }

        [ActionParamField(Package.Params.IsMgcp.DISPLAY, Package.Params.IsMgcp.DESCRIPTION, false, Package.Params.IsMgcp.DEFAULT)]
        public bool IsMgcp { set { isMgcp = value; } }

        [ResultDataField(Package.Results.DoDeviceResetResponse.DISPLAY, Package.Results.DoDeviceResetResponse.DESCRIPTION)]
        public doDeviceResetResponse DoDeviceResetResponse { get { return response; } }
        ...
        private bool isMgcp;
        private bool isHardReset;
        private string callManagerIP;
        private int code;
        private LogWriter log;
        private doDeviceResetResponse response;

		public DoDeviceReset()
		{
		    Clear();	
		}
        ...
        public void Clear()
        {
            ...
            this.isMgcp         = false;
            this.response       = new doDeviceResetResponse();
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            doDeviceReset request = new doDeviceReset();
            request.Item = IAxlSoap.DetermineChosenBetweenStrings(phoneName, phoneId);
            request.ItemElementName = (ItemChoiceType10) IAxlSoap.DetermineChosenBetweenStringsType
                (phoneName, phoneId, ItemChoiceType10.deviceName, ItemChoiceType10.deviceId);
            request.isHardReset = isHardReset;
            request.isMGCP = isMgcp;
            
            try
            {
                response = client.doDeviceReset(request);
            }
