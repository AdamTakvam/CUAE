...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.UpdateTranslationPattern;

namespace Metreos.Native.AxlSoap333
{
    /// <summary> Wraps up the 'updateTranslationPattern' AXL SOAP method for Cisco CallManager 3.3.3 </summary>
...
//            }
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            trans.Item = uuid != null ? null : IAxlSoap.DetermineChosenBetweenStrings(routePartitionName, routePartitionId);
            trans.ItemElementName = (Item1ChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
                routePartitionName, routePartitionId, Item1ChoiceType5.routePartitionName, Item1ChoiceType5.routePartitionId);
...
//            trans.Item2 = IAxlSoap.DetermineChosenBetweenStrings(dialPlanName, dialPlanId);
            trans.Item2ElementName = (Item2ChoiceType3) IAxlSoap.DetermineChosenBetweenStringsType(
                dialPlanName, dialPlanId, Item2ChoiceType3.dialPlanName, Item2ChoiceType3.dialPlanId);
            trans.Item3 = IAxlSoap.DetermineChosenBetweenStrings(digitDiscardInstructionName, digitDiscardInstructionId);
            trans.Item3ElementName = (Item3ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
                digitDiscardInstructionName, digitDiscardInstructionId, Item3ChoiceType2.digitDiscardInstructionName, Item3ChoiceType2.digitDiscardInstructionId);
...
//                routeFilterName, routeFilterId, Item4ChoiceType2.routeFilterName, Item4ChoiceType2.routeFilterId);
            trans.Item5 = uuid != null ? null : IAxlSoap.DetermineChosenBetweenStrings(routeFilterName, routeFilterId);
            trans.Item5ElementName = (Item4ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
                routeFilterName, routeFilterId, Item4ChoiceType2.routeFilterName, Item4ChoiceType2.routeFilterId);
            trans.Item6 = IAxlSoap.DetermineChosenBetweenStrings(callingSearchSpaceName, callingSearchSpaceId);
            trans.Item6ElementName = (Item5ChoiceType1) IAxlSoap.DetermineChosenBetweenStringsType(
                callingSearchSpaceName, callingSearchSpaceId, Item5ChoiceType1.callingSearchSpaceName, Item5ChoiceType1.callingSearchSpaceId);
