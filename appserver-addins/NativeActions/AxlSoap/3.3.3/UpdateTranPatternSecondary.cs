...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333.Actions.UpdateTranslationPatternSecondary;

namespace Metreos.Native.AxlSoap333
{
    /// <summary> Wraps up the additional, non-serializable 'updateTranslationPattern' AXL SOAP fields for Cisco CallManager 3.3.3 </summary>
    ...
    {     
        ...
        public string Execute(SessionData sessionData, IConfigUtility configUtility) 
        {
            ...
            trans.Item1ElementName = (Item1ChoiceType5) IAxlSoap.DetermineChosenBetweenStringsType(
                newRoutePartitionName, newRoutePartitionId, Item1ChoiceType5.routePartitionName, Item1ChoiceType5.routePartitionId);
            ...
            trans.Item4ElementName = (Item4ChoiceType2) IAxlSoap.DetermineChosenBetweenStringsType(
                newRouteFilterName, newRouteFilterId, Item4ChoiceType2.routeFilterName, Item4ChoiceType2.routeFilterId);
            trans.uuid = uuid;
