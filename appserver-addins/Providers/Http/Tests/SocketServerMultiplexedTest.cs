...
namespace Metreos.Providers.Http.Tests
{
    ...
    public sealed class MyTestMuxedProtocolStack
    {
        ...
        public SocketServerMultiplexed mux;

        public int lastConnectionHandle;

        public MyTestMuxedProtocolStack(ushort port)
        {
            mux = new SocketServerMultiplexed("MyTestProtocolStack", port, TraceLevel.Info);
            ...
            mux.onDataReceived = new SocketServerBase.DataReceivedDelegate(this.OnNewData);
            mux.onNewConnection = new SocketServerBase.NewConnectionDelegate(this.OnNewConnection);
            mux.onCloseConnection = new SocketServerBase.CloseConnectionDelegate(this.OnCloseConnection);
    ...
    [csUnit.Ignore("Not implemented.")]
    public class SocketServerMultiplexedTest
    {
        public const ushort PORT = 23127;
        public MyTestMuxedProtocolStack stack;

        public SocketServerMultiplexedTest()
        {
        }
        ...
        {
            stack = new MyTestMuxedProtocolStack(PORT);
        }
