...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601Types.Types.ListUserByNameResponse;

namespace Metreos.Types.AxlSoap601
{
    /// <summary>
    ///     Provides an interface to the information contained within the listUserByNameResponse from AXL SOAP 6.0.1
    /// </summary>
