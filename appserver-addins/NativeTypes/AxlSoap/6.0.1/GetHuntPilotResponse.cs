...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601Types.Types.GetHuntPilotResponse;

namespace Metreos.Types.AxlSoap601
{
    /// <summary>
    ///     Provides an interface to the information contained within the getHuntPilotResponse from AXL SOAP 6.0.1
    /// </summary>
