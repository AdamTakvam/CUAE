...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap601Types.Types.Speeddials;

namespace Metreos.Types.AxlSoap601
{
    /// <summary>
    ///     Stores information about multiple speeddials, for use with 'updatePhone' from the AXL SOAP 6.0.1
    /// </summary>
