...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413Types.Types.UpdateTranslationPatternResponse;

namespace Metreos.Types.AxlSoap413
{
    /// <summary>
    ///     Provides an interface to the information contained within the updateTransPatternResponse from AXL SOAP 4.1.3
    /// </summary>
