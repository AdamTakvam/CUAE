...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413Types.Types.LineGroupMembers;

namespace Metreos.Types.AxlSoap413
{
    /// <summary>
    ///     Stores information about multiple lines, for use with 'updateLineGroup' or 'addLineGroup' from the AXL SOAP 4.1.3
    /// </summary>
