...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413Types.Types.Services;

namespace Metreos.Types.AxlSoap413
{
    /// <summary>
    ///     Stores information about multiple sevices, for use with 'updatePhone' from the AXL SOAP 4.1.3
    /// </summary>
