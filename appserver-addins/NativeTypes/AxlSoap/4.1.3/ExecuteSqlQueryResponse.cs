...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413Types.Types.ExecuteSQLQueryResponse;

namespace Metreos.Types.AxlSoap413
{
    /// <summary>
    ///     Provides an interface to the information contained within the ExecuteSQLQuery from AXL SOAP 4.1.3
    /// </summary>
