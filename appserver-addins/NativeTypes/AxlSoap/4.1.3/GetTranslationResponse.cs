...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413Types.Types.GetTranslationResponse;

namespace Metreos.Types.AxlSoap413
{
    /// <summary>
    ///     Provides an interface to the information contained within the getTransPatternResponse from AXL SOAP 4.1.3
    /// </summary>
