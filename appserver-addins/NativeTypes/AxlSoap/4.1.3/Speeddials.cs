...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap413Types.Types.Speeddials;

namespace Metreos.Types.AxlSoap413
{
    /// <summary>
    ///     Stores information about multiple speeddials, for use with 'updatePhone' from the AXL SOAP 4.1.3
    /// </summary>
