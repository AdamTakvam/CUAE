...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333Types.Types.RemovePhoneResponse;

namespace Metreos.Types.AxlSoap333
{
    /// <summary>
    ///     Provides an interface to the information contained within the removePhoneResponse from AXL SOAP 3.3.3
    /// </summary>
    [Metreos.PackageGeneratorCore.Attributes.TypeDecl("AxlSoap.RemovePhoneResponse (3.3.3)", 
