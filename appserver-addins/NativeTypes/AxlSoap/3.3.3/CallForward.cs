...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333Types.Types.CallForward;

namespace Metreos.Types.AxlSoap333
{
    /// <summary>
    ///     Stores information about a forward object, for use with 'updatePhone' from the AXL SOAP 3.3.3
    /// </summary>
