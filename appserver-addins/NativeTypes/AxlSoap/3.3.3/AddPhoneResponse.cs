...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333Types.Types.AddPhoneResponse;

namespace Metreos.Types.AxlSoap333
{
    /// <summary>
    ///     Provides an interface to the information contained within the addPhoneResponse from AXL SOAP 3.3.3
    /// </summary>
    [Metreos.PackageGeneratorCore.Attributes.TypeDecl("AxlSoap.AddPhoneResponse (3.3.3)", 
