...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333Types.Types.GetTranslationResponse;

namespace Metreos.Types.AxlSoap333
{
    /// <summary>
    ///     Provides an interface to the information contained within the getTransPatternResponse from AXL SOAP 3.3.3
    /// </summary>
