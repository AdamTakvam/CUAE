...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap333Types.Types.Services;

namespace Metreos.Types.AxlSoap333
{
    /// <summary>
    ///     Stores information about multiple sevices, for use with 'updatePhone' from the AXL SOAP 3.3.3
    /// </summary>
