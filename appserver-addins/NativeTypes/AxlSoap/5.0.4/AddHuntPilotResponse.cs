...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504Types.Types.AddHuntPilotResponse;

namespace Metreos.Types.AxlSoap504
{
    /// <summary>
    ///     Provides an interface to the information contained within the addHuntPilotResponse from AXL SOAP 5.0.4
    /// </summary>
