...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504Types.Types.ListUserByNameResponse;

namespace Metreos.Types.AxlSoap504
{
    /// <summary>
    ///     Provides an interface to the information contained within the listUserByNameResponse from AXL SOAP 5.0.4
    /// </summary>
