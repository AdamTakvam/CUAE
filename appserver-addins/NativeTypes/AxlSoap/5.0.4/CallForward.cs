...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504Types.Types.CallForward;

namespace Metreos.Types.AxlSoap504
{
    /// <summary>
    ///     Stores information about a forward object, for use with 'updatePhone' from the AXL SOAP 5.0.4
    /// </summary>
