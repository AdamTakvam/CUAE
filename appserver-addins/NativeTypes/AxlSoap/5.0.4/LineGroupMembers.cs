...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504Types.Types.LineGroupMembers;

namespace Metreos.Types.AxlSoap504
{
    /// <summary>
    ///     Stores information about multiple lines, for use with 'updateLineGroup' or 'addLineGroup' from the AXL SOAP 5.0.4
    /// </summary>
