...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504Types.Types.Services;

namespace Metreos.Types.AxlSoap504
{
    /// <summary>
    ///     Stores information about multiple sevices, for use with 'updatePhone' from the AXL SOAP 5.0.4
    /// </summary>
