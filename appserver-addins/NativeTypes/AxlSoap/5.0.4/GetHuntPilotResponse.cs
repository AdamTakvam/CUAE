...
using Package = Metreos.Interfaces.PackageDefinitions.AxlSoap504Types.Types.GetHuntPilotResponse;

namespace Metreos.Types.AxlSoap504
{
    /// <summary>
    ///     Provides an interface to the information contained within the getHuntPilotResponse from AXL SOAP 5.0.4
    /// </summary>
