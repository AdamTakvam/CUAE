...
rem echo on
set EnrollSpeakerDir=X:\Build\AppSuite\EnrollSpeaker
mkdir %EnrollSpeakerDir%
...
copy %ActionDir%\%1\Metreos.Native.EnrollSpeaker.dll			%EnrollSpeakerDir%   		>> postbuild.txt
...
copy %ActionDir%\%1\Metreos.Native.EnrollSpeaker.pdb				%EnrollSpeakerDir%   	>> postbuild.txt
