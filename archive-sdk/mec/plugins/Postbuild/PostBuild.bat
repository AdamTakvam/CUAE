...
rem echo on
set MceDir=X:\Build\AppSuite\Mce
mkdir %MceDir%    
...
copy %ActionDir%\%1\Metreos.Native.Mec.dll				%MceDir%   		>> postbuild.txt
...
copy %ActionDir%\%1\Metreos.Native.Mec.pdb				%MceDir%   		>> postbuild.txt
