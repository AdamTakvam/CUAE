<Application name="Main" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <global name="Main">
    ...
    <variables>
      <treenode text="g_deviceProfile" id="632994707712075203" vid="632586579304079811">
        <Properties type="String" initWith="deviceProfile">g_deviceProfile</Properties>
      </treenode>
      <treenode text="g_ccmIp" id="632994707712075205" vid="632586579304079813">
        <Properties type="String" initWith="callManagerIP">g_ccmIp</Properties>
      </treenode>
      <treenode text="g_ccmUsername" id="632994707712075207" vid="632586579304079815">
        <Properties type="String" initWith="ccmUsername">g_ccmUsername</Properties>
      </treenode>
      <treenode text="g_ccmPassword" id="632994707712075209" vid="632586579304079817">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632419389328631747" treenode="632419389328631748" appnode="632419389328631745" handlerfor="632419389328631744">
    ...
    <node type="Label" id="632419389328631758" text="A" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="618" y="59">
      <linkto id="632419389328631752" type="Basic" style="Vector" />
    </node>
    ...
    <node type="Action" id="632452364485965518" name="UpdateDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="393" y="199">
    ...
    <node type="Action" id="632453055653810658" name="GetDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="212" y="198">
    ...
    <node type="Variable" id="632453055653810659" name="getDeviceProfileResponse" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.GetDeviceProfileResponse" refType="reference">getDeviceProfileResponse</Properties>
    </node>
  </canvas>
  <Properties desc="">
  </Properties>
