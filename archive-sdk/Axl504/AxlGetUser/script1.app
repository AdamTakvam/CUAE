<Application name="script1" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false" grid="true">
  ...
  <global name="script1">
    ...
    <variables>
      <treenode text="g_userId" id="632994701834575214" vid="632994701834575213">
        <Properties type="String" initWith="userId">g_userId</Properties>
      </treenode>
      <treenode text="g_ccmUser" id="632994701834575216" vid="632994701834575215">
        <Properties type="String" initWith="ccmUsername">g_ccmUser</Properties>
      </treenode>
      <treenode text="g_ccmPass" id="632994701834575218" vid="632994701834575217">
        <Properties type="String" initWith="ccmPassword">g_ccmPass</Properties>
      </treenode>
      <treenode text="g_ccmIp" id="632994701834575220" vid="632994701834575219">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632994701834575201" treenode="632994701834575202" appnode="632994701834575199" handlerfor="632994701834575198">
    ...
    <node type="Action" id="632994701834575203" name="GetUser" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="360" y="464">
    ...
    <node type="Action" id="632994701834575239" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="560" y="464">
      ...
      <Properties language="csharp">
public static string Execute(Metreos.Types.AxlSoap504.GetUserResponse getUserResponse, ref string formattedMessage)
{
...
manager: {8}
userLocale: {9}
associatedDevices: {10}
associatedPC: {11}
digestCredentials: {12}
iaqExtension: {13}
phoneProfiles: {14}
uuid:{15}",
...
user.department,
user.manager,
user.userLocale.ToString(),
associated,
user.associatedPC,
user.digestCredentials,
user.iaqExtension,
dps,
user.uuid);
    ...
    <node type="Variable" id="632994701834575223" name="getUserResponse" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.GetUserResponse" refType="reference">getUserResponse</Properties>
    </node>
