<Application name="Main" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632419389328631747" treenode="632419389328631748" appnode="632419389328631745" handlerfor="632419389328631744">
    ...
    <node type="Action" id="632419389328631749" name="GetPhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="208" y="200">
    ...
    <node type="Action" id="632419389328631750" name="UpdatePhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="384" y="200">
    ...
    <node type="Action" id="632419389328631768" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="504" y="200">
      ...
      <Properties language="csharp">
	public static string Execute(Metreos.Types.AxlSoap504.GetPhoneResponse getPhoneResponse, ref string formattedMessage)
	{
