<Application name="Update" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false" grid="true">
  <!--//// app tree ////-->
  <global name="Update">
    <outline>
    ...
    <variables>
      <treenode text="g_ccmIP" id="632925366559301597" vid="632925366559301596">
        <Properties type="String" initWith="callManagerIP">g_ccmIP</Properties>
      </treenode>
      <treenode text="g_user" id="632925366559301599" vid="632925366559301598">
        <Properties type="String" initWith="ccmUsername">g_user</Properties>
      </treenode>
      <treenode text="g_pass" id="632925366559301601" vid="632925366559301600">
        <Properties type="String" initWith="ccmPassword">g_pass</Properties>
      </treenode>
      <treenode text="g_clear" id="632925366559301603" vid="632925366559301602">
        <Properties type="Bool" initWith="Clear">g_clear</Properties>
      </treenode>
      <treenode text="g_distAlgo" id="632925366559301605" vid="632925366559301604">
        <Properties type="String" initWith="DistributionAlgorithm">g_distAlgo</Properties>
      </treenode>
      <treenode text="g_specifyDistAlgo" id="632925366559301607" vid="632925366559301606">
        <Properties type="Bool" initWith="ModifyDistributionAlgorithm">g_specifyDistAlgo</Properties>
      </treenode>
      <treenode text="g_busyAlgo" id="632925366559301609" vid="632925366559301608">
        <Properties type="String" initWith="HuntAlgoBusy">g_busyAlgo</Properties>
      </treenode>
      <treenode text="g_specifyBusyAlgo" id="632925366559301611" vid="632925366559301610">
        <Properties type="Bool" initWith="ModifyHuntAlgoBusy">g_specifyBusyAlgo</Properties>
      </treenode>
      <treenode text="g_noAnswerAlgo" id="632925366559301613" vid="632925366559301612">
        <Properties type="String" initWith="HuntAlgoNoAnswer">g_noAnswerAlgo</Properties>
      </treenode>
      <treenode text="g_specifyNoAnswerAlgo" id="632925366559301615" vid="632925366559301614">
        <Properties type="Bool" initWith="ModifyHuntAlgoNoAnswer">g_specifyNoAnswerAlgo</Properties>
      </treenode>
      <treenode text="g_notAvailableAlgo" id="632925366559301617" vid="632925366559301616">
        <Properties type="String" initWith="HuntAlgoNotAvailable">g_notAvailableAlgo</Properties>
      </treenode>
      <treenode text="g_specifyNotAvailableAlgo" id="632925366559301619" vid="632925366559301618">
        <Properties type="Bool" initWith="ModifyHuntAlgoNotAvailable">g_specifyNotAvailableAlgo</Properties>
      </treenode>
      <treenode text="g_lineGroupName" id="632925366559301621" vid="632925366559301620">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632925366559301586" treenode="632925366559301587" appnode="632925366559301584" handlerfor="632925366559301583">
    ...
    <node type="Action" id="632925366559301625" name="ClearLineGroup" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="408" y="608">
    ...
    <node type="Action" id="632925366559301628" name="UpdateLineGroup" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="408" y="784">
...
public static string Execute(Metreos.Types.Http.QueryParamCollection query, ref string device)
{
    ...
    <node type="Action" id="632925366559301658" name="GetPhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="744" y="440">
    ...
    <node type="Action" id="632925366559301665" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="1080" y="440">
      ...
      <Properties language="csharp">
public static string Execute(Metreos.Types.AxlSoap504.GetPhoneResponse axlPhone, ref string primaryLineUuid, LogWriter log)
{
	...
	{
        	XLine line = axlPhone.Response.@return.device.lines.Items[0] as XLine;
    ...
    <node type="Action" id="632925366559301675" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="1560" y="440">
      ...
      <Properties language="csharp">
public static string Execute(Metreos.Types.AxlSoap504.GetLineGroupResponse axlLineGroup)
{
    ...
    <node type="Action" id="632925366559301676" name="UpdateLineGroup" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="2248" y="440">
    ...
    <node type="Action" id="632925366559301678" name="GetLineGroup" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="1256" y="440">
    ...
    <node type="Action" id="632925366559301685" name="AddLineGroupItem" container="632925366559301686" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="1952" y="280">
    ...
    <node type="Action" id="632925366559301691" name="AddLineGroupItem" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="1432" y="440">
...
public static string Execute(ref int count, ref string lineUuid, IEnumerator loopEnum, LogWriter log)
{
    ...
    <node type="Variable" id="632925366559301626" name="lineGroupMembers" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.LineGroupMembers" refType="reference">lineGroupMembers</Properties>
    </node>
    ...
    <node type="Variable" id="632925366559301660" name="axlPhone" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.GetPhoneResponse" refType="reference">axlPhone</Properties>
    </node>
    ...
    <node type="Variable" id="632925366559301679" name="axlLineGroup" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.GetLineGroupResponse" refType="reference">axlLineGroup</Properties>
    </node>
