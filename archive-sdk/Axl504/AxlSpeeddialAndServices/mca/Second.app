<Application name="Second" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <global name="Second">
    ...
    <variables>
      <treenode text="g_devicename" id="632746759761007314" vid="632586614329867972">
        <Properties type="String" initWith="devicename">g_devicename</Properties>
      </treenode>
      <treenode text="g_ccmIp" id="632746759761007316" vid="632586614329867974">
        <Properties type="String" initWith="callManagerIP">g_ccmIp</Properties>
      </treenode>
      <treenode text="g_ccmUsername" id="632746759761007318" vid="632586614329867976">
        <Properties type="String" initWith="ccmUsername">g_ccmUsername</Properties>
      </treenode>
      <treenode text="g_ccmPassword" id="632746759761007320" vid="632586614329867978">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632423474098293159" treenode="632423474098293160" appnode="632423474098293157" handlerfor="632423474098293156">
    <node type="Loop" id="632424417737187602" name="Loop" text="loop (expr)" cx="209" cy="148" entry="1" class="MaxLoopContainerNode" group="Application Components" path="Metreos.StockTools" x="345" y="62" mx="450" my="136">
      <linkto id="632424417737187605" fromport="1" type="Basic" style="Bevel" ortho="true" />
      <linkto id="632586605968725302" fromport="3" type="Labeled" style="Bevel" ortho="true" label="default" />
    ...
    <node type="Loop" id="632424417737187610" name="Loop" text="loop (expr)" cx="227" cy="148" entry="1" class="MaxLoopContainerNode" group="Application Components" path="Metreos.StockTools" x="344" y="246" mx="458" my="320">
      <linkto id="632424417737187611" fromport="1" type="Basic" style="Bevel" ortho="true" />
      <linkto id="632424417737187612" fromport="3" type="Labeled" style="Bevel" ortho="true" label="default" />
    ...
    <node type="Start" id="632423474098293159" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="40" y="136">
      <linkto id="632423474098293161" type="Basic" style="Bevel" ortho="true" />
    </node>
    <node type="Action" id="632423474098293161" name="GetPhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="112" y="136">
      <linkto id="632423474098293163" type="Labeled" style="Bevel" ortho="true" label="default" />
    ...
    <node type="Action" id="632423474098293163" name="If" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="208" y="136">
      <linkto id="632424417737187602" port="1" type="Labeled" style="Bevel" ortho="true" label="true" />
      <linkto id="632424417737187609" type="Labeled" style="Bevel" ortho="true" label="false" />
      <Properties final="false" type="native" log="On">
    ...
    <node type="Action" id="632424417737187605" name="AddSpeeddialItem" container="632424417737187602" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="449" y="136">
      <linkto id="632424417737187602" port="3" type="Labeled" style="Bevel" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
    ...
    <node type="Action" id="632424417737187609" name="If" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="208" y="320">
      <linkto id="632424417737187610" port="1" type="Labeled" style="Bevel" ortho="true" label="true" />
      <linkto id="632424433605337724" type="Labeled" style="Bevel" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
    ...
    <node type="Action" id="632424417737187611" name="AddServiceItem" container="632424417737187610" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="459" y="320">
      <linkto id="632424417737187610" port="3" type="Labeled" style="Bevel" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="Name" type="csharp">getPhoneResponse.Response.@return.device.services[loopIndex].name</ap>
        <ap name="Url" type="csharp">getPhoneResponse.Response.@return.device.services[loopIndex].url</ap>
        <ap name="UrlButtonIndex" type="csharp">getPhoneResponse.Response.@return.device.services[loopIndex].urlButtonIndex</ap>
        <ap name="Uuid" type="csharp">getPhoneResponse.Response.@return.device.services[loopIndex].uuid</ap>
        <ap name="TelecasterServiceName" type="csharp">getPhoneResponse.Response.@return.device.services[loopIndex].name</ap>
        <rd field="Service">services</rd>
      </Properties>
    </node>
    <node type="Action" id="632424417737187612" name="UpdatePhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="649" y="320">
      <linkto id="632424417737187613" type="Labeled" style="Bevel" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="PhoneName" type="variable">g_devicename</ap>
    ...
    <node type="Action" id="632424417737187613" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="753" y="320">
      <linkto id="632424417737187614" type="Labeled" style="Bevel" ortho="true" label="default" />
    ...
    <node type="Label" id="632424433605337725" text="s" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="649" y="240">
      <linkto id="632424417737187612" type="Basic" style="Bevel" ortho="true" />
    </node>
    <node type="Label" id="632586605968725301" text="a" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="128" y="320">
      <linkto id="632424417737187609" type="Basic" style="Bevel" ortho="true" />
    </node>
    ...
    <node type="Variable" id="632423474098293162" name="getPhoneResponse" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.GetPhoneResponse" refType="reference">getPhoneResponse</Properties>
    </node>
    <node type="Variable" id="632424417737187606" name="speeddials" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.Speeddials" refType="reference">speeddials</Properties>
    </node>
    <node type="Variable" id="632424417737187607" name="services" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.Services" refType="reference">services</Properties>
    </node>
