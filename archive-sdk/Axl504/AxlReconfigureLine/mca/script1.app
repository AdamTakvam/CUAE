<Application name="script1" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <global name="script1">
    ...
    <variables>
      <treenode text="g_profileName" id="632921408319788053" vid="632599905279436778">
        <Properties type="String" initWith="profileName">g_profileName</Properties>
      </treenode>
      <treenode text="g_callManagerIP" id="632921408319788055" vid="632599905279436780">
        <Properties type="String" initWith="callManagerIP">g_callManagerIP</Properties>
      </treenode>
      <treenode text="g_administrator" id="632921408319788057" vid="632599905279436782">
        <Properties type="String" initWith="ccmUsername">g_administrator</Properties>
      </treenode>
      <treenode text="g_password" id="632921408319788059" vid="632599905279436784">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632599905279436744" treenode="632599905279436745" appnode="632599905279436742" handlerfor="632599905279436741">
    ...
    <node type="Action" id="632599905279436786" name="GetDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="288" y="312">
...
public static string Execute(Metreos.Types.AxlSoap504.GetDeviceProfileResponse getDeviceProfile, Metreos.Types.AxlSoap504.Lines lines)
{
	...
	Metreos.AxlSoap504.XLine[] lineData = new Metreos.AxlSoap504.XLine[getDeviceProfile.Response.@return.profile.lines.Items.Length];
    ...
    <node type="Action" id="632599905279436797" name="UpdateDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap504" x="552" y="312">
      <linkto id="632599905279436796" type="Labeled" style="Bevel" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="ProfileName" type="variable">g_profileName</ap>
    ...
    <node type="Variable" id="632599905279436749" name="getDeviceProfile" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.GetDeviceProfileResponse" refType="reference">getDeviceProfile</Properties>
    </node>
    <node type="Variable" id="632599905279436750" name="lines" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap504.Lines" refType="reference">lines</Properties>
    </node>
