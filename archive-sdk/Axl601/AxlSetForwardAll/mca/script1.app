<Application name="script1" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632422597965332844" treenode="632422597965332845" appnode="632422597965332842" handlerfor="632422597965332841">
    ...
    <node type="Action" id="632422610569637355" name="UpdateLine" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="448" y="360">
    ...
    <node type="Action" id="632422663463697334" name="CreateForward" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="336" y="360">
    ...
    <node type="Action" id="632422663463697336" name="GetPhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="112" y="360">
	...
	public static string Execute(Metreos.Types.AxlSoap601.GetPhoneResponse getPhoneResponse, ref string lineId, ref string formattedMessage, int g_linePosition)
	{
		...
		if(getPhoneResponse.Response.@return.device.lines == null ||
 		...
 		Metreos.AxlSoap601.XLine lineInfo = (Metreos.AxlSoap601.XLine) getPhoneResponse.Response.@return.device.lines.Items[g_linePosition - 1]; 
    ...
    <node type="Variable" id="632422663463697335" name="callForwardAll" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap601.CallForward" refType="reference">callForwardAll</Properties>
    </node>
