<Application name="Main" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <global name="Main">
    ...
    <variables>
      <treenode text="g_devicename" id="633119615461563079" vid="632586614329867941">
        <Properties type="String" initWith="devicename">g_devicename</Properties>
      </treenode>
      <treenode text="g_ccmIp" id="633119615461563081" vid="632586614329867943">
        <Properties type="String" initWith="callManagerIP">g_ccmIp</Properties>
      </treenode>
      <treenode text="g_ccmUsername" id="633119615461563083" vid="632586614329867945">
        <Properties type="String" initWith="ccmUsername">g_ccmUsername</Properties>
      </treenode>
      <treenode text="g_ccmPassword" id="633119615461563085" vid="632586614329867947">
        <Properties type="String" initWith="ccmPassword">g_ccmPassword</Properties>
      </treenode>
      <treenode text="g_name1" id="633119615461563087" vid="632746799038485520">
        <Properties type="String" initWith="Name1">g_name1</Properties>
      </treenode>
      <treenode text="g_url1" id="633119615461563089" vid="632746799038485522">
        <Properties type="String" initWith="Url1">g_url1</Properties>
      </treenode>
      <treenode text="g_urlLabel1" id="633119615461563091" vid="632746799038485524">
        <Properties type="String" initWith="UrlLabel1">g_urlLabel1</Properties>
      </treenode>
      <treenode text="g_index1" id="633119615461563093" vid="632746799038485526">
        <Properties type="String" initWith="Index1">g_index1</Properties>
      </treenode>
      <treenode text="g_teleName1" id="633119615461563095" vid="632746799038485528">
        <Properties type="String" initWith="TelecasterName1">g_teleName1</Properties>
      </treenode>
      <treenode text="g_url2" id="633119615461563097" vid="632746799038485530">
        <Properties type="String" initWith="Url2">g_url2</Properties>
      </treenode>
      <treenode text="g_urlLabel2" id="633119615461563099" vid="632746799038485532">
        <Properties type="String" initWith="UrlLabel2">g_urlLabel2</Properties>
      </treenode>
      <treenode text="g_index2" id="633119615461563101" vid="632746799038485534">
        <Properties type="String" initWith="Index2">g_index2</Properties>
      </treenode>
      <treenode text="g_name2" id="633119615461563103" vid="632746799038485536">
        <Properties type="String" initWith="Name2">g_name2</Properties>
      </treenode>
      <treenode text="g_teleName2" id="633119615461563105" vid="632746799038485538">
        <Properties type="String" initWith="TelecasterName2">g_teleName2</Properties>
      </treenode>
      <treenode text="g_teleId1" id="633119615461563107" vid="632746892548451438">
        <Properties type="String" initWith="TeleId1">g_teleId1</Properties>
      </treenode>
      <treenode text="g_teleId2" id="633119615461563109" vid="632746892548451440">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632423474098293105" treenode="632423474098293106" appnode="632423474098293103" handlerfor="632423474098293102">
    ...
    <node type="Action" id="632423474098293107" name="AddSpeeddialItem" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="153" y="370">
    ...
    <node type="Action" id="632423474098293112" name="AddSpeeddialItem" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="269" y="255">
    ...
    <node type="Action" id="632423474098293113" name="AddServiceItem" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="442" y="199">
    ...
    <node type="Action" id="632423474098293114" name="UpdatePhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="629" y="367">
    ...
    <node type="Action" id="632423474098293116" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="763" y="367">
    ...
    <node type="Action" id="632423474098293117" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="892" y="367">
      <Properties final="true" type="appControl" log="On">
      </Properties>
    </node>
    <node type="Action" id="632746799038485540" name="AddServiceItem" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="442" y="368">
