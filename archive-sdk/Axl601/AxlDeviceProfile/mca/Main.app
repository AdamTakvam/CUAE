<Application name="Main" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <global name="Main">
    ...
    <variables>
      <treenode text="g_deviceProfile" id="633117036046875492" vid="632586579304079811">
        <Properties type="String" initWith="deviceProfile">g_deviceProfile</Properties>
      </treenode>
      <treenode text="g_ccmIp" id="633117036046875494" vid="632586579304079813">
        <Properties type="String" initWith="callManagerIP">g_ccmIp</Properties>
      </treenode>
      <treenode text="g_ccmUsername" id="633117036046875496" vid="632586579304079815">
        <Properties type="String" initWith="ccmUsername">g_ccmUsername</Properties>
      </treenode>
      <treenode text="g_ccmPassword" id="633117036046875498" vid="632586579304079817">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632419389328631747" treenode="632419389328631748" appnode="632419389328631745" handlerfor="632419389328631744">
    <node type="Start" id="632419389328631747" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="41" y="199">
      <linkto id="632453055653810658" type="Basic" style="Bevel" ortho="true" />
    </node>
    <node type="Action" id="632419389328631752" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="616" y="200">
      <linkto id="632419389328631755" type="Labeled" style="Bevel" ortho="true" label="default" />
    ...
    <node type="Label" id="632419389328631758" text="A" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="618" y="59">
      <linkto id="632419389328631752" type="Basic" style="Vector" ortho="true" />
    </node>
    <node type="Action" id="632419389328631763" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="300" y="365">
      <linkto id="632419389328631764" type="Labeled" style="Bevel" ortho="true" label="default" />
    ...
    <node type="Action" id="632419389328631765" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="472" y="360">
      <linkto id="632419389328631767" type="Labeled" style="Bevel" ortho="true" label="default" />
      <Properties language="csharp">
    ...
    <node type="Action" id="632452364485965518" name="UpdateDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="393" y="199">
      <linkto id="632419389328631763" type="Labeled" style="Bevel" ortho="true" label="failure" />
      <linkto id="632419389328631765" type="Labeled" style="Bevel" ortho="true" label="fault" />
      <linkto id="632419389328631752" type="Labeled" style="Bevel" ortho="true" label="default" />
    ...
    <node type="Action" id="632453055653810658" name="GetDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="212" y="198">
      <linkto id="632452364485965518" type="Labeled" style="Bevel" ortho="true" label="default" />
      <linkto id="632419389328631763" type="Labeled" style="Bevel" ortho="true" label="failure" />
      <linkto id="632419389328631765" type="Labeled" style="Bevel" ortho="true" label="fault" />
      <Properties final="false" type="native" log="On">
        <ap name="ProfileName" type="variable">g_deviceProfile</ap>
    ...
    <node type="Variable" id="632453055653810659" name="getDeviceProfileResponse" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap601.GetDeviceProfileResponse" refType="reference">getDeviceProfileResponse</Properties>
    </node>
  </canvas>
  <Properties desc="">
  </Properties>
