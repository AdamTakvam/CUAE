<Application name="script1" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <global name="script1">
    ...
    <variables>
      <treenode text="g_user" id="633113762591875460" vid="632919681893171704">
        <Properties type="String" initWith="Username">g_user</Properties>
      </treenode>
      <treenode text="g_pass" id="633113762591875462" vid="632919681893171706">
        <Properties type="String" initWith="Password">g_pass</Properties>
      </treenode>
      <treenode text="g_ip" id="633113762591875464" vid="632919681893171708">
        <Properties type="String" initWith="CallManagerIP">g_ip</Properties>
      </treenode>
      <treenode text="g_query" id="633113762591875466" vid="632919681893171710">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632919681893171692" treenode="632919681893171693" appnode="632919681893171690" handlerfor="632919681893171689">
    <node type="Start" id="632919681893171692" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="60" y="252">
      <linkto id="632919681893171694" type="Basic" style="Vector" ortho="true" />
    </node>
    <node type="Action" id="632919681893171694" name="ExecuteSQLQuery" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="279" y="252">
      <linkto id="632920143635856115" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="Query" type="csharp">"select device.name from device"</ap>
        ...
        <log condition="entry" on="true" level="Info" type="csharp">post["query"] != null ? post["query"] : g_query</log>
      </Properties>
    </node>
    <node type="Action" id="632920143635856115" name="ParseSQLQuery" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap601" x="465" y="251">
      <linkto id="632920143635856119" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
    ...
    <node type="Action" id="632920143635856119" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="640" y="251">
      <linkto id="632920143635856122" type="Labeled" style="Bezier" ortho="true" label="default" />
...
public static string Execute(DataTable table, ref string body)
{
    ...
    <node type="Action" id="632920143635856122" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="801" y="250">
      <linkto id="632920143635856117" type="Labeled" style="Bezier" ortho="true" label="default" />
    ...
    <node type="Variable" id="632920143635856116" name="executeResponse" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap601.ExecuteSQLQueryResponse" refType="reference">executeResponse</Properties>
    </node>
