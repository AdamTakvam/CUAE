<Application name="script1" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false">
  ...
  <global name="script1">
    ...
    <variables>
      <treenode text="g_profileName" id="632737175525011424" vid="632599905279436778">
        <Properties type="String" initWith="profileName">g_profileName</Properties>
      </treenode>
      <treenode text="g_callManagerIP" id="632737175525011426" vid="632599905279436780">
        <Properties type="String" initWith="callManagerIP">g_callManagerIP</Properties>
      </treenode>
      <treenode text="g_administrator" id="632737175525011428" vid="632599905279436782">
        <Properties type="String" initWith="ccmUsername">g_administrator</Properties>
      </treenode>
      <treenode text="g_password" id="632737175525011430" vid="632599905279436784">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632599905279436744" treenode="632599905279436745" appnode="632599905279436742" handlerfor="632599905279436741">
    <node type="Start" id="632599905279436744" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="144" y="312">
      <linkto id="632599905279436786" type="Basic" style="Bevel" ortho="true" />
    </node>
    <node type="Action" id="632599905279436786" name="GetDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="288" y="312">
      <linkto id="632599905279436787" type="Labeled" style="Bevel" ortho="true" label="default" />
      <linkto id="632599905279436790" type="Labeled" style="Bevel" ortho="true" label="success" />
    ...
    <node type="Action" id="632599905279436788" name="Assign" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="557" y="236">
      <linkto id="632599905279436796" type="Labeled" style="Bevel" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
    ...
    <node type="Action" id="632599905279436790" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="416" y="312">
      <linkto id="632599905279436791" type="Labeled" style="Bevel" ortho="true" label="default" />
      <linkto id="632599905279436797" type="Labeled" style="Bevel" ortho="true" label="success" />
      <Properties language="csharp">
public static string Execute(Metreos.Types.AxlSoap333.GetDeviceProfileResponse getDeviceProfile, Metreos.Types.AxlSoap333.Lines lines)
{
	...
	Metreos.AxlSoap333.XLine[] lineData = new Metreos.AxlSoap333.XLine[getDeviceProfile.Response.@return.profile.lines.Items.Length];

	Array.Copy(getDeviceProfile.Response.@return.profile.lines.Items,
			lineData, lineData.Length);

   	lineData[0].e164Mask = "2000";
	lineData[0].display = "Bugs Bunny";
    ...
    <node type="Label" id="632599905279436792" text="e" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="472" y="240">
      <linkto id="632599905279436788" type="Basic" style="Bevel" ortho="true" />
    </node>
    <node type="Label" id="632599905279436793" text="n" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="536" y="160">
      <linkto id="632599905279436794" type="Basic" style="Bevel" ortho="true" />
    </node>
    ...
    <node type="Action" id="632599905279436796" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="696" y="312">
      <linkto id="632599905279436798" type="Labeled" style="Bevel" ortho="true" label="default" />
    ...
    <node type="Action" id="632599905279436797" name="UpdateDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="552" y="312">
      <linkto id="632599905279436796" type="Labeled" style="Bevel" ortho="true" label="default" />
      <Properties final="false" type="native" log="On">
        <ap name="ProfileName" type="variable">g_profileName</ap>
    ...
    <node type="Variable" id="632599905279436749" name="getDeviceProfile" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap333.GetDeviceProfileResponse" refType="reference">getDeviceProfile</Properties>
    </node>
    <node type="Variable" id="632599905279436750" name="lines" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
      <Properties type="Metreos.Types.AxlSoap333.Lines" refType="reference">lines</Properties>
    </node>
