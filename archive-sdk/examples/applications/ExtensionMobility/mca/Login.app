<Application name="Login" trigger="Metreos.Providers.Http.GotRequest" version="0.7" single="false" grid="true">
  <!--//// app tree ////-->
  <global name="Login">
    <outline>
      <treenode type="evh" id="632338063425000168" level="1" text="Metreos.Providers.Http.GotRequest (trigger): InputUsername">
      ...
      <treenode type="evh" id="632338063425000183" level="1" text="GotRequest: LoginUser">
    ...
    <variables>
      <treenode text="g_deviceName" id="632338193022188054" vid="632338063425000177">
        <Properties type="String">g_deviceName</Properties>
      </treenode>
      <treenode text="g_proxyUserId" id="632338193022188056" vid="632338063425000264">
        <Properties type="String" initWith="ProxyUserId">g_proxyUserId</Properties>
      </treenode>
      <treenode text="g_proxyUserPassword" id="632338193022188058" vid="632338063425000266">
        <Properties type="String" initWith="ProxyUserPassword">g_proxyUserPassword</Properties>
      </treenode>
      <treenode text="g_loginUrl" id="632338193022188060" vid="632338063425000268">
        <Properties type="String" initWith="LoginURL">g_loginUrl</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="InputUsername" startnode="632338063425000167" treenode="632338063425000168" appnode="632338063425000165" handlerfor="632338063425000164">
    <node type="Start" id="632338063425000167" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="32" y="360">
      <linkto id="632338063425000169" type="Basic" style="Bezier" ortho="true" />
    </node>
    <node type="Action" id="632338063425000169" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="224" y="360">
      <linkto id="632338063425000213" type="Labeled" style="Bezier" ortho="true" label="failure" />
      <linkto id="632338063425000215" type="Labeled" style="Bezier" ortho="true" label="success" />
...
ref string g_deviceName, ref string userId)
    ...
    <node type="Action" id="632338063425000213" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="224" y="496">
      <linkto id="632338063425000214" type="Labeled" style="Bezier" ortho="true" label="default" />
    ...
    <node type="Action" id="632338063425000215" name="CreateInput" class="MaxActionNode" group="" path="Metreos.Native.CiscoIpPhone" x="416" y="360">
      <linkto id="632338063425000216" type="Labeled" style="Bezier" ortho="true" label="default" />
    ...
    <node type="Action" id="632338063425000216" name="AddInputItem" class="MaxActionNode" group="" path="Metreos.Native.CiscoIpPhone" x="568" y="360">
      <linkto id="632338063425000219" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632338063425000219" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="712" y="360">
      <linkto id="632338063425000220" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="responseCode" type="literal">200</ap>
  ...
  <canvas type="Function" name="LoginUser" activetab="true" startnode="632338063425000182" treenode="632338063425000183" appnode="632338063425000180" handlerfor="632338063425000179">
    <node type="Start" id="632338063425000182" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="32" y="360">
      <linkto id="632338063425000226" type="Basic" style="Bezier" ortho="true" />
    </node>
    <node type="Action" id="632338063425000226" name="Login" class="MaxActionNode" group="" path="Metreos.Native.CiscoExtensionMobility" x="224" y="360">
      <linkto id="632338063425000274" type="Labeled" style="Bezier" ortho="true" label="default" />
      <linkto id="632338063425000281" type="Labeled" style="Bezier" ortho="true" label="success" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632338063425000274" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="224" y="480">
      <linkto id="632338063425000276" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties language="csharp">
...
{1}", errorMessage, errorCode);
    ...
    <node type="Action" id="632338063425000276" name="CreateText" class="MaxActionNode" group="" path="Metreos.Native.CiscoIpPhone" x="224" y="600">
      <linkto id="632338063425000277" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632338063425000277" name="AddSoftKeyItem" class="MaxActionNode" group="" path="Metreos.Native.CiscoIpPhone" x="224" y="728">
      <linkto id="632338063425000282" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632338063425000281" name="CreateText" class="MaxActionNode" group="" path="Metreos.Native.CiscoIpPhone" x="432" y="360">
      <linkto id="632338063425000283" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632338063425000282" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="224" y="848">
      <linkto id="632338063425000278" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="responseCode" type="literal">200</ap>
    ...
    <node type="Action" id="632338063425000283" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="592" y="360">
      <linkto id="632338193022187718" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="provider">
        <ap name="responseCode" type="literal">200</ap>
