<Application name="Second" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false" grid="true">
  <!--//// app tree ////-->
  <global name="Second">
    <outline>
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632423474098293159" treenode="632423474098293160" appnode="632423474098293157" handlerfor="632423474098293156">
    <node type="Loop" id="632424417737187602" name="Loop" text="loop (expr)" cx="209" cy="148" entry="1" class="MaxLoopContainerNode" group="Application Components" path="Metreos.StockTools" x="304" y="64" mx="408" my="138">
      <linkto id="632424417737187605" fromport="1" type="Basic" style="Bezier" ortho="true" />
      <linkto id="632424417737187609" fromport="3" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties iteratorType="int" type="csharp">getPhoneResponse.Response.@return.device.speeddials.Length</Properties>
    </node>
    <node type="Loop" id="632424417737187610" name="Loop" text="loop (expr)" cx="227" cy="148" entry="1" class="MaxLoopContainerNode" group="Application Components" path="Metreos.StockTools" x="296" y="304" mx="410" my="378">
      <linkto id="632424417737187611" fromport="1" type="Basic" style="Bezier" ortho="true" />
      <linkto id="632424417737187612" fromport="3" type="Labeled" style="Bezier" ortho="true" label="default" />
    ...
    <node type="Start" id="632423474098293159" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="40" y="136">
      <linkto id="632423474098293161" type="Basic" style="Bezier" ortho="true" />
    </node>
    <node type="Action" id="632423474098293161" name="GetPhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="112" y="136">
      <linkto id="632423474098293163" type="Labeled" style="Bezier" ortho="true" label="default" />
    ...
    <node type="Action" id="632423474098293163" name="If" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="200" y="136">
      <linkto id="632424417737187602" port="1" type="Labeled" style="Bezier" ortho="true" label="true" />
      <linkto id="632424417737187609" type="Labeled" style="Bezier" ortho="true" label="false" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632424417737187605" name="AddSpeeddialItem" container="632424417737187602" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="408" y="136">
      <linkto id="632424417737187602" port="3" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632424417737187609" name="If" class="MaxActionNode" group="" path="Metreos.Native.Conditional" x="200" y="376">
      <linkto id="632424417737187610" port="1" type="Labeled" style="Bezier" ortho="true" label="true" />
      <linkto id="632424433605337724" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
    ...
    <node type="Action" id="632424417737187611" name="AddServiceItem" container="632424417737187610" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="408" y="376">
      <linkto id="632424417737187610" port="3" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
        <ap name="Uuid" type="csharp">getPhoneResponse.Response.@return.device.services[loopIndex].uuid</ap>
        <rd field="Service">services</rd>
      </Properties>
    </node>
    <node type="Action" id="632424417737187612" name="UpdatePhone" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="584" y="248">
      <linkto id="632424417737187613" type="Labeled" style="Bezier" ortho="true" label="default" />
      <Properties final="false" type="native">
        <ap name="PhoneName" type="literal">SEP001243F504B3</ap>
    ...
    <node type="Action" id="632424417737187613" name="SendResponse" class="MaxActionNode" group="" path="Metreos.Providers.Http" x="688" y="248">
      <linkto id="632424417737187614" type="Labeled" style="Bezier" ortho="true" label="default" />
    ...
    <node type="Action" id="632424417737187614" name="EndScript" class="MaxActionNode" group="" path="Metreos.ApplicationControl" x="784" y="248">
      <Properties final="true" type="appControl">
      </Properties>
    </node>
    <node type="Label" id="632424433605337724" text="a" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="200" y="480" />
    <node type="Label" id="632424433605337725" text="a" class="MaxLabelNode" group="Application Components" path="Metreos.StockTools" x="584" y="168">
      <linkto id="632424417737187612" type="Basic" style="Bezier" ortho="true" />
    </node>
