<Application name="script1" trigger="Metreos.Providers.Http.GotRequest" version="0.8" single="false" grid="true">
  ...
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632422597965332844" treenode="632422597965332845" appnode="632422597965332842" handlerfor="632422597965332841">
    <node type="Start" id="632422597965332844" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="32" y="360">
      <linkto id="632453744379256103" type="Basic" style="Bezier" ortho="true" />
    </node>
    ...
    <node type="Action" id="632422663463697334" name="CreateForward" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="336" y="360">
      ...
      <Properties final="false" type="native">
        <ap name="Destination" type="literal">61001</ap>
        <ap name="CallingSearchSpaceName" type="literal">Unrestricted</ap>
    ...
    <node type="Action" id="632422663463697339" name="CustomCode" class="MaxCodeNode" group="Application Components" path="Metreos.StockTools" x="224" y="360">
      <linkto id="632422663463697334" type="Labeled" style="Bezier" ortho="true" label="default" />
      <linkto id="632425466128232860" type="Labeled" style="Bezier" ortho="true" label="nolines" />
      <Properties language="csharp">
	public static string Execute(Metreos.Types.AxlSoap333.GetDeviceProfileResponse  getDeviceProfileResponse, ref string lineId, ref string formattedMessage)
	{
		// if we can find no line information, then this device must have
            // no lines, and so is not useful for this demo.
		if(getDeviceProfileResponse.Response.@return.profile.lines == null ||
               getDeviceProfileResponse.Response.@return.profile.lines.Items == null ||
               getDeviceProfileResponse.Response.@return.profile.lines.Items.Length == 0)
            {
		     formattedMessage = "Use a device with phone lines";
                 return "nolines";
            }

 		Metreos.AxlSoap333.XLine lineInfo = (Metreos.AxlSoap333.XLine) getDeviceProfileResponse.Response.@return.profile.lines.Items[0]; 
    ...
    <node type="Action" id="632453744379256103" name="GetDeviceProfile" class="MaxActionNode" group="" path="Metreos.Native.AxlSoap333" x="128" y="360">
    ...
    <node type="Variable" id="632422663463697338" name="getDeviceProfileResponse" class="MaxRecumbentVariableNode" group="Application Components" path="Metreos.StockTools" x="0" y="0">
