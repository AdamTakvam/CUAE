<Application name="HandleInboundCall" trigger="Metreos.CallControl.IncomingCall" version="0.8" single="false">
  ...
  <global name="HandleInboundCall">
    <outline>
      ...
      <treenode type="evh" id="632930018989531700" level="2" text="Metreos.MediaControl.Play_Complete: OnPlay_Complete">
        ...
        <references>
          <ref id="632930018989531707" actid="632930018989531706" />
        </references>
      ...
      <treenode type="evh" id="632930018989531705" level="2" text="Metreos.MediaControl.Play_Failed: OnPlay_Failed">
        ...
        <references>
          <ref id="632930018989531708" actid="632930018989531706" />
        </references>
        <Properties type="asyncCallback">
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="g_callId" id="632930018989531686" vid="632930018989531685">
        <Properties type="String">g_callId</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnIncomingCall" startnode="632930018989531682" treenode="632930018989531683" appnode="632930018989531680" handlerfor="632930018989531679">
    ...
    <node type="Action" id="632930018989531706" name="Play" class="MaxAsyncActionNode" group="" path="Metreos.MediaControl" x="392" y="416" mx="445" my="432">
      ...
      <Properties final="false" type="provider" log="On">
        ...
        <log condition="entry" on="true" level="Info" type="literal">The AnswerCall application successfully answered the call...</log>
      </Properties>
    </node>
  ...
  <canvas type="Function" name="OnRemoteHangup" activetab="true" startnode="632930018989531732" treenode="632930018989531733" appnode="632930018989531730" handlerfor="632930018989531729">
    <node type="Start" id="632930018989531732" name="Start" class="MaxStartNode" group="Metreos.StockTools" path="Metreos.StockTools" x="177" y="464">
