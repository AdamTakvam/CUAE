  ...
  <global name="HandleMakeCall">
    <outline>
      ...
      <treenode type="evh" id="632929999374687939" level="2" text="Metreos.CallControl.MakeCall_Complete: OnMakeCall_Complete">
        ...
        <references>
          <ref id="632929999374687976" actid="632929999374687950" />
        </references>
      ...
      <treenode type="evh" id="632929999374687944" level="2" text="Metreos.CallControl.MakeCall_Failed: OnMakeCall_Failed">
        ...
        <references>
          <ref id="632929999374687977" actid="632929999374687950" />
        </references>
        <Properties type="asyncCallback">
        </Properties>
      </treenode>
      <treenode type="evh" id="632929999374687949" level="2" text="Metreos.CallControl.RemoteHangup: OnRemoteHangup">
        ...
        <references>
          <ref id="632929999374687978" actid="632929999374687950" />
        </references>
      ...
      <treenode type="evh" id="632929999374687998" level="2" text="Metreos.MediaControl.Play_Complete: OnPlay_Complete">
        ...
        <references>
          <ref id="632929999374688005" actid="632929999374688004" />
        </references>
        <Properties type="asyncCallback">
        </Properties>
      </treenode>
      <treenode type="evh" id="632929999374688003" level="2" text="Metreos.MediaControl.Play_Failed: OnPlay_Failed">
        ...
        <references>
          <ref id="632929999374688006" actid="632929999374688004" />
        </references>
        <Properties type="asyncCallback">
        </Properties>
      </treenode>
    ...
    <variables>
      <treenode text="to" id="632929999374687985" vid="632929999374687984">
        <Properties type="String" initWith="To">to</Properties>
      </treenode>
      <treenode text="g_callId" id="632929999374688019" vid="632929999374688018">
        <Properties type="String">g_callId</Properties>
      </treenode>
    </variables>
  </global>
  <!--//// visible canvases ////-->
  <canvas type="Function" name="OnGotRequest" activetab="true" startnode="632929999374687932" treenode="632929999374687933" appnode="632929999374687930" handlerfor="632929999374687929">
    ...
    <node type="Action" id="632929999374687950" name="MakeCall" class="MaxAsyncActionNode" group="" path="Metreos.CallControl" x="288" y="424" mx="354" my="440">
      ...
      <Properties final="false" type="provider" log="On">
        ...
        <ap name="From" type="literal">12345</ap>
...
Check the Application Server logs for errors.</ap>
  ...
  <canvas type="Function" name="OnMakeCall_Complete" startnode="632929999374687938" treenode="632929999374687939" appnode="632929999374687936" handlerfor="632929999374687935">
