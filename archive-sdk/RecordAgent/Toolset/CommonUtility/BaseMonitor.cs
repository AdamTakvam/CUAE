...
namespace Metreos.Toolset.CommonUtility
{
	...
	public abstract class BaseMonitor
	{
		...
		protected bool timeElapsed = false;
		protected bool reactivated = false;

		protected bool mouseMoved  = false;
		protected bool keyboardEntered = false;
		...
		{
			if (mouseMoved || keyboardEntered)
			{
				mouseMoved = false;
				keyboardEntered = false;
				return;
			}
