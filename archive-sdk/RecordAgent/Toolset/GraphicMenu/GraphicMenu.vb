...
#Region "Private members"
        ...
        Private __MenuItemBackColorSelected As Color = Color.Lavender
        Private __MenuItemBorderSelected As Color = Color.SteelBlue
...
#End Region
        ...
        Public Sub AddIcon(ByVal item As MenuItem, ByVal icon As Bitmap)
            ...
            icon.Save(strm, System.Drawing.Imaging.ImageFormat.Bmp)
            'Create a Byte Array, put the Memory Stream in it. 
            Dim ba() As Byte
            ba = strm.ToArray
            menuItemIconCollection.Add(item, ba)
        ...
        Private Sub DrawBitmap(ByVal g As Graphics, ByVal item As MenuItem, ByVal itemState As DrawItemState)
            ...
            Else
                ...
                Else
                    If Not menuItemIconCollection.Contains(item) Then
                        Return
                    End If
                    Dim obj As Object = menuItemIconCollection(item)
                    'Convert the Object to a Byte Array 
                    Dim ba() As Byte = CType(obj, Byte())
                    'Convert the Byte Array to a Memory Stream 
                    Dim strm As New System.IO.MemoryStream(ba)
            ...
            If (disabled) Then
                ...
                Dim tmpRect = New Rectangle(BitmapBounds.X + 2, BitmapBounds.Y + 2, BitmapBounds.Width - 2, BitmapBounds.Right - 2)
