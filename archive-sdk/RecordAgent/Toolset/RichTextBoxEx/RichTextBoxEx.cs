...
namespace Metreos.Toolset
{
	...
	public class RichTextBoxEx : System.Windows.Forms.RichTextBox {
		...
		public RtfColor TextColor {
			...
			set {textColor = value; base.SelectionColor = GetSystemColor(value); }
		}
		...
		public void InsertImage(Image _image) {
			Font of = this.SelectionFont;
			HorizontalAlignment os = this.SelectionAlignment;
			RtfColor oc = this.TextColor;
			...
			this.SelectionFont = of;
			this.SelectionAlignment = os;
			this.TextColor = oc;
		}
		...
		#region Insert Drop File
		public void AppendDropFile(string filePath, Image img)
		{
			InsertImage(img);
		...
		private Color GetSystemColor(RtfColor _color)
		{
			switch (_color)
			{
				case RtfColor.Black:
					return Color.Black;
				case RtfColor.Maroon:
					return Color.Maroon;
				case RtfColor.Green:
					return Color.Green;
				case RtfColor.Olive:
				...
				case RtfColor.Navy:
					return Color.Navy;
				case RtfColor.Purple:
					return Color.Purple;
				case RtfColor.Teal:
					return Color.Teal;
				case RtfColor.Gray:
					return Color.Gray;
				case RtfColor.Silver:
					return Color.Silver;
				case RtfColor.Red:
					return Color.Red;
				case RtfColor.Lime:
					return Color.Lime;
				case RtfColor.Yellow:
					return Color.Yellow;
				case RtfColor.Blue:
					return Color.Blue;
				case RtfColor.Fuchsia:
		...
		/// <summary>
		/// Determine if data is in rtf format
		/// </summary>
		/// <param name="data"></param>
		/// <returns></returns>
		public bool IsRtf(string data)
		{
			if (data.IndexOf(RTF_HEADER) != -1)
				return true;
