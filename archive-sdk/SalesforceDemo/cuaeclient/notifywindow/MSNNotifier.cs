...
{
	/// <summary>
	/// Display An MSN-Messenger-Style MSNNotifier.
	/// </summary>
	public class MSNNotifier : System.Windows.Forms.Form
	{
		#region Public Variables
		/// <summary>
		/// Gets or sets the title text to be displayed in the MSNNotifier.
		/// </summary>
		public string Title;
		/// <summary>
		...
		/// <summary>
		/// Gets or sets the style used when drawing the background of the MSNNotifier.
		/// </summary>
		public BackgroundStyles BackgroundStyle;
		/// <summary>
		/// Gets or sets the Blend used when drawing a gradient background for the MSNNotifier.
		/// </summary>
		public System.Drawing.Drawing2D.Blend Blend;
		/// <summary>
		/// Gets or sets the StringFormat used when drawing text in the MSNNotifier.
		/// </summary>
		...
		/// <summary>
		/// An EventHandler called when the MSNNotifier main text is clicked.
		/// </summary>
		public event System.EventHandler TextClicked;
		/// <summary>
		/// An EventHandler called when the MSNNotifier title text is clicked.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the color of the MSNNotifier main text.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the amount of milliseconds to display the MSNNotifier for.
		/// </summary>
		public int WaitTime;
		/// <summary>
		/// Gets or sets the full height of the MSNNotifier, used after the opening animation has been completed.
		/// </summary>
		public int ActualHeight;
		/// <summary>
		/// Gets or sets the full width of the MSNNotifier.
		/// </summary>
		...
		#region Constructor
		/// <param name="title">Title text displayed in the MSNNotifier</param>
		/// <param name="text">Main text displayedin the MSNNotifier</param>
		public MSNNotifier (string title, string text) : this() { Title = title; Text = text; }
		/// <param name="text">Text displayed in the MSNNotifier</param>
		public MSNNotifier (string text) : this() { Text = text; }
		public MSNNotifier()
		{
            InitializeComponent();
			...
			ActualHeight = 130;
			WaitTime = 8000;    
            logoBitmap = new Bitmap(this.pictureBoxLogo.Image);
		}
		#endregion

		#region Public Methods
		/// <summary>
		/// Sets the width and height of the MSNNotifier.
		/// </summary>
		...
		/// <summary>
		/// Displays the MSNNotifier.
		/// </summary>
		public void Notify()
		{
			if (Text == null || Text.Length < 1)
				throw new System.Exception ("You must set MSNNotifier.Text before calling Notify()");
			...
			if (Title != null)
			{
				using (Graphics fx = CreateGraphics())
				{
					...
					rTitle = new Rectangle (11 + logoBitmap.Width, 12 + (int)Math.Ceiling((double)(logoBitmap.Height/3)), (int) Math.Ceiling (sz.Width), (int) Math.Ceiling (sz.Height));
		...
		protected override void OnPaint (System.Windows.Forms.PaintEventArgs e)
		{
            ...
            if (logoBitmap != null)
            {
                e.Graphics.DrawImage(logoBitmap, 11, 12, logoBitmap.Width, logoBitmap.Height);
            }
        ...
        {
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(MSNNotifier));
            ...
            this.pictureBoxLogo.Location = new System.Drawing.Point(16, 8);
            this.pictureBoxLogo.Name = "pictureBoxLogo";
            this.pictureBoxLogo.Size = new System.Drawing.Size(48, 32);
